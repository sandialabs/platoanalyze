...
namespace Plato
{
inline std::string getFileExtension(std::string const& aFileName)
{
...
inline std::string trim(std::string const& aLine)
{
...
class CSVReader
{
   ...
   public:
    CSVReader(Teuchos::ParameterList& aInputs, Plato::DataMap& aDataMap, Plato::Mesh aMesh) : mDataMap(aDataMap)
    {
    ...
    inline void readLine(std::string const& aLine)
    {
