...
void AugLagStressCriterionGeneral<EvaluationType>::initialize(Teuchos::ParameterList& aInputParams)
{
    Plato::ElasticModelFactory<mNumSpatialDims> tMaterialModelFactory(aInputParams);
    auto tMaterialModel = tMaterialModelFactory.create(mSpatialDomain.materialName());
    ...
    Teuchos::ParameterList tMaterialModelInputs = tMaterialModelsInputs.sublist(mSpatialDomain.materialName());
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::readInputs(Teuchos::ParameterList& aInputParams)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::updateAugLagPenaltyMultipliers()
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
AugLagStressCriterionGeneral<EvaluationType>::AugLagStressCriterionGeneral(
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::Scalar AugLagStressCriterionGeneral<EvaluationType>::getAugLagPenalty() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::Scalar AugLagStressCriterionGeneral<EvaluationType>::getMassNormalizationMultiplier() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::ScalarVector AugLagStressCriterionGeneral<EvaluationType>::getLagrangeMultipliers() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::setStressLimit(const Plato::Scalar& aInput)
{
    mStressLimit = aInput;
}
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::setAugLagPenalty(const Plato::Scalar& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::setCellMaterialDensity(const Plato::Scalar& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::setLagrangeMultipliers(const Plato::ScalarVector& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::setCellStiffMatrix(
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::updateProblem(const Plato::ScalarMultiVector& aStateWS,
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::evaluate_conditional(
    ...
    Kokkos::parallel_for(
        "elastic energy", Kokkos::RangePolicy<>(0, tNumCells), KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal) {
            ...
            ResultT tTrueConstraintValue = tVonMisesOverStressLimit > static_cast<ResultT>(1.0)
                                               ? tTrialConstraintValue
                                               : static_cast<ResultT>(0.0);

            // Compute constraint contribution to augmented Lagrangian function
            ResultT tConstraint =
                tLagrangianMultiplier *
                ((tLagrangeMultipliers(iCellOrdinal) * tTrueConstraintValue) +
                 (static_cast<Plato::Scalar>(0.5) * tAugLagPenalty * tTrueConstraintValue * tTrueConstraintValue));
            ...
            // Compute augmented Lagrangian function
            aResultWS(iCellOrdinal) = (tMassCriterionWeight * tObjective) + (tStressCriterionWeight * tConstraint);
        });
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::updateLagrangeMultipliers(const Plato::ScalarMultiVector& aStateWS,
                                                                             const Plato::ScalarMultiVector& aControlWS,
                                                                             const Plato::ScalarArray3D& aConfigWS)
{
    const Plato::OrdinalType tNumCells = mSpatialDomain.numCells();
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionGeneral<EvaluationType>::computeStructuralMass()
{
