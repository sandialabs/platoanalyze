...
class PhysicsScalarFunction : public ScalarFunctionBase, public Plato::WorksetBase<typename PhysicsType::ElementType>
{
   ...
   public:
     ...
     **********************************************************************************/
    PhysicsScalarFunction(Plato::SpatialModel& aSpatialModel,
     ...
     * \param [in] aInput scalar function
     **********************************************************************************/
    void setEvaluator(const GradientCFunction& aInput, std::string aName);
     ...
     * \return 1D view with the gradient of the physics scalar function wrt the state variables
     **********************************************************************************/
    Plato::ScalarVector gradient_c(const Plato::Solutions& aSolution,
                                   const Plato::ScalarArray4D& aLocalStates,
                                   const Plato::ScalarVector& aControl,
                                   Plato::OrdinalType aStepIndex,
                                   Plato::Scalar aTimeStep = 0.0) const override;
