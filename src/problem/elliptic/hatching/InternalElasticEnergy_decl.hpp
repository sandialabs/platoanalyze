...
class InternalElasticEnergy : public EvaluationType::ElementType,
                              public Plato::Elliptic::Hatching::AbstractScalarFunction<EvaluationType>
{
   ...
   public:
     ...
     **********************************************************************************/
    void evaluate_conditional(const Plato::ScalarMultiVectorT<GlobalStateScalarType>& aGlobalState,
