...
std::shared_ptr<Plato::Elliptic::Hatching::ScalarFunctionBase> ScalarFunctionBaseFactory<PhysicsType>::create(
    ...
    std::string& aFunctionName)
{
    ...
    {
        return std::make_shared<PhysicsScalarFunction<PhysicsType>>(aSpatialModel, aSequence, aDataMap, aProblemParams,
                                                                    aFunctionName);
    }
    else
    {
