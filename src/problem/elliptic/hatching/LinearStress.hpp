...
class LinearStress : ElementType
{
   ...
   public:
     ...
     **********************************************************************************/
    LinearStress(const Plato::Matrix<mNumVoigtTerms, mNumVoigtTerms> aCellStiffness) : mCellStiffness(aCellStiffness)
    {
    ...
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType aCellOrdinal,
                                           ...
                                           Plato::ScalarArray3DT<LocalStateT> const& aPrevStrain) const
    {
        // compute stress
        //
        for (Plato::OrdinalType tVoigtIndex_I = 0; tVoigtIndex_I < mNumVoigtTerms; tVoigtIndex_I++)
        {
            ...
            {
                aCauchyStress(tVoigtIndex_I) += (aStrainInc(tVoigtIndex_J) - mReferenceStrain(tVoigtIndex_J) +
                                                 aPrevStrain(aCellOrdinal, aGpOrdinal, tVoigtIndex_J)) *
