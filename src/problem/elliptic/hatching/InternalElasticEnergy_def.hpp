...
#include "problem/elliptic/hatching/LinearStress.hpp"
...
InternalElasticEnergy<EvaluationType, IndicatorFunctionType>::InternalElasticEnergy(
    ...
    : Plato::Elliptic::Hatching::AbstractScalarFunction<EvaluationType>(
          aSpatialDomain, aDataMap, aProblemParams, aFunctionName),
 ...
 **********************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void InternalElasticEnergy<EvaluationType, IndicatorFunctionType>::evaluate_conditional(
