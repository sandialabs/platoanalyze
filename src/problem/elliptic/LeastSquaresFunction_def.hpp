...
#include "problem/elliptic/LeastSquaresFunction_decl.hpp"
 ...
 **********************************************************************************/
template <typename PhysicsType>
void LeastSquaresFunction<PhysicsType>::updateProblem(const Plato::ScalarVector& aState,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::Scalar LeastSquaresFunction<PhysicsType>::value(const Plato::Solutions& aSolution,
                                                       ...
                                                       Plato::Scalar aTimeStep) const
{
    ...
    for (Plato::OrdinalType tFunctionIndex = 0; tFunctionIndex < mScalarFunctionBaseContainer.size(); ++tFunctionIndex)
    {
        ...
        tResult += tFunctionWeight * std::pow((tFunctionValue - tFunctionGoldValue) / tFunctionScale, 2);
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector LeastSquaresFunction<PhysicsType>::gradient_x(const Plato::Solutions& aSolution,
                                                                  const Plato::ScalarVector& aControl,
                                                                  Plato::Scalar aTimeStep) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector LeastSquaresFunction<PhysicsType>::gradient_u(const Plato::Solutions& aSolution,
                                                                  const Plato::ScalarVector& aControl,
                                                                  ...
                                                                  Plato::Scalar aTimeStep) const
{
    ...
    {
        for (Plato::OrdinalType tFunctionIndex = 0; tFunctionIndex < mScalarFunctionBaseContainer.size();
             ++tFunctionIndex)
        {
            const Plato::Scalar tFunctionWeight = mFunctionWeights[tFunctionIndex];
            const Plato::Scalar tFunctionGoldValue = mFunctionGoldValues[tFunctionIndex];
            ...
            Kokkos::parallel_for(
                "Least Squares Function Summation Grad U", Kokkos::RangePolicy<>(0, tNumDofs),
                KOKKOS_LAMBDA(const Plato::OrdinalType& tDof) {
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector LeastSquaresFunction<PhysicsType>::gradient_z(const Plato::Solutions& aSolution,
                                                                  const Plato::ScalarVector& aControl,
                                                                  Plato::Scalar aTimeStep) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
void LeastSquaresFunction<PhysicsType>::setGradientWRTStateIsZeroFlag(bool aGradientWRTStateIsZero)
{
