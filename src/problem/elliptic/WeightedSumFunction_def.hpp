...
void WeightedSumFunction<PhysicsType>::initialize(Teuchos::ParameterList& aProblemParams)
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
void WeightedSumFunction<PhysicsType>::appendFunctionWeight(Plato::Scalar aWeight)
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
void WeightedSumFunction<PhysicsType>::allocateScalarFunctionBase(
 ...
 **********************************************************************************/
template <typename PhysicsType>
void WeightedSumFunction<PhysicsType>::updateProblem(const Plato::ScalarVector& aState,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::Scalar WeightedSumFunction<PhysicsType>::value(const Plato::Solutions& aSolution,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector WeightedSumFunction<PhysicsType>::gradient_x(const Plato::Solutions& aSolution,
                                                                 const Plato::ScalarVector& aControl,
                                                                 Plato::Scalar aTimeStep) const
{
    ...
    for (Plato::OrdinalType tFunctionIndex = 0; tFunctionIndex < mScalarFunctionBaseContainer.size(); ++tFunctionIndex)
    {
        ...
        Plato::ScalarVector tFunctionGradX =
            mScalarFunctionBaseContainer[tFunctionIndex]->gradient_x(aSolution, aControl, aTimeStep);
        Kokkos::parallel_for(
            "Weighted Sum Function Summation Grad X", Kokkos::RangePolicy<>(0, tNumDofs),
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector WeightedSumFunction<PhysicsType>::gradient_u(const Plato::Solutions& aSolution,
                                                                 const Plato::ScalarVector& aControl,
                                                                 ...
                                                                 Plato::Scalar aTimeStep) const
{
    ...
    for (Plato::OrdinalType tFunctionIndex = 0; tFunctionIndex < mScalarFunctionBaseContainer.size(); ++tFunctionIndex)
    {
        ...
        Plato::ScalarVector tFunctionGradU =
            mScalarFunctionBaseContainer[tFunctionIndex]->gradient_u(aSolution, aControl, aTimeStep);
        Kokkos::parallel_for(
            "Weighted Sum Function Summation Grad U", Kokkos::RangePolicy<>(0, tNumDofs),
            KOKKOS_LAMBDA(const Plato::OrdinalType& tDof) {
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector WeightedSumFunction<PhysicsType>::gradient_z(const Plato::Solutions& aSolution,
                                                                 const Plato::ScalarVector& aControl,
                                                                 Plato::Scalar aTimeStep) const
{
    ...
    for (Plato::OrdinalType tFunctionIndex = 0; tFunctionIndex < mScalarFunctionBaseContainer.size(); ++tFunctionIndex)
    {
        ...
        Plato::ScalarVector tFunctionGradZ =
            mScalarFunctionBaseContainer[tFunctionIndex]->gradient_z(aSolution, aControl, aTimeStep);
        Kokkos::parallel_for(
            "Weighted Sum Function Summation Grad Z", Kokkos::RangePolicy<>(0, tNumDofs),
            KOKKOS_LAMBDA(const Plato::OrdinalType& tDof) {
 ...
 **********************************************************************************/
template <typename PhysicsType>
void WeightedSumFunction<PhysicsType>::setFunctionName(const std::string aFunctionName)
{
