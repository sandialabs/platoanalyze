...
void VolumeIntegralCriterion<EvaluationType>::initialize(Teuchos::ParameterList& aInputParams)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void VolumeIntegralCriterion<EvaluationType>::readInputs(Teuchos::ParameterList& aInputParams)
{
    ...
    {
        ANALYZE_THROWERR(
            "A penalty function type other than SIMP is not yet implemented for the VolumeIntegralCriterion.")
    }
 ...
 **********************************************************************************/
template <typename EvaluationType>
void VolumeIntegralCriterion<EvaluationType>::setVolumeIntegratedQuantity(
 ...
 **********************************************************************************/
template <typename EvaluationType>
void VolumeIntegralCriterion<EvaluationType>::setSpatialWeightFunction(std::string aWeightFunctionString)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void VolumeIntegralCriterion<EvaluationType>::updateProblem(const Plato::ScalarMultiVector& aStateWS,
 ...
 **********************************************************************************/
template <typename EvaluationType>
void VolumeIntegralCriterion<EvaluationType>::evaluate_conditional(
    ...
    Plato::Scalar aTimeStep) const
{
    auto tSpatialWeights =
        Plato::computeSpatialWeights<ConfigT, ElementType>(mSpatialDomain, aConfigWS, mSpatialWeightFunction);
    ...
    Kokkos::parallel_for(
        "compute volume", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
        KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal, const Plato::OrdinalType iGpOrdinal) {
            ...
            ResultT tValue = tVolumeIntegratedQuantity(iCellOrdinal) * tCellVolume *
                             tSpatialWeights(iCellOrdinal * tNumPoints + iGpOrdinal);
