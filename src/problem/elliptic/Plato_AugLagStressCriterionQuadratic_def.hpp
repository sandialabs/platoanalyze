...
void AugLagStressCriterionQuadratic<EvaluationType>::initialize(Teuchos::ParameterList& aInputParams)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::readInputs(Teuchos::ParameterList& aInputParams)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::updateAugLagPenaltyMultipliers()
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::Scalar AugLagStressCriterionQuadratic<EvaluationType>::getAugLagPenalty() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::ScalarVector AugLagStressCriterionQuadratic<EvaluationType>::getLagrangeMultipliers() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::setLocalMeasure(
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::setLocalMeasureValueLimit(const Plato::Scalar& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::setAugLagPenalty(const Plato::Scalar& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::setLagrangeMultipliers(const Plato::ScalarVector& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::updateProblem(const Plato::ScalarMultiVector& aStateWS,
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::evaluate_conditional(
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterionQuadratic<EvaluationType>::updateLagrangeMultipliers(
    ...
    Kokkos::parallel_for(
        "elastic energy", Kokkos::RangePolicy<>(0, tNumCells), KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal) {
            ...
            const Plato::Scalar tLocalMeasureValueOverLimit =
                tLocalMeasureValue(iCellOrdinal) / tLocalMeasureValueLimit;
            ...
            const Plato::Scalar tTrialMultiplier =
                tLagrangeMultipliers(iCellOrdinal) + (tAugLagPenalty * tTrueConstraintValue);
