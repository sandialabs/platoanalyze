...
void MassPropertiesFunction<PhysicsType>::initialize(Teuchos::ParameterList& aInputParams)
{
    for (const auto& tDomain : mSpatialModel.mDomains)
    {
        ...
        if (tMaterialModelsInputs.isSublist(tDomain.materialName()))
        {
            auto tMaterialModelInputs = aInputParams.sublist(tDomain.materialName());
 ...
 **********************************************************************************/
template <typename PhysicsType>
std::shared_ptr<Plato::Elliptic::ScalarFunctionBase> MassPropertiesFunction<PhysicsType>::getFirstMomentOverMassRatio(
    const plato::domain::SpatialModel& aSpatialModel, const std::string& aMomentType)
{
    ...
    std::shared_ptr<Plato::Elliptic::PhysicsScalarFunction<PhysicsType>> tDenominator = getMassFunction(aSpatialModel);
 ...
 **********************************************************************************/
template <typename PhysicsType>
std::shared_ptr<Plato::Elliptic::ScalarFunctionBase> MassPropertiesFunction<PhysicsType>::getSecondMassMoment(
    const plato::domain::SpatialModel& aSpatialModel, const std::string& aMomentType)
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
std::shared_ptr<Plato::Elliptic::ScalarFunctionBase> MassPropertiesFunction<PhysicsType>::getMomentOfInertia(
 ...
 **********************************************************************************/
template <typename PhysicsType>
void MassPropertiesFunction<PhysicsType>::updateProblem(const Plato::ScalarVector& aState,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::Scalar MassPropertiesFunction<PhysicsType>::value(const Plato::Solutions& aSolution,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector MassPropertiesFunction<PhysicsType>::gradient_u(const Plato::Solutions& aSolution,
                                                                    const Plato::ScalarVector& aControl,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector MassPropertiesFunction<PhysicsType>::gradient_x(const Plato::Solutions& aSolution,
                                                                    const Plato::ScalarVector& aControl,
                                                                    Plato::Scalar aTimeStep) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector MassPropertiesFunction<PhysicsType>::gradient_z(const Plato::Solutions& aSolution,
                                                                    const Plato::ScalarVector& aControl,
                                                                    Plato::Scalar aTimeStep) const
{
