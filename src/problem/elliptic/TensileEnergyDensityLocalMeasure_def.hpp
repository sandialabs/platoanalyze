...
#include "local_operations/constitutive/TensileEnergyDensity.hpp"
    ...
    Teuchos::ParameterList& aInputParams)
{
    ...
    else
    {
        throw std::runtime_error(
            "Tensile Energy Density requires Isotropic Linear Elastic Material Model in ParameterList");
    }
}
 ...
 **********************************************************************************/
template <typename EvaluationType>
void TensileEnergyDensityLocalMeasure<EvaluationType>::computeLameConstants()
{
    mLameConstantMu =
        mYoungsModulus / (static_cast<Plato::Scalar>(2.0) * (static_cast<Plato::Scalar>(1.0) + mPoissonsRatio));
 ...
 **********************************************************************************/
template <typename EvaluationType>
void TensileEnergyDensityLocalMeasure<EvaluationType>::operator()(const Plato::ScalarMultiVectorT<StateT>& aStateWS,
                                                                  ...
                                                                  Plato::ScalarVectorT<ResultT>& aResultWS)
{
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal, const Plato::OrdinalType iGpOrdinal) {
            ...
            tComputeTensileEnergyDensity(iCellOrdinal, tPrincipalStrain, tLameLambda, tLameMu, tWeightTimesDet,
                                         aResultWS);
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal) { aResultWS(iCellOrdinal) /= tCellVolume(iCellOrdinal); });
}
}  // namespace Plato
// namespace Plato
