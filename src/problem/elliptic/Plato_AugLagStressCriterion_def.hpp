 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::readInputs(Teuchos::ParameterList& aInputParams)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::updateAugLagPenaltyMultipliers()
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::Scalar AugLagStressCriterion<EvaluationType>::getAugLagPenalty() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::Scalar AugLagStressCriterion<EvaluationType>::getMassMultipliersUpperBound() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::Scalar AugLagStressCriterion<EvaluationType>::getMassNormalizationMultiplier() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::ScalarVector AugLagStressCriterion<EvaluationType>::getMassMultipliers() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
Plato::ScalarVector AugLagStressCriterion<EvaluationType>::getLagrangeMultipliers() const
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::setStressLimit(const Plato::Scalar& aInput)
{
    mStressLimit = aInput;
}
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::setAugLagPenalty(const Plato::Scalar& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::setCellMaterialDensity(const Plato::Scalar& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::setMassMultipliers(const Plato::ScalarVector& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::setLagrangeMultipliers(const Plato::ScalarVector& aInput)
{
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::setCellStiffMatrix(
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::updateProblem(const Plato::ScalarMultiVector& aStateWS,
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::evaluate_conditional(const Plato::ScalarMultiVectorT<StateT>& aStateWS,
                                                                 ...
                                                                 Plato::Scalar aTimeStep) const
{
    ...
    Kokkos::parallel_for(
        "elastic energy", Kokkos::RangePolicy<>(0, tNumCells), KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal) {
            ControlT tCellDensity(0.0);
            ResultT tVonMises(0.0), tMassMultiplierMeasure(0.0);
            ...
            ResultT tPenalizedStressConstraint = tVonMisesOverStressLimit > static_cast<ResultT>(1.0)
                                                     ? tSuggestedPenalizedStressConstraint
                                                     : static_cast<ResultT>(0.0);
            ...
            ResultT tRelaxedStressConstraint =
                (tPenalizedStressConstraint > tLambdaOverPenalty) ? tPenalizedStressConstraint : tLambdaOverPenalty;

            // Compute Von Mises stress contribution to augmented Lagrangian function
            ResultT tStressContribution =
                (tLagrangeMultipliers(iCellOrdinal) +
                 static_cast<Plato::Scalar>(0.5) * tAugLagPenalty * tRelaxedStressConstraint) *
                tRelaxedStressConstraint;

            // Compute mass contribution to augmented Lagrangian function
            ResultT tMassContribution =
                (tMassMultipliers(iCellOrdinal) * tCellMaterialDensity * tCellMass) / tMassNormalizationMultiplier;

            // Compute augmented Lagrangian
            aResultWS(iCellOrdinal) =
                tMassContribution + (static_cast<Plato::Scalar>(1.0 / tNumCells) * tStressContribution);
        });
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::updateMultipliers(const Plato::ScalarMultiVector& aStateWS,
                                                              const Plato::ScalarMultiVector& aControlWS,
                                                              const Plato::ScalarArray3D& aConfigWS)
{
    const Plato::OrdinalType tNumCells = mSpatialDomain.numCells();
    ...
    Kokkos::parallel_for(
        "elastic energy", Kokkos::RangePolicy<>(0, tNumCells), KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal) {
            ...
            tMassMultipliers(iCellOrdinal) = tMassMultiplierMeasure > static_cast<Plato::Scalar>(1.0)
                                                 ? Plato::max2(tOptionOne, tMassMultiplierLowerBound)
                                                 : Plato::min2(tOptionTwo, tMassMultiplierUpperBound);
            ...
            tLagrangeMultipliers(iCellOrdinal) =
                Plato::max2(tSuggestedLagrangeMultiplier, static_cast<Plato::Scalar>(0.0));
        });
}
 ...
 **********************************************************************************/
template <typename EvaluationType>
void AugLagStressCriterion<EvaluationType>::computeStructuralMass()
{
    ...
    auto tCellMaterialDensity = mCellMaterialDensity;
    Kokkos::parallel_for(
        "elastic energy", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
