...
class ElectroelastostaticResidual : public EvaluationType::ElementType,
...
/******************************************************************************/
{
   private:
    ...
    std::optional<Plato::NaturalBCs<ElementType, NElecDims, mNumDofsPerNode, EDofOffset>> mBoundaryCharges;
   ...
   public:
    /**************************************************************************/
    ElectroelastostaticResidual(const Plato::SpatialDomain& aSpatialDomain,
