#ifndef PLATO_ELLIPTIC_FINITEDEFORMATIONMECHANICS_STRAININVARIANT_DECL_H
#define PLATO_ELLIPTIC_FINITEDEFORMATIONMECHANICS_STRAININVARIANT_DECL_H
...
{
/// @brief criterion that computes a specified strain invariant at each integration point.
...
class StrainInvariant : public EvaluationType::ElementType,
