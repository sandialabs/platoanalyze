...
void DivisionFunction<PhysicsType>::initialize(Teuchos::ParameterList& aProblemParams)
{
    ...
    mScalarFunctionBaseNumerator = tFactory.create(mSpatialModel, mDataMap, aProblemParams, tNumeratorFunctionName);

    mScalarFunctionBaseDenominator = tFactory.create(mSpatialModel, mDataMap, aProblemParams, tDenominatorFunctionName);
}
 ...
 **********************************************************************************/
template <typename PhysicsType>
void DivisionFunction<PhysicsType>::allocateNumeratorFunction(
    const std::shared_ptr<Plato::Elliptic::ScalarFunctionBase>& aInput)
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
void DivisionFunction<PhysicsType>::allocateDenominatorFunction(
    const std::shared_ptr<Plato::Elliptic::ScalarFunctionBase>& aInput)
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
void DivisionFunction<PhysicsType>::updateProblem(const Plato::ScalarVector& aState,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::Scalar DivisionFunction<PhysicsType>::value(const Plato::Solutions& aSolution,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector DivisionFunction<PhysicsType>::gradient_x(const Plato::Solutions& aSolution,
                                                              const Plato::ScalarVector& aControl,
                                                              Plato::Scalar aTimeStep) const
{
    ...
    Kokkos::parallel_for(
        "Division Function Grad X", Kokkos::RangePolicy<>(0, tNumDofs), KOKKOS_LAMBDA(const Plato::OrdinalType& tDof) {
            tGradientX(tDof) = (tNumeratorGradX(tDof) * tDenominatorValue - tDenominatorGradX(tDof) * tNumeratorValue) /
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector DivisionFunction<PhysicsType>::gradient_u(const Plato::Solutions& aSolution,
                                                              const Plato::ScalarVector& aControl,
                                                              ...
                                                              Plato::Scalar aTimeStep) const
{
    ...
    Kokkos::parallel_for(
        "Division Function Grad U", Kokkos::RangePolicy<>(0, tNumDofs), KOKKOS_LAMBDA(const Plato::OrdinalType& tDof) {
            tGradientU(tDof) = (tNumeratorGradU(tDof) * tDenominatorValue - tDenominatorGradU(tDof) * tNumeratorValue) /
                               (tDenominatorValueSquared);
        });
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector DivisionFunction<PhysicsType>::gradient_z(const Plato::Solutions& aSolution,
                                                              const Plato::ScalarVector& aControl,
                                                              Plato::Scalar aTimeStep) const
{
    ...
    Kokkos::parallel_for(
        "Division Function Grad Z", Kokkos::RangePolicy<>(0, tNumDofs), KOKKOS_LAMBDA(const Plato::OrdinalType& tDof) {
            tGradientZ(tDof) = (tNumeratorGradZ(tDof) * tDenominatorValue - tDenominatorGradZ(tDof) * tNumeratorValue) /
                               (tDenominatorValueSquared);
        });
