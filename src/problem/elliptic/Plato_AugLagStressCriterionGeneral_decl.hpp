...
class AugLagStressCriterionGeneral : public EvaluationType::ElementType,
                                     public Plato::Elliptic::AbstractScalarFunction<EvaluationType>
{
   private:
    ...
    Plato::Scalar
        mMassCriterionWeight; /*!< weight for mass term, i.e. /f$ \alpha_{\mbox{mass}} * f_{\mbox{mass}} /f$ */
    Plato::Scalar mStressCriterionWeight;       /*!< weight for constraint term, i.e. /f$ \alpha_{\mbox{constraint}} *
                                                   f_{\mbox{constraint}} /f$ */
