...
TEUCHOS_UNIT_TEST(ElastostaticTests, 3D)
{
    ...
    Kokkos::View<Plato::Scalar*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged> u_host_view(u_host.data(), u_host.size());
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const int cellOrdinal, const int gpOrdinal) {
            ...
            for (int iVoigt = 0; iVoigt < tNumVoigtTerms; iVoigt++) tStrains(cellOrdinal, iVoigt) = tStrain(iVoigt);

            tVoigtStress(tStress, tStrain);
            for (int iVoigt = 0; iVoigt < tNumVoigtTerms; iVoigt++) tStresses(cellOrdinal, iVoigt) = tStress(iVoigt);
    ...
    for (int iCell = 0; iCell < numGoldCells; iCell++)
    {
        for (int iNode = 0; iNode < tNodesPerCell; iNode++)
        {
            for (int iDim = 0; iDim < tSpatialDims; iDim++)
            {
                ...
                {
                    TEST_FLOATING_EQUALITY(tGradient_Host(iCell, iNode, iDim), tGradient_gold[iCell][iNode][iDim],
                                           1e-13);
                }
            }
        }
    ...
    std::vector<std::vector<Plato::Scalar>> tStrain_gold = {
        {0.0054, 0.0018, 0.0006, 0.0024, 0.0060, 0.0072}, {0.0054, 0.0018, 0.0006, 0.0024, 0.0060, 0.0072},
        {0.0054, 0.0018, 0.0006, 0.0024, 0.0060, 0.0072}, {0.0054, 0.0018, 0.0006, 0.0024, 0.0060, 0.0072},
        {0.0054, 0.0018, 0.0006, 0.0024, 0.0060, 0.0072}, {0.0054, 0.0018, 0.0006, 0.0024, 0.0060, 0.0072}};
    ...
    std::vector<std::vector<Plato::Scalar>> tStress_gold = {{8653.846153846152, 5884.615384615384, 4961.538461538462,
                                                             923.0769230769231, 2307.692307692308, 2769.230769230769},
                                                            {8653.846153846152, 5884.615384615384, 4961.538461538462,
                                                             923.0769230769231, 2307.692307692308, 2769.230769230769},
                                                            {8653.846153846152, 5884.615384615384, 4961.538461538462,
                                                             923.0769230769231, 2307.692307692308, 2769.230769230769},
                                                            {8653.846153846152, 5884.615384615384, 4961.538461538462,
    ...
    std::vector<std::vector<Plato::Scalar>> tResult_gold = {
        {-115.3846153846154, -245.1923076923076, -38.46153846153845, 264.4230769230769, 76.92307692307693,
         -110.5769230769230, -245.1923076923076, 129.8076923076923, -57.69230769230768, 96.15384615384616,
         38.46153846153845, 206.7307692307692},
        {-115.3846153846154, -245.1923076923076, -38.46153846153846, 19.23076923076923, 206.7307692307692,
         -168.2692307692307, -264.4230769230768, -76.92307692307693, 110.5769230769230, 360.5769230769230,
         115.3846153846154, 96.15384615384616},
    };
...
TEUCHOS_UNIT_TEST(ElastostaticTests, Residual3D)
{
    ...
    Plato::Elliptic::VectorFunction<::Plato::Mechanics<Plato::Tet4>> esVectorFunction(
    ...
    std::vector<Plato::Scalar> residual_gold = {
        -1144.230769230769, -798.0769230769229, -682.6923076923076, -1427.884615384615, -1081.730769230769,
        -403.8461538461537, -283.6538461538461, -283.6538461538461, 278.8461538461538,  -1370.192307692307,
        -461.5384615384612, -908.6538461538460, -2163.461538461538, -692.3076923076923, -576.9230769230769,
        -793.2692307692304, -230.7692307692308, 331.7307692307693,  -225.9615384615384, 336.5384615384614,
        -225.9615384615383, -735.5769230769222, 389.4230769230768,  -173.0769230769231, -509.6153846153846,
        0.5015625000000010, 1.003125000000002,  3.009375000000004,  2.006250000000002,  0.5015625000000008,
        2.006250000000004,  1.50468750000000};
    ...
    std::vector<Plato::Scalar> grad_x_gold = {
        10.16250000000000,  0.7125000000000001,  -2.437500000000000, 9.713942307692305,  -0.7745192307692330,
        1.748076923076921,  -0.4485576923076922, -1.487019230769231, 4.185576923076923,  8.779326923076917,
        4.932692307692306,  -4.374519230769231,  6.499038461538459,  6.178846153846154,  2.059615384615383,
        -2.280288461538460, 1.246153846153845,   6.434134615384615,  -1.383173076923076, 4.220192307692306,
        -1.937019230769230, -3.214903846153847,  6.953365384615383,  0.3115384615384613, -1.831730769230766,
        2.733173076923077,  2.248557692307692,   11.99423076923077,  -2.020673076923078, -4.686057692307688,
        12.92884615384615,  -7.727884615384617,  1.436538461538468,  0.9346153846153846, -5.707211538461538,
        6.122596153846152,  11.05961538461539,   3.686538461538455,  -10.80865384615385, 0.00000000000000,
...
TEUCHOS_UNIT_TEST(DerivativeTests, StressPNorm3D)
{
    ...
    Teuchos::RCP<Teuchos::ParameterList> tParamList = Teuchos::getParametersFromXmlString(
        ...
        "        <Parameter name='Type' type='string' value='Voigt Tensor L2' /> \n"
        "      </ParameterList> \n"
        "      <ParameterList name='Penalty Function'>                                 \n"
        "        <Parameter name='Exponent' type='double' value='1.0'/>                \n"
        "        <Parameter name='Minimum Value' type='double' value='0.0'/>           \n"
    ...
    std::vector<Plato::Scalar> grad_u_gold = {
        -136045.3530811711, -117804.6353496175, -111724.3961057662, -194947.6707559799, -173058.8094781152,
        -12768.50241208767, -58902.31767480877, -55254.17412849799, 98955.89369367871,  -193123.5989828244,
        -14592.57418524276, -163938.4506123385, -368006.4802340950, -21888.86127786443, -18240.71773155366,
        -174882.8812512706, -7296.287092621476, 145697.7328807848,  -57078.24590165332, 103212.0611643744,
        -52214.05450657228, -173058.8094781151, 151169.9482002509,  -5472.215319466181, -115980.5635764621,
        47957.88703587653,  46741.83918710628,  -20064.78950470938, -165762.5223854940, -158466.2352928726,
        -21888.86127786437, -324228.7576783666, -7296.287092621540, -1824.071773155300, -158466.2352928726,
        151169.9482002512};
    ...
    std::vector<Plato::Scalar> grad_z_gold = {
        380.1479579741605, 506.8639439655473, 126.7159859913868, 506.8639439655473, 760.2959159483208,
        253.4319719827737, 126.7159859913868, 253.4319719827736, 126.7159859913870, 506.8639439655479,
        760.2959159483213, 253.4319719827739, 760.2959159483212, 1520.591831896641, 760.2959159483211,
        253.4319719827736, 760.2959159483206, 506.8639439655473, 126.7159859913873, 253.4319719827741,
        126.7159859913868, 253.4319719827742, 760.2959159483217, 506.8639439655475, 126.7159859913868,
        506.8639439655471, 380.1479579741601};
    ...
    std::vector<Plato::Scalar> grad_x_gold = {
        1889.624352503137,  573.5565681715406, 134.8673067276750,  1929.468920298000,  558.6789827717420,
        228.4649895877097,  39.84456779486254, -14.87758539979850, 93.59768286003472,  1880.218982422804,
        668.9783228047302,  96.27678827685651, 1950.502747932197,  734.6449066383240,  244.8816355461080,
        70.28376550939277,  65.66658383359324, 148.6048472692513,  -9.405370080332322, 95.42175463319003,
        -38.59051845081814, 21.03382763419772, 175.9659238665815,  16.41664595839830,  30.43919771453029,
        80.54416923339170,  55.00716440921650, 1859.185154788609,  493.0123989381497,  79.86014231845859,
        1908.435092663803,  382.7130589051604, 212.0483436293115,  49.24993787519501,  -110.2993400329887,
        132.1882013108530,  1809.935216913413, 603.3117389711377,  -52.32805899239442, 0.000000000000000,
        0.000000000000000,  0.0000000000000000};
...
TEUCHOS_UNIT_TEST(DerivativeTests, EffectiveEnergy3D_ShearCellProblem)
{
    ...
    //
    std::vector<Plato::Scalar> solution_gold = {0,
                                                0,
                                                0,
                                                0,
                                                0,
                                                ...
                                                0,
                                                -0.00415282392026578451,
                                                0.0833333333333333426,
                                                -5.44375829931787534e-18,
                                                -4.39093400669304936e-18,
                                                0,
                                                0,
                                                0.00415282392026578278,
                                                0,
                                                0,
                                                0,
                                                0,
    ...
    Kokkos::View<Plato::Scalar*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged> tHostView(solution_gold.data(),
                                                                                       solution_gold.size());
    ...
    std::vector<Plato::Scalar> grad_u_gold = {0,
                                              32051.28205128205,
                                              32051.28205128205,
                                              0,
                                              0,
    ...
    std::vector<Plato::Scalar> grad_z_gold = {
        12052.5066019252044, 15975.7272765993694, 3989.77234006303706, 15975.7272765993694, 24105.0132038504162,
        8029.45842916773017, 3989.77234006303706, 8029.45842916773017, 4006.41025641025590, 16125.4685237243357,
        24005.1857057671004, 7912.99301473719970, 24005.1857057671004, 48210.0264077008178, 24005.1857057671004,
        7912.99301473719970, 24005.1857057671004, 16125.4685237243339, 4006.41025641025590, 8029.45842916773017,
        3989.77234006303706, 8029.45842916773017, 24105.0132038504162, 15975.7272765993694, 3989.77234006303706,
        15975.7272765993694, 12052.5066019252044};
    ...
    std::vector<Plato::Scalar> grad_x_gold = {-32051.2820512820472,
                                              -32184.3853820597978,
                                              -32184.3853820597942,
                                              -48076.9230769230708,
                                              -47943.8197461453237,
                                              ...
                                              31918.1787205042965,
                                              -48076.9230769230708,
                                              1.08002495835535228e-12,
                                              -47943.8197461453237,
                                              -96153.8461538461415,
                                              1.81898940354585648e-12,
                                              -1.81898940354585648e-12,
                                              -48076.9230769230708,
                                              0,
                                              48210.0264077008178,
                                              ...
                                              47810.7164153675694,
                                              3.63797880709171295e-12,
                                              2.89901436190120876e-12,
                                              -96153.8461538461561,
                                              0,
                                              -1.81898940354585648e-12,
                                              -1.81898940354585648e-12,
                                              3.63797880709171295e-12,
                                              -5.45696821063756943e-12,
                                              96153.8461538461561,
                                              5.68434188608080149e-13,
                                              47810.7164153675694,
                                              -47810.7164153675694,
                                              3.63797880709171295e-12,
                                              96153.8461538461561,
...
TEUCHOS_UNIT_TEST(DerivativeTests, EffectiveEnergy3D_NormalCellProblem)
{
    ...
    std::vector<Plato::Scalar> solution_gold = {
        0.000000000000000000,   0.0000000000000000000,  0.00000000000000000,     0.000000000000000000,
        0.0000000000000000000,  -0.0156569934602977037, 0.000000000000000000,    0.0000000000000000000,
        0.00000000000000000,    0.000000000000000000,   -0.0156569934602976933,  0.00000000000000000,
        0.000000000000000000,   -0.0179154946192411728, -0.0179154946192411797,  0.000000000000000000,
        23720.8110818120258, 10095.2840528259185, 23720.8110818120258, 13061.7278050108744, 66029.7816635471245,
        90094.2200129909324, 26122.2272325746198, 90094.2200129909470, 155699.063565457996, 71259.5965853674861,
        26122.2272325746198, 71259.5965853674861, 48404.2720297033302, 20641.8333034958050, 40576.6606721150602,
        19634.3310851935239, 40576.6606721150602, 116679.465204682449, 73430.3395317338582, 19634.3310851935203,
        73430.3395317338436, 50097.0261970390711};
    ...
    std::vector<Plato::Scalar> grad_x_gold = {
        -115407.611033288966,     -59890.1173628834731,     -59890.1173628834877,     -170021.296515866125,
        -97126.6548281997821,     -7.27595761418342590e-12, -56227.7474094780482,     -34147.9861350302526,
        82267.7525630205928,      -170021.296515866095,     -6.36646291241049767e-12, -97126.6548281997821,
        -336262.453898992506,     -2.00088834390044212e-11, -1.63709046319127083e-11, -166655.168842329818,
        1.09139364212751389e-11,  146062.077953277621,      -56227.7474094780482,     82267.7525630205928,
        -34147.9861350302526,     -166655.168842329818,     146062.077953277621,      7.27595761418342590e-12,
        -108675.355686216382,     53108.2330767377789,      53108.2330767377862,      -1.45519152283668518e-11,
        -192366.664605835686,     -192366.664605835686,     1.45519152283668518e-11,  -331294.233826283715,
        -2.91038304567337036e-11, 7.27595761418342590e-12,  -142914.075479116524,     177697.165539035719,
        0.00000000000000000,      -7.95807864051312208e-12, -331294.233826283715,     2.91038304567337036e-11,
        1.45519152283668518e-11,  -2.91038304567337036e-11, 2.18278728425502777e-11,  -7.27595761418342590e-12,
        319405.944968142954,      9.09494701772928238e-12,  177697.165539035719,      -142914.075479116524,
        2.91038304567337036e-11,  319405.944968142954,      -1.45519152283668518e-11, 1.45519152283668518e-11,
        156875.561808302155,      156875.561808302155,      109752.733327579175,      -83275.7287566346058,
        -83275.7287566346058,     166485.844925396872,      -245913.755875948555,     -7.95807864051312208e-13,
        55519.7346718637054,      -159224.629283913062,     76203.7706730678328,      166485.844925396843,
        1.45519152283668518e-11,  -245913.755875948525,     337678.479374221119,      0.00000000000000000,
        -5.82076609134674072e-11, 169482.607695184706,      -4.36557456851005554e-11, 209574.634346625826,
        55519.7346718637054,      76203.7706730678183,      -159224.629283913062,     169482.607695184706,
        209574.634346625826,      0.00000000000000000,      115746.258867154844,      124958.705225635247,
        124958.705225635218};
...
{
    Teuchos::RCP<Teuchos::ParameterList> tElasticityParams = Teuchos::getParametersFromXmlString(
        "<ParameterList name='Plato Problem'>                                          \n"
        "  <ParameterList name='Spatial Model'>                                        \n"
        "    <ParameterList name='Domains'>                                            \n"
        "      <ParameterList name='Design Volume'>                                    \n"
    ...
    Plato::Elliptic::Problem<Plato::Mechanics<Plato::Tri3>> tElasticityProblem(tMesh, *tElasticityParams, tMachine);
    ...
    auto tNumDirichletDofs =
        tDirichletIndicesBoundaryX0.size() + tDirichletIndicesBoundaryY0.size() + tDirichletIndicesBoundaryX1.size();
    ...
    Kokkos::parallel_for(
        "set dirichlet values and indices", Kokkos::RangePolicy<>(0, tDirichletIndicesBoundaryX0.size()),
    ...
    Kokkos::parallel_for(
        "set dirichlet values and indices", Kokkos::RangePolicy<>(0, tDirichletIndicesBoundaryY0.size()),
        KOKKOS_LAMBDA(const Plato::OrdinalType& aIndex) {
    ...
    Kokkos::parallel_for(
        "set dirichlet values and indices", Kokkos::RangePolicy<>(0, tDirichletIndicesBoundaryX1.size()),
        KOKKOS_LAMBDA(const Plato::OrdinalType& aIndex) {
            auto tIndex = tOffset + aIndex;
            tDirichletValues(tIndex) = tValueToSet;
    ...
    std::vector<Plato::Scalar> tGold = {
        0.00000000000000000000, 0.0000000000000000000,   0.00000000000000000000, -8.5714285714284777e-05,
        0.00000000000000000000, -0.00017142857142857061, 0.00000000000000000000, -0.00025714285714285672,
        0.00019999999999999939, 0.0000000000000000000,   0.00019999999999999795, -8.5714285714286851e-05,
        0.00019999999999999827, -0.00017142857142857189, 0.00020000000000000042, -0.00025714285714285737,
        0.00039999999999999937, 0.0000000000000000000,   0.00039999999999999872, -8.5714285714287502e-05,
        0.00039999999999999704, -0.00017142857142857611, 0.00040000000000000045, -0.00025714285714286105,
        0.00059999999999999984, 0.0000000000000000000,   0.00059999999999999984, -8.5714285714287529e-05,
        0.00059999999999999984, -0.00017142857142857495, 0.00059999999999999984, -0.00025714285714286295};
...
TEUCHOS_UNIT_TEST(DerivativeTests, referenceStrain3D)
{
    ...
    Plato::ScalarMultiVectorT<Plato::Scalar> stress("stress", numCells, numVoigtTerms);

    Plato::ScalarMultiVector elasticStrain("strain", numCells, numVoigtTerms);
    auto tHostStrain = Kokkos::create_mirror(elasticStrain);
    tHostStrain(0, 0) = 0.0006;
    tHostStrain(1, 0) = 0.006;
    tHostStrain(2, 0) = 0.006;
    tHostStrain(0, 1) = 0.0048;
    tHostStrain(1, 1) = 0.0048;
    tHostStrain(2, 1) = 0.0012;
    tHostStrain(0, 2) = 0.0024;
    tHostStrain(1, 2) = -0.0030;
    tHostStrain(2, 2) = 0.0006;
    tHostStrain(0, 3) = 0.0072;
    tHostStrain(1, 3) = 0.0018;
    tHostStrain(2, 3) = 0.0018;
    tHostStrain(0, 4) = 0.003;
    tHostStrain(1, 4) = 0.0030;
    tHostStrain(2, 4) = 0.0066;
    tHostStrain(0, 5) = 0.0054;
    tHostStrain(1, 5) = 0.0108;
    tHostStrain(2, 5) = 0.0072;

    tHostStrain(3, 0) = 0.012;
    tHostStrain(4, 0) = 0.006;
    tHostStrain(5, 0) = 0.006;
    tHostStrain(3, 1) = -0.0048;
    tHostStrain(4, 1) = 0.0012;
    tHostStrain(5, 1) = 0.0012;
    tHostStrain(3, 2) = 0.0006;
    tHostStrain(4, 2) = 0.0006;
    tHostStrain(5, 2) = 0.0006;
    tHostStrain(3, 3) = -0.0042;
    tHostStrain(4, 3) = 0.0018;
    tHostStrain(5, 3) = 0.0018;
    tHostStrain(3, 4) = 0.0126;
    tHostStrain(4, 4) = 0.0066;
    tHostStrain(5, 4) = 0.0066;
    tHostStrain(3, 5) = 0.0072;
    tHostStrain(4, 5) = 0.0072;
    tHostStrain(5, 5) = 0.0072;
    ...
    Kokkos::parallel_for(
        "referenceStrain", Kokkos::RangePolicy<int>(0, numCells),
        KOKKOS_LAMBDA(int cellOrdinal) { voigtStress(cellOrdinal, stress, elasticStrain); });
