...
#include "material/IsotropicLinearElasticMaterial.hpp"
#include "material/ThermalMassMaterial.hpp"
#include "problem/Analyze_Diagnostics.hpp"
#include "problem/Mechanics.hpp"
#include "problem/elliptic/MassMoment.hpp"
#include "problem/elliptic/PhysicsScalarFunction.hpp"
#include "problem/elliptic/Plato_AugLagStressCriterion.hpp"
#include "problem/elliptic/Plato_AugLagStressCriterionGeneral.hpp"
#include "problem/elliptic/Plato_AugLagStressCriterionQuadratic.hpp"
#include "problem/elliptic/TensileEnergyDensityLocalMeasure.hpp"
#include "problem/elliptic/ThermalVonMisesLocalMeasure.hpp"
#include "problem/elliptic/VonMisesLocalMeasure.hpp"
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLag_Eigenvalue1D)
{
    ...
    Kokkos::parallel_for(
        "Test Computing Eigenvalues", Kokkos::RangePolicy<>(0, tNumCells),
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLag_Eigenvalue2D)
{
    ...
    auto tHostCauchyStrain = Kokkos::create_mirror(tCauchyStrain);
    tHostCauchyStrain(0, 0) = 3.0;
    tHostCauchyStrain(0, 1) = 2.0;
    tHostCauchyStrain(0, 2) = 0.0;
    tHostCauchyStrain(1, 0) = 0.5;
    tHostCauchyStrain(1, 1) = 0.2;
    tHostCauchyStrain(1, 2) = 1.6;
    tHostCauchyStrain(2, 0) = 0.0;
    tHostCauchyStrain(2, 1) = 0.0;
    tHostCauchyStrain(2, 2) = 1.6;
    Kokkos::deep_copy(tCauchyStrain, tHostCauchyStrain);
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLag_Eigenvalue3D)
{
    ...
    tHostCauchyStrain(0, 0) = 3.0;
    tHostCauchyStrain(0, 1) = 2.0;
    tHostCauchyStrain(0, 2) = 1.0;
    tHostCauchyStrain(0, 3) = 0.0;
    tHostCauchyStrain(0, 4) = 0.0;
    tHostCauchyStrain(0, 5) = 0.0;
    tHostCauchyStrain(1, 0) = 0.5;
    tHostCauchyStrain(1, 1) = 0.2;
    tHostCauchyStrain(1, 2) = 0.8;
    tHostCauchyStrain(1, 3) = 1.1;
    tHostCauchyStrain(1, 4) = 1.5;
    tHostCauchyStrain(1, 5) = 0.3;
    tHostCauchyStrain(2, 0) = 1.64913808;
    tHostCauchyStrain(2, 1) = 0.61759347;
    tHostCauchyStrain(2, 2) = 0.33326845;
    tHostCauchyStrain(2, 3) = 0.65938917;
    tHostCauchyStrain(2, 4) = -0.1840644;
    tHostCauchyStrain(2, 5) = 1.55789418;
    Kokkos::deep_copy(tCauchyStrain, tHostCauchyStrain);
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_EvaluateVonMises)
{
    ...
    Kokkos::parallel_for(
        "fill state", Kokkos::RangePolicy<>(0, tNumDofs), KOKKOS_LAMBDA(const Plato::OrdinalType& aOrdinal) {
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_EvalTensileEnergyScalarFuncBase2D)
{
    ...
    const auto tPhysicsScalarFunc =
        std::make_shared<Plato::Elliptic::PhysicsScalarFunction<Plato::Mechanics<Plato::Tri3>>>(tSpatialModel,
                                                                                                tDataMap);

    tPhysicsScalarFunc->setEvaluator(tCriterion, tOnlyDomain.domainName());
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_CheckThermalVonMises3D)
{
    ...
    Kokkos::parallel_for(
        "fill specific vector entry globally", Kokkos::RangePolicy<>(0, tNumDofs / tDofStride),
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_FiniteDiff_TensileEnergyScalarFuncBaseGradZ_3D)
{
    ...
    // ALLOCATE PLATO CRITERION
    Plato::DataMap tDataMap;
    const auto tParsedDomains = plato::domain::parse_domains(*tGenericParamList, tMesh);
    plato::domain::SpatialModel tSpatialModel(tMesh, tParsedDomains, tDataMap);
    ...
    constexpr Plato::Scalar tYoungsModulus = 1.0;
    constexpr Plato::Scalar tPoissonRatio = 0.3;
    const auto tLocalMeasureGradZ = std::make_shared<Plato::TensileEnergyDensityLocalMeasure<GradientZ>>(
        tOnlyDomain, tDataMap, tYoungsModulus, tPoissonRatio, "TensileEnergyDensity");
    const auto tLocalMeasurePODType = std::make_shared<Plato::TensileEnergyDensityLocalMeasure<Residual>>(
        tOnlyDomain, tDataMap, tYoungsModulus, tPoissonRatio, "TensileEnergyDensity");
    ...
    const auto tPhysicsScalarFunc =
        std::make_shared<Plato::Elliptic::PhysicsScalarFunction<Plato::Mechanics<Plato::Tet4>>>(tSpatialModel,
                                                                                                tDataMap);

    tPhysicsScalarFunc->setEvaluator(tCriterionResidual, tOnlyDomain.domainName());
    tPhysicsScalarFunc->setEvaluator(tCriterionGradZ, tOnlyDomain.domainName());
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_FiniteDiff_TensileEnergyScalarFuncBaseGradU_2D)
{
    ...
    constexpr Plato::Scalar tYoungsModulus = 1.0;
    constexpr Plato::Scalar tPoissonRatio = 0.3;
    const auto tLocalMeasureEvaluationType = std::make_shared<Plato::TensileEnergyDensityLocalMeasure<Jacobian>>(
        tOnlyDomain, tDataMap, tYoungsModulus, tPoissonRatio, "TensileEnergyDensity");
    const auto tLocalMeasurePODType = std::make_shared<Plato::TensileEnergyDensityLocalMeasure<Residual>>(
        tOnlyDomain, tDataMap, tYoungsModulus, tPoissonRatio, "TensileEnergyDensity");
    tCriterionResidual->setLocalMeasure(tLocalMeasurePODType, tLocalMeasurePODType);
    ...
    tPhysicsScalarFunc->setEvaluator(tCriterionResidual, tOnlyDomain.domainName());
    tPhysicsScalarFunc->setEvaluator(tCriterionGradU, tOnlyDomain.domainName());
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_EvaluateTensileEnergyDensity3D)
{
    ...
    // ****** TEST OUTPUT/RESULT VALUE FOR EACH CELL ******
    constexpr Plato::Scalar tTolerance = 1e-4;
    std::vector<Plato::Scalar> tGold = {3.024956014559, 3.024956014559, 3.024956014559,
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_FiniteDiff_TensileEnergyCriterionGradZ_2D)
{
    ...
    constexpr Plato::Scalar tYoungsModulus = 1.0;
    constexpr Plato::Scalar tPoissonRatio = 0.3;
    const auto tLocalMeasureEvaluationType = std::make_shared<Plato::TensileEnergyDensityLocalMeasure<GradientZ>>(
        tOnlyDomain, tDataMap, tYoungsModulus, tPoissonRatio, "TensileEnergyDensity");
    const auto tLocalMeasurePODType = std::make_shared<Plato::TensileEnergyDensityLocalMeasure<Residual>>(
        tOnlyDomain, tDataMap, tYoungsModulus, tPoissonRatio, "TensileEnergyDensity");
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_UpdateMultipliers1)
{
    ...
    tHostState(0) = 0.4360751;
    tHostState(1) = 0.2577532;
    tHostState(2) = 0.4132397;
    tHostState(3) = 0.4193760;
    tHostState(4) = 0.4646589;
    tHostState(5) = 0.1790205;
    tHostState(6) = 0.2340891;
    tHostState(7) = 0.4072918;
    tHostState(8) = 0.2111099;
    tHostState(9) = 0.3215880;
    tHostState(10) = 0.2909588;
    tHostState(11) = 0.3515484;
    tHostState(12) = 0.2459138;
    tHostState(13) = 0.3053604;
    tHostState(14) = 0.4808919;
    tHostState(15) = 0.4664780;
    tHostState(16) = 0.3542847;
    tHostState(17) = 0.3869188;
    tHostState(18) = 0.1566410;
    tHostState(19) = 0.3427876;
    tHostState(20) = 0.1065202;
    tHostState(21) = 0.1971547;
    tHostState(22) = 0.1548926;
    tHostState(23) = 0.4216707;
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLagQuadratic_UpdateMultipliers2)
{
    ...
    Plato::ScalarVector tState("State", tNumDofs);
    auto tHostState = Kokkos::create_mirror(tState);
    tHostState(0) = 4.360751;
    tHostState(1) = 2.577532;
    tHostState(2) = 4.132397;
    tHostState(3) = 4.193760;
    tHostState(4) = 4.646589;
    tHostState(5) = 1.790205;
    tHostState(6) = 2.340891;
    tHostState(7) = 4.072918;
    tHostState(8) = 2.111099;
    tHostState(9) = 3.215880;
    tHostState(10) = 2.909588;
    tHostState(11) = 3.515484;
    tHostState(12) = 2.459138;
    tHostState(13) = 3.053604;
    tHostState(14) = 4.808919;
    tHostState(15) = 4.664780;
    tHostState(16) = 3.542847;
    tHostState(17) = 3.869188;
    tHostState(18) = 1.566410;
    tHostState(19) = 3.427876;
    tHostState(20) = 1.065202;
    tHostState(21) = 1.971547;
    tHostState(22) = 1.548926;
    tHostState(23) = 4.216707;
    Kokkos::deep_copy(tState, tHostState);
    Plato::ScalarMultiVectorT<Plato::Scalar> tStateWS("state workset", tNumCells, tDofsPerCell);
    tWorksetBase.worksetState(tState, tStateWS);
    ...
    constexpr Plato::Scalar tTolerance = 1e-4;
    std::vector<Plato::Scalar> tGoldLagrangeMultipliers = {0.131739476, 0.112932370, 0.064022544,
                                                           0.111203340, 0.042183347, 0.219975864};
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLag_VonMises3D)
{
    ...
    Kokkos::parallel_for(
        "Test Von Mises Yield Stress Calculation", Kokkos::RangePolicy<>(0, tNumCells),
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, AugLag_CellDensity)
{
    ...
    Kokkos::parallel_for(
        "Test cell density inline function", Kokkos::RangePolicy<>(0, tNumCells),
        KOKKOS_LAMBDA(Plato::OrdinalType tCellOrdinal) {
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, MassPlusTensileEnergy2D)
{
    ...
    tPhysicsScalarFuncMass->setEvaluator(tMassCriterion, tOnlyDomain.domainName());
    ...
    tPhysicsScalarFuncTensileEnergy->setEvaluator(tTensileEnergyCriterion, tOnlyDomain.domainName());
    ...
    Plato::Scalar tMassGoldValue = pow(static_cast<Plato::Scalar>(tMeshWidth), tSpaceDim) * tPseudoDensity *
                                   tMassFunctionWeight * tMaterialDensity;
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, MassPlusVonMises_GradZ_2D)
{
    ...
    const auto tLocalMeasureGradZ =
        std::make_shared<Plato::VonMisesLocalMeasure<GradientZ>>(tOnlyDomain, tDataMap, tCellStiffMatrix, "VonMises");
    ...
    tPhysicsScalarFuncVonMises->setEvaluator(tCriterionResidual, tOnlyDomain.domainName());
    tPhysicsScalarFuncVonMises->setEvaluator(tCriterionGradZ, tOnlyDomain.domainName());
    ...
    tPhysicsScalarFuncMass->setEvaluator(tMassCriterion, tOnlyDomain.domainName());
    tPhysicsScalarFuncMass->setEvaluator(tMassCriterionGradZ, tOnlyDomain.domainName());
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, MassPlusVonMises_GradU_2D)
{
    ...
    tPhysicsScalarFuncVonMises->setEvaluator(tCriterionResidual, tOnlyDomain.domainName());
    tPhysicsScalarFuncVonMises->setEvaluator(tCriterionGradU, tOnlyDomain.domainName());
    ...
    tPhysicsScalarFuncMass->setEvaluator(tMassCriterion, tOnlyDomain.domainName());
    tPhysicsScalarFuncMass->setEvaluator(tMassCriterionGradU, tOnlyDomain.domainName());
