...
void VolumeAverageCriterion<PhysicsType>::initialize(Teuchos::ParameterList& aInputParams)
{
    auto params = aInputParams.sublist("Criteria").get<Teuchos::ParameterList>(mFunctionName);
    if (params.isType<std::string>("Function")) mSpatialWeightingFunctionString = params.get<std::string>("Function");
                                                       ...
                                                       Teuchos::ParameterList& aInputParams)
{
    ...
    for (const auto& tDomain : mSpatialModel.mDomains)
    {
        ...
        std::shared_ptr<Plato::Elliptic::AbstractScalarFunction<GradientU>> tGradientU =
            tFactory.template createScalarFunction<GradientU>(tDomain, mDataMap, aInputParams, tFunctionType,
                                                              mFunctionName);
        ...
        std::shared_ptr<Plato::Elliptic::AbstractScalarFunction<GradientZ>> tGradientZ =
            tFactory.template createScalarFunction<GradientZ>(tDomain, mDataMap, aInputParams, tFunctionType,
                                                              mFunctionName);
        ...
        std::shared_ptr<Plato::Elliptic::AbstractScalarFunction<GradientX>> tGradientX =
            tFactory.template createScalarFunction<GradientX>(tDomain, mDataMap, aInputParams, tFunctionType,
                                                              mFunctionName);
                                                                 ...
                                                                 Teuchos::ParameterList& aInputParams)
{
    ...
    mDivisionFunction = std::make_shared<Plato::Elliptic::DivisionFunction<PhysicsType>>(aSpatialModel, mDataMap);
 ...
 **********************************************************************************/
template <typename PhysicsType>
void VolumeAverageCriterion<PhysicsType>::updateProblem(const Plato::ScalarVector& aState,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::Scalar VolumeAverageCriterion<PhysicsType>::value(const Plato::Solutions& aSolution,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector VolumeAverageCriterion<PhysicsType>::gradient_u(const Plato::Solutions& aSolution,
                                                                    const Plato::ScalarVector& aControl,
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector VolumeAverageCriterion<PhysicsType>::gradient_x(const Plato::Solutions& aSolution,
                                                                    const Plato::ScalarVector& aControl,
                                                                    Plato::Scalar aTimeStep) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector VolumeAverageCriterion<PhysicsType>::gradient_z(const Plato::Solutions& aSolution,
                                                                    const Plato::ScalarVector& aControl,
                                                                    Plato::Scalar aTimeStep) const
{
