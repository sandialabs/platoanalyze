...
#include "linear_algebra/VectorPNorm.hpp"
...
FluxPNorm<EvaluationType, IndicatorFunctionType>::FluxPNorm(const plato::domain::SpatialDomain& aSpatialDomain,
...
/**************************************************************************/
{
    ...
    mMaterialModel = mmfactory.create(mSpatialDomain.materialName());
...
/**************************************************************************/
{
    ...
    Kokkos::parallel_for(
        "thermal energy", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
...
/**************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void FluxPNorm<EvaluationType, IndicatorFunctionType>::postEvaluate(Plato::ScalarVector resultVector,
...
/**************************************************************************/
{
    ...
    Kokkos::parallel_for(
        "scale vector", Kokkos::RangePolicy<int>(0, numEntries),
        KOKKOS_LAMBDA(int entryOrdinal) { resultVector(entryOrdinal) *= scale; });
}

/**************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void FluxPNorm<EvaluationType, IndicatorFunctionType>::postEvaluate(Plato::Scalar& resultValue)
/**************************************************************************/
{
