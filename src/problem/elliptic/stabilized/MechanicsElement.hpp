...
class MechanicsElement : public TopoElementTypeT, public ElementBase<TopoElementTypeT>
{
   public:
    ...
    static constexpr auto mNumDofsPerNode =
        mNumSpatialDims + 1; /*!< number of degrees of freedom per node { disp_x, disp_y, disp_z, pressure} */
    ...
    static constexpr auto mNumDofsPerCell =
        mNumDofsPerNode * mNumNodesPerCell; /*!< number of degrees of freedom per cell */
