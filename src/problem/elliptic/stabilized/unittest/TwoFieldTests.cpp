...
#include "linear_algebra/Plato_Solve.hpp"
...
#include "local_operations/mapping/StateValues.hpp"
...
TEUCHOS_UNIT_TEST(StabilizedThermomechTests, 3D)
{
    ...
    Kokkos::parallel_for(
        "projected pgrad", Kokkos::RangePolicy<int>(0, tNumCells), KOKKOS_LAMBDA(const int& aCellOrdinal) {
            for (int iNode = 0; iNode < nodesPerCell; iNode++)
            {
                for (int iDim = 0; iDim < spaceDim; iDim++)
                {
                    tPGradWS(aCellOrdinal, iNode * spaceDim + iDim) =
                        (4e-7) * (iNode + 1) * (iDim + 1) * (aCellOrdinal + 1);
                }
            }
        });
...

    {
        ...
        std::vector<std::vector<std::vector<double>>> tGold = {
            {{40026.6844563111663, 0.00000000000000000000, -40026.6844562962651, 73382.2548365577095,
              186791.194129419659, 140093.395597064722}}};
...

    {
        ...
        std::vector<std::vector<double>> gold = {
            {-5837.22481654436342, 0.00000000000000000,  -3057.59395152323759, 0.000000000000000000,
             0.000000000000000000, -6115.18790304649701, 2779.63086502112537,  9450.74494107180726,
             0.000000000000000000, 0.000000000000000000, 4169.44629753170830,  -5837.22481654444073,
             -4725.37247053591454, 0.000000000000000000, 0.000000000000000000, 7782.96642205915214,
             3057.59395152323759,  -1667.77851901265467, 0.000000000000000000, 0.000000000000000000}};
...

    {
        ...
        std::vector<std::vector<Plato::Scalar>> gold = {
            {0.000000000000000000, -1.45833333333333613e-7, 0.000000000000000000,    0.000000000000000000,
             0.000000000000000000, 1.45833333333333613e-7,  0.000000000000000000,    -1.45833333333333613e-7,
             0.000000000000000000, 0.000000000000000000,    -1.45833333333333613e-7, 1.45833333333333613e-7,
...

    {
        ...
        std::vector<std::vector<Plato::Scalar>> gold = {
            {0.000000000000000000,    0.000000000000000000,     0.000000000000000000,     -1.87667717525243086e-20,
             0.000000000000000000,    0.000000000000000000,     0.000000000000000000,     0.000000000000000000,
             1.87667717525243646e-19, 0.000000000000000000,     0.000000000000000000,     0.000000000000000000,
             0.000000000000000000,    -1.31367402267670519e-19, 0.000000000000000000,     0.000000000000000000,
             0.000000000000000000,    0.000000000000000000,     -3.75335435050487918e-20, 0.000000000000000000}};
...

    {
        ...
        std::vector<std::vector<Plato::Scalar>> gold = {
            {0.000000000000000000,      0.000000000000000000,    0.000000000000000000,     0.000000000000000000,
             -0.0000999999999999999912, 0.000000000000000000,    0.000000000000000000,     0.000000000000000000,
             0.000000000000000000,      0.000266666666666666625, 0.000000000000000000,     0.000000000000000000,
             0.000000000000000000,      0.000000000000000000,    -0.000200000000000000010, 0.000000000000000000,
             0.000000000000000000,      0.000000000000000000,    0.000000000000000000,     0.0000333333333333333620}};
...

    {
        ...
        std::vector<std::vector<Plato::Scalar>> gold = {
            {0.000000000000000000,   0.000000000000000000,   0.000000000000000000,   1.87496499999996229e-8,
             0.000000000000000000,   0.000000000000000000,   0.000000000000000000,   0.000000000000000000,
             1.87494999999997670e-8, 0.000000000000000000,   0.000000000000000000,   0.000000000000000000,
             0.000000000000000000,   1.87496124999997648e-8, 0.000000000000000000,   0.000000000000000000,
             0.000000000000000000,   0.000000000000000000,   1.87494874999994966e-8, 0.000000000000000000}};
...

    {
        ...
        std::vector<std::vector<Plato::Scalar>> gold = {
            {0.000000000000000000,   0.000000000000000000,   0.000000000000000000,   0.000000000000000000,
             0.00349999999999998316, 0.000000000000000000,   0.000000000000000000,   0.000000000000000000,
             0.000000000000000000,   0.00500000000000001658, 0.000000000000000000,   0.000000000000000000,
             0.000000000000000000,   0.000000000000000000,   0.00387500000000001645, 0.000000000000000000,
             0.000000000000000000,   0.000000000000000000,   0.000000000000000000,   0.00512500000000001669}};
...
TEUCHOS_UNIT_TEST(StabilizedThermomechTests, StabilizedThermomechResidual3D)
{
    ...
    Plato::Stabilized::VectorFunction<::Plato::Stabilized::Thermomechanics<Plato::Tet4>> vectorFunction(
        tSpatialModel, tDataMap, *params, params->get<std::string>("PDE Constraint"));

    // create input pressure gradient projector
    //
    Teuchos::RCP<Teuchos::ParameterList> paramsProjector = Teuchos::getParametersFromXmlString(
        "<ParameterList name='Plato Problem'>                                                    \n"
    ...
    Plato::blas1::extract<Plato::Stabilized::ThermomechanicsElement<Plato::Tet4>::mNumDofsPerNode,
                          Plato::Stabilized::Thermomechanics<Plato::Tet4>::ProjectorType::ElementType::mProjectionDof>(
        tState, tProjectState);

    // create constraint evaluator
    //
    Plato::Stabilized::VectorFunction<
        ::Plato::Stabilized::Projection<Plato::Tet4, ElementType::mNumDofsPerNode, ElementType::mPressureDofOffset>>
    ...
    std::vector<double> tGold = {
        -30575.9395155763268,     -17789.6375363854313,     -18345.5637093583755,     1.12498049999996111e-7,
        -0.000866666666666666627, -22515.0100071816269,     -17511.6744500184250,     -32521.6811207887404,
        1.49997124999994593e-7,   -0.00119999999999999946,  8060.92950841537277,      277.963086387605472,
        -14176.1174113472043,     3.74993249999989460e-8,   -0.000333333333333333376, -28352.2348238301493,
        -26684.4563043277230,     -18345.5637095877137,     1.49996249999993140e-7,   -0.00100000000000000002,
        -10006.6711151388827,     -35023.3488994538275,     -46697.7985324173933,     2.24994249999989958e-7,
        -0.00180000000000000017,  18345.5637086913339,      -8338.89259512603167,     -28352.2348227046859,
        7.49982499999972219e-8,   -0.000800000000000000147,
    };
    ...
    std::vector<Plato::Scalar> gold_jac_entries = {1.85308724334749870e10,
                                                   0,
                                                   0,
                                                   -0.0208333333333332107,
                                                   0,
                                                   0,
                                                   1.85308724334745827e10,
                                                   0,
                                                   -0.0208333333333332107,
                                                   0,
                                                   0,
                                                   0,
                                                   1.85308724334745789e10,
                                                   -0.0208333333333332107,
                                                   0,
                                                   -0.0208333333333332107,
                                                   -0.0208333333333332107,
                                                   -0.0208333333333332107,
                                                   -2.25701261030292215e-13,
                                                   -3.74999999999997151e-7,
                                                   0,
                                                   0,
                                                   0,
                                                   0,
                                                   499.999999999999943,
                                                   -5.55926173004224968e9,
                                                   0,
                                                   2.77963086502112484e9,
                                                   0,
                                                   0,
                                                   0,
                                                   -5.55926173004224968e9,
                                                   ...
                                                   0,
                                                   0,
                                                   -1.85308724334731412e9,
                                                   -1.85308724334731412e9,
                                                   -7.41234897339007950e9,
                                                   -0.0208333333333333738,
                                                   0,
                                                   -0.0104166666666666054,
                                                   -0.0104166666666666054,
                                                   0.0208333333333332107,
                                                   7.49837536767640727e-14,
                                                   -6.24999999999997060e-8,
                                                   0,
                                                   0,
                                                   0,
                                                   0,
                                                   ...
                                                   -1.85308724334731412e9,
                                                   0,
                                                   -9.26543621673707724e8,
                                                   -0.0104166666666666869,
                                                   0,
                                                   -1.85308724334731412e9,
                                                   -9.26543621673707724e8,
                                                   0,
...
TEUCHOS_UNIT_TEST(PlatoMathFunctors, RowSumSolve)
{
    ...
    Kokkos::parallel_for(
        "state", Kokkos::RangePolicy<int>(0, tNumNodes),
        KOKKOS_LAMBDA(const int& aNodeOrdinal) { tProjectState(aNodeOrdinal) = 1.0 * aNodeOrdinal; });
    ...
    {  // test residual
        ...
        std::vector<Plato::Scalar> tGold = {
            -0.5625000000000000,  -0.1875000000000000,  -0.06249999999999998, -0.7500000000000000,  -0.2500000000000000,
            -0.08333333333333338, -0.1875000000000000,  -0.06250000000000000, -0.02083333333333334, -0.7500000000000000,
            -0.2500000000000000,  -0.08333333333333329, -1.125000000000000,   -0.3750000000000000,  -0.1250000000000001,
    ...
    {  // test jacobian
        ...
        std::vector<Plato::Scalar> tGold = {
            0.0124999999999999053,  0, 0, 0, 0.0124999999999999053,  0, 0, 0, 0.0124999999999999053,
            0.00208333333333332333, 0, 0, 0, 0.00208333333333332333, 0, 0, 0, 0.00208333333333332333,
            0.00208333333333332333, 0, 0, 0, 0.00208333333333332333, 0, 0, 0, 0.00208333333333332333,
            0.00208333333333332333, 0, 0, 0, 0.00208333333333332333, 0, 0, 0, 0.00208333333333332333};
    ...
    {  // test row sum functor
        ...
        Kokkos::parallel_for(
            "row sum inverse", Kokkos::RangePolicy<int>(0, tNumBlockRows), KOKKOS_LAMBDA(int blockRowOrdinal) {
                // compute row sum
        ...
        std::vector<Plato::Scalar> tRowSum_gold = {
            0.0312500000000000000, 0.0312500000000000000, 0.0312500000000000000, 0.0416666666666666713,
            0.0416666666666666713, 0.0416666666666666713, 0.0104166666666666661, 0.0104166666666666661,
            0.0104166666666666661, 0.0416666666666666644, 0.0416666666666666644, 0.0416666666666666644,
            0.0625000000000000000, 0.0625000000000000000, 0.0625000000000000000, 0.0208333333333333322,
            0.0208333333333333322, 0.0208333333333333322, 0.0104166666666666661, 0.0104166666666666661,
            0.0104166666666666661, 0.0208333333333333322, 0.0208333333333333322, 0.0208333333333333322,
            0.0104166666666666661, 0.0104166666666666661, 0.0104166666666666661, 0.0416666666666666644,
            0.0416666666666666644, 0.0416666666666666644, 0.0625000000000000000, 0.0625000000000000000,
            0.0625000000000000000, 0.0208333333333333322, 0.0208333333333333322, 0.0208333333333333322,
            0.0625000000000000000, 0.0625000000000000000, 0.0625000000000000000, 0.124999999999999958,
            0.124999999999999958,  0.124999999999999958,  0.0624999999999999931, 0.0624999999999999931,
            0.0624999999999999931, 0.0208333333333333322, 0.0208333333333333322, 0.0208333333333333322,
            0.0624999999999999931, 0.0624999999999999931, 0.0624999999999999931, 0.0416666666666666644,
            0.0416666666666666644, 0.0416666666666666644, 0.0104166666666666661, 0.0104166666666666661,
            0.0104166666666666661, 0.0208333333333333322, 0.0208333333333333322, 0.0208333333333333322,
            0.0104166666666666661, 0.0104166666666666661, 0.0104166666666666661, 0.0208333333333333322,
            0.0208333333333333322, 0.0208333333333333322, 0.0624999999999999931, 0.0624999999999999931,
            0.0624999999999999931, 0.0416666666666666644, 0.0416666666666666644, 0.0416666666666666644,
            0.0104166666666666661, 0.0104166666666666661, 0.0104166666666666661, 0.0416666666666666644,
            0.0416666666666666644, 0.0416666666666666644, 0.0312500000000000000, 0.0312500000000000000,
    ...
    {  // test row summed solve
        ...
        std::vector<Plato::Scalar> tGold = {
            18.0000000000000000, 5.99999999999999911, 1.99999999999999933, 17.9999999999999964, 5.99999999999999911,
            2.00000000000000089, 18.0000000000000000, 6.00000000000000000, 2.00000000000000000, 18.0000000000000000,
            6.00000000000000000, 1.99999999999999889, 17.9999999999999964, 6.00000000000000000, 2.00000000000000133,
            18.0000000000000000, 6.00000000000000000, 2.00000000000000089, 18.0000000000000000, 5.99999999999999822,
            1.99999999999999956, 17.9999999999999964, 6.00000000000000000, 2.00000000000000133};
