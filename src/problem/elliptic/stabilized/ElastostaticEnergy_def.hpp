...
ElastostaticEnergy<EvaluationType, IndicatorFunctionType>::ElastostaticEnergy(
...
/**************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void ElastostaticEnergy<EvaluationType, IndicatorFunctionType>::evaluate_conditional(
