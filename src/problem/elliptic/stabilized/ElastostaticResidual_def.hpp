...
#include "problem/elliptic/stabilized/Kinetics.hpp"
    ...
    Plato::Scalar aTimeStep) const
{
    ...
    Plato::InterpolateFromNodal<ElementType, mNumSpatialDims, /*dof_offset=*/0, mNumSpatialDims>
    ...
    Kokkos::parallel_for(
        ...
        KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal, const Plato::OrdinalType iGpOrdinal) {
            ...
            tKinetics(tVolume, tProjectedPGrad, tDGrad, tPGrad, tPressure, tDevStress, tVolStrain, tCellStab);
    ...
    {
        toMap(mDataMap, tCellPressure, "pressure", mSpatialDomain);
    }
    if (std::count(mPlottable.begin(), mPlottable.end(), "deviatoric stress"))
    {
        toMap(mDataMap, tCellDevStress, "deviatoric stress", mSpatialDomain);
    }
}
/******************************************************************************/
/**
