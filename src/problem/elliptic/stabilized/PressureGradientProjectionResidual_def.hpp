...
#include "problem/elliptic/stabilized/PressureGradient.hpp"
...
void PressureGradientProjectionResidual<EvaluationType, IndicatorFunctionType>::initialize(
 ...
 **********************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
PressureGradientProjectionResidual<EvaluationType, IndicatorFunctionType>::PressureGradientProjectionResidual(
 ...
 ********************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
Plato::Solutions PressureGradientProjectionResidual<EvaluationType, IndicatorFunctionType>::getSolutionStateOutputData(
 ...
 **********************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void PressureGradientProjectionResidual<EvaluationType, IndicatorFunctionType>::evaluate(
    ...
    Plato::Scalar aTimeStep) const
{
    ...
    Kokkos::parallel_for(
        "Projected pressure gradient residual", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
 ...
 **********************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void PressureGradientProjectionResidual<EvaluationType, IndicatorFunctionType>::updateProblem(
    const Plato::ScalarMultiVector& aState, const Plato::ScalarVector& aControl, Plato::Scalar aTimeStep)
{
