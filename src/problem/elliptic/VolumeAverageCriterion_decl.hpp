...
class VolumeAverageCriterion : public Plato::Elliptic::ScalarFunctionBase,
                               public Plato::WorksetBase<typename PhysicsType::ElementType>
{
   private:
    ...
    std::string mSpatialWeightingFunctionString =
        "1.0"; /*!< Spatial weighting function string of x, y, z coordinates  */
