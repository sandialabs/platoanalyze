...
#include "problem/hyperbolic/AbstractVectorFunction.hpp"
...
class VectorFunction : public Plato::WorksetBase<typename PhysicsType::ElementType>
{
   ...
   public:
        ...
        : Plato::WorksetBase<ElementType>(aSpatialModel.mMesh), mSpatialModel(aSpatialModel), mDataMap(aDataMap)
    {
        ...
        for (const auto& tDomain : mSpatialModel.mDomains)
        {
            ...
            mGradientAFunctions[tName] =
                tFunctionFactory.template createVectorFunction<GradientA>(tDomain, aDataMap, aParamList, aProblemType);
    ...
    VectorFunction(Plato::Mesh aMesh, Plato::DataMap& aDataMap)
        : Plato::WorksetBase<ElementType>(aMesh), mDataMap(aDataMap)
    {
    }
                              ...
                              Plato::Scalar aCurrentTime = 0.0) const
    {
        ...
        for (const auto& tDomain : mSpatialModel.mDomains)
        {
            ...
            Plato::ScalarMultiVectorT<StateDotDotScalar> tStateDotDotWS("StateDotDot Workset", tNumCells,
                                                                        mNumDofsPerCell);
            ...
            mResidualFunctions.at(tName)->evaluate(tStateWS, tStateDotWS, tStateDotDotWS, tControlWS, tConfigWS,
                                                   tResidual, aTimeStep, aCurrentTime);
...

        {
            ...
            mBoundaryLoadsResidualFunction->evaluate_boundary(mSpatialModel, tStateWS, tStateDotWS, tStateDotDotWS,
                                                  ...
                                                  Plato::Scalar aCurrentTime = 0.0) const
    {
        ...
        for (const auto& tDomain : mSpatialModel.mDomains)
        {
            ...
            mGradientXFunctions.at(tName)->evaluate(tStateWS, tStateDotWS, tStateDotDotWS, tControlWS, tConfigWS,
                                                    tJacobian, aTimeStep, aCurrentTime);
...

        {
            ...
            Plato::ScalarMultiVectorT<StateDotDotScalar> tStateDotDotWS("StateDotDot Workset", mNumCells,
                                                                        mNumDofsPerCell);
            Plato::WorksetBase<ElementType>::worksetState(aStateDotDot, tStateDotDotWS);
            ...
            mBoundaryLoadsGradientXFunction->evaluate_boundary(mSpatialModel, tStateWS, tStateDotWS, tStateDotDotWS,
                                                               tControlWS, tConfigWS, tJacobian, aTimeStep,
                                                               aCurrentTime);

            Plato::BlockMatrixEntryOrdinal<mNumSpatialDims, mNumSpatialDims, mNumDofsPerNode> tJacobianMatEntryOrdinal(
                tJacobianMat, tMesh);
                                                  ...
                                                  Plato::Scalar aCurrentTime = 0.0) const
    {
        ...
        for (const auto& tDomain : mSpatialModel.mDomains)
        {
            ...
            mGradientUFunctions.at(tName)->evaluate(tStateWS, tStateDotWS, tStateDotDotWS, tControlWS, tConfigWS,
                                                    tJacobian, aTimeStep, aCurrentTime);
...

        {
            ...
            mBoundaryLoadsGradientUFunction->evaluate_boundary(mSpatialModel, tStateWS, tStateDotWS, tStateDotDotWS,
                                                               tControlWS, tConfigWS, tJacobian, aTimeStep,
                                                               aCurrentTime);
    ...
    Teuchos::RCP<Plato::CrsMatrixType> gradient_v(const Plato::ScalarVector& aState,
                                                  const Plato::ScalarVector& aStateDot,
                                                  const Plato::ScalarVector& aStateDotDot,
                                                  const Plato::ScalarVector& aControl,
                                                  Plato::Scalar aTimeStep,
                                                  Plato::Scalar aCurrentTime = 0.0) const
    {
        ...
        for (const auto& tDomain : mSpatialModel.mDomains)
        {
            ...
            mGradientVFunctions.at(tName)->evaluate(tStateWS, tStateDotWS, tStateDotDotWS, tControlWS, tConfigWS,
                                                    tJacobian, aTimeStep, aCurrentTime);
...

        {
            ...
            mBoundaryLoadsGradientVFunction->evaluate_boundary(mSpatialModel, tStateWS, tStateDotWS, tStateDotDotWS,
                                                               tControlWS, tConfigWS, tJacobian, aTimeStep,
                                                               aCurrentTime);
    ...
    Teuchos::RCP<Plato::CrsMatrixType> gradient_a(const Plato::ScalarVector& aState,
                                                  const Plato::ScalarVector& aStateDot,
                                                  const Plato::ScalarVector& aStateDotDot,
                                                  const Plato::ScalarVector& aControl,
                                                  Plato::Scalar aTimeStep,
                                                  Plato::Scalar aCurrentTime = 0.0) const
    {
        ...
        for (const auto& tDomain : mSpatialModel.mDomains)
        {
            ...
            mGradientAFunctions.at(tName)->evaluate(tStateWS, tStateDotWS, tStateDotDotWS, tControlWS, tConfigWS,
                                                    tJacobian, aTimeStep, aCurrentTime);
...

        {
            ...
            mBoundaryLoadsGradientAFunction->evaluate_boundary(mSpatialModel, tStateWS, tStateDotWS, tStateDotDotWS,
                                                               tControlWS, tConfigWS, tJacobian, aTimeStep,
                                                               aCurrentTime);
    ...
    Teuchos::RCP<Plato::CrsMatrixType> gradient_z(const Plato::ScalarVector& aState,
                                                  const Plato::ScalarVector& aStateDot,
                                                  const Plato::ScalarVector& aStateDotDot,
                                                  const Plato::ScalarVector& aControl,
                                                  Plato::Scalar aTimeStep,
                                                  Plato::Scalar aCurrentTime = 0.0) const
    {
        ...
        for (const auto& tDomain : mSpatialModel.mDomains)
        {
            ...
            mGradientZFunctions.at(tName)->evaluate(tStateWS, tStateDotWS, tStateDotDotWS, tControlWS, tConfigWS,
                                                    tJacobian, aTimeStep, aCurrentTime);
...

        {
            ...
            mBoundaryLoadsGradientZFunction->evaluate_boundary(mSpatialModel, tStateWS, tStateDotWS, tStateDotDotWS,
                                                               tControlWS, tConfigWS, tJacobian, aTimeStep,
                                                               aCurrentTime);
