...
#include "problem/hyperbolic/RayleighStress.hpp"
...
template <typename EvaluationType, typename IndicatorFunctionType>
Plato::Scalar TransientMechanicsResidual<EvaluationType, IndicatorFunctionType>::getMaxEigenvalue(
...
template <typename EvaluationType, typename IndicatorFunctionType>
Plato::Solutions TransientMechanicsResidual<EvaluationType, IndicatorFunctionType>::getSolutionStateOutputData(
...
template <typename EvaluationType, typename IndicatorFunctionType>
void TransientMechanicsResidual<EvaluationType, IndicatorFunctionType>::evaluate(
...
template <typename EvaluationType, typename IndicatorFunctionType>
void TransientMechanicsResidual<EvaluationType, IndicatorFunctionType>::evaluateWithoutDamping(
    const Plato::ScalarMultiVectorT<StateScalarType>& aState,
    const Plato::ScalarMultiVectorT<StateDotScalarType>& aStateDot,
    const Plato::ScalarMultiVectorT<StateDotDotScalarType>& aStateDotDot,
    const Plato::ScalarMultiVectorT<ControlScalarType>& aControl,
...
template <typename EvaluationType, typename IndicatorFunctionType>
void TransientMechanicsResidual<EvaluationType, IndicatorFunctionType>::evaluateWithDamping(
    const Plato::ScalarMultiVectorT<StateScalarType>& aState,
    const Plato::ScalarMultiVectorT<StateDotScalarType>& aStateDot,
    const Plato::ScalarMultiVectorT<StateDotDotScalarType>& aStateDotDot,
    const Plato::ScalarMultiVectorT<ControlScalarType>& aControl,
    ...
    Plato::Scalar aCurrentTime) const
{
    ...
    Plato::ScalarMultiVectorT<VelGradScalarType> tCellVelGrad("velgrad", tNumCells, mNumVoigtTerms);
    ...
    if (std::count(mPlotTable.begin(), mPlotTable.end(), "velgrad"))
    {
        Plato::toMap(mDataMap, tCellVelGrad, "velgrad", mSpatialDomain);
    }
    if (std::count(mPlotTable.begin(), mPlotTable.end(), "strain"))
    {
        Plato::toMap(mDataMap, tCellStrain, "strain", mSpatialDomain);
