...
Plato::Scalar testVectorFunction_Partial_z(
    VectorFunctionT& aVectorFunction, VectorT aU, VectorT aV, VectorT aA, ControlT aControl, Plato::Scalar aTimeStep)
{
...
TEUCHOS_UNIT_TEST(TransientMechanicsElementTests, ElementFunctors3D)
{
    ...
    Kokkos::View<Plato::Scalar*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged> a_host_view(a_host.data(), a_host.size());
    ...
    for (int iCell = 0; iCell < int(tInertialContent_gold.size()); iCell++)
    {
        for (int iGp = 0; iGp < tNumPoints; iGp++)
        {
            for (int iDim = 0; iDim < tSpatialDims; iDim++)
            {
                ...
                {
                    TEST_FLOATING_EQUALITY(tInertialContent_Host(iCell, iGp, iDim),
                                           tInertialContent_gold[iCell][iGp][iDim], 1e-13);
                }
            }
        }
    }
    ...
    std::vector<std::vector<Plato::Scalar>> tResult_gold = {
        {-115.359584134615361, -245.165870192307693, -38.4336947115384504, 264.458233173076906, 76.9596394230769221,
         -110.538954326923118, -245.164745192307606, 129.836661057692311, -57.6619326923076869, 96.1898461538461333,
         38.4989447115384493, 206.769581730769261},
        {-115.366334134615386, -245.172620192307647, -38.4404447115384542, 19.2515817307692281, 206.752987980769205,
         -168.245605769230764, -264.401420673076814, -76.9000144230769394, 110.601391826923063, 360.606173076923028,
         115.415271634615380, 96.1859086538461696}};
...
TEUCHOS_UNIT_TEST(TransientMechanicsProblemTests, 3D)
{
    ...
    //
    Teuchos::RCP<Teuchos::ParameterList> tInputParams = Teuchos::getParametersFromXmlString(
        "<ParameterList name='Plato Problem'>                                      \n"
    ...
    Plato::Hyperbolic::Problem<Plato::Hyperbolic::Mechanics<Plato::Tet4>> tProblem(tMesh, *tInputParams, tMachine);
    ...
    std::vector<Plato::Scalar> tDisplacement_gold = {
        2.10816942698054615984187e-12,  -2.52418580606097773558868e-14, -2.52418580606097773558868e-14,
        7.18574825931105206768831e-13,  -6.57398927754318208407556e-15, 1.09680935499520513093439e-14,
        -7.17183093247985723454205e-14, 2.84200697348839217896060e-16,  7.06752621625155373438040e-15,
        7.18574825931105206768831e-13,  1.09680935499520513093439e-14,  -6.57398927754318208407556e-15};
    ...
    for (int iNode = 0; iNode < int(tDisplacement_gold.size()); iNode++)
    {
        ...
        {
            TEST_FLOATING_EQUALITY(tDisplacement_Host[iNode], tDisplacement_gold[iNode], 1e-3);
        }
    }
...
TEUCHOS_UNIT_TEST(TransientMechanicsResidualTests, 3D_NoMass)
{
    ...
    std::vector<Plato::Scalar> tResidualZero_gold = {0,
                                                     0,
                                                     0,
                                                     0,
                                                     0,
    ...
    std::vector<Plato::Scalar> tResidual_gold = {-917857.142857142724,   -692857.142857142841, -617857.142857142724,
    ...
    std::vector<Plato::Scalar> gold_jac_entries = {
        2.73809523809523804e11, 0.000000000000000000,    0.000000000000000000,   0.000000000000000000,
        2.73809523809523834e11, 0.000000000000000000,    0.000000000000000000,   0.000000000000000000,
        2.73809523809523804e11, -4.16666666666666718e10, 0.000000000000000000,   2.08333333333333359e10,
        0.000000000000000000,   -4.16666666666666718e10, 2.08333333333333359e10, 5.35714285714285660e10,
        5.35714285714285660e10, -1.90476190476190460e11};
    ...
    std::vector<Plato::Scalar> gold_tGradientX_entries = {
        -1.47857142857142817229033e6, -1.47857142857142840512097e6, -1.47857142857142840512097e6,
        -492857.142857142898719758,   -492857.142857142956927419,   -492857.142857142724096775,
        -164285.714285714173456654,   -164285.714285714260768145,   -164285.714285714202560484,
        -189285.714285714377183467,   -114285.714285714202560484,   360714.285714285622816533};
    ...
    std::vector<Plato::Scalar> gold_tGradientZ_entries = {
        -229464.285714285681024194, -173214.285714285710128024, -154464.285714285681024194, -67857.1428571428550640121,
        -67857.1428571428550640121, 88839.2857142856810241938,  -58482.1428571428550640121, 98214.2857142857101280242,
        -58482.1428571428405120969, -126339.285714285695576109, 30357.1428571428441500757,  30357.1428571428405120969};
...
TEUCHOS_UNIT_TEST(TransientMechanicsResidualTests, 3D_WithMass)
{
    ...
    std::vector<Plato::Scalar> tResidual_gold = {-917772.767857142724,   -692772.767857142841, -617772.767857142724,
    ...
    std::vector<Plato::Scalar> gold_jacA_entries = {0.03375, 0, 0, 0, 0.03375, 0, 0, 0, 0.03375};
    ...
    std::vector<Plato::Scalar> gold_tGradientX_entries = {
        -1.47862767857142817229033e6, -1.47862767857142840512097e6, -1.47862767857142840512097e6,
        -492913.392857142898719758,   -492913.392857142956927419,   -492913.392857142724096775,
        -164341.964285714173456654,   -164341.964285714260768145,   -164341.964285714202560484,
        -189285.714285714377183467,   -114285.714285714202560484,   360714.285714285622816533,
    };
    ...
    std::vector<Plato::Scalar> gold_tGradientZ_entries = {
        -229430.535714284342247993, -173180.535714284691493958, -154430.535714284778805450, -67851.5178571424476103857,
        -67851.5178571424476103857, 88844.9107142851862590760,  -58476.5178571424839901738, 98219.9107142851426033303,
        -58476.5178571425058180466, -126333.660714284953428432, 30362.7678571426804410294,  30362.7678571426768030506};
...
TEUCHOS_UNIT_TEST(TransientMechanicsIntegratorTests, NewmarkUForm)
{
    ...
    Plato::Scalar tU_pred_val =
        tU_Prev_val + tTimeStep * tV_Prev_val + tTimeStep * tTimeStep / 2.0 * (1.0 - 2.0 * tBeta) * tA_Prev_val;

    Plato::Scalar tV_pred_val = tV_Prev_val + (1.0 - tGamma) * tTimeStep * tA_Prev_val;
    ...
    auto tResidualV = tIntegrator.v_value(tU, tU_Prev, tV, tV_Prev, tA, tA_Prev, tTimeStep);
    ...
    auto tResidualA = tIntegrator.a_value(tU, tU_Prev, tV, tV_Prev, tA, tA_Prev, tTimeStep);
...
TEUCHOS_UNIT_TEST(TransientMechanicsIntegratorTests, NewmarkAForm)
{
    ...
    auto tResidualU = tIntegrator.u_value(tU, tU_Prev, tV, tV_Prev, tA, tA_Prev, tTimeStep);
...
TEUCHOS_UNIT_TEST(TransientMechanicsResidualTests, 3D_ScalarFunction)
{
    ...
    Kokkos::parallel_for(
        "initial data", Kokkos::RangePolicy<int>(0, tNumDofs), KOKKOS_LAMBDA(int aDofOrdinal) {
    ...
    std::vector<Plato::Scalar> tObjGradU_gold = {
        -1.83571428571428544819355e6, -1.38571428571428568102419e6, -1.23571428571428568102419e6,
        -2.37857142857142817229033e6, -1.92857142857142840512097e6, -525000.000000000000000000,
        -542857.142857142724096775,   -542857.142857142724096775,   710714.285714285448193550,
        -2.30357142857142817229033e6, -600000.000000000116415322,   -1.70357142857142840512097e6};
    ...
    std::vector<Plato::Scalar> tObjGradX_gold = {
        17.4942857142857093322164,  1.44857142857142950909122, -3.89999999999999902300374, 16.2321428571428540976740,
        -1.16357142857142981107188, 2.89928571428571357770920, -1.26214285714285767703302, -2.61214285714285665562784,
        6.79928571428571260071294,  15.0171428571428560161394, 8.29285714285714092852686,  -7.09714285714285608719365};
    ...
    std::vector<Plato::Scalar> tObjGradZ_gold = {
        2.46535714285712792559480,  3.28714285714284315531586, 0.821785714285715562787971, 3.28714285714284315531586,
        4.93071428571427627929324,  1.64357142857143134762055, 0.821785714285715784832576, 1.64357142857143156966515,
...
TEUCHOS_UNIT_TEST(TimeDependentBCsTests, EssentialBoundaryDofValuesMatchFunctionValues)
{
    ...
    Teuchos::RCP<Teuchos::ParameterList> tInputParams = Teuchos::getParametersFromXmlString(
        ...
        "      <Parameter name='Index'  type='int'           value='0'/>     \n"
        "      <Parameter name='Sides'  type='string'        value='x+'/>          \n"
        "      <Parameter name='Function' type='string' value='w=2e-6; p=0.01; pi=3.14159264; "
        "-p*(pi*pi/w/w)*sin(pi*t/w)'/> \n"
        "    </ParameterList>                                                      \n"
        "  </ParameterList>                                                        \n"
    ...
    // construct problem
    //
    auto tProblem = std::make_unique<Plato::Hyperbolic::Problem<Plato::Hyperbolic::Mechanics<Plato::Tet4>>>(
...
TEUCHOS_UNIT_TEST(TransientMechanicsFormulationTests, UFormAndAFormEquivalenceWithConstantNaturalBCs)
{
    ...
    //
    Teuchos::RCP<Teuchos::ParameterList> tInputParamsUForm = Teuchos::getParametersFromXmlString(
        "<ParameterList name='Plato Problem'>                                      \n"
        "  <Parameter name='PDE Constraint' type='string' value='Hyperbolic'/>     \n"
        "  <Parameter name='Physics' type='string' value='Mechanical'/>            \n"
        "  <Parameter name='Self-Adjoint' type='bool' value='false'/>              \n"
    ...
    //
    Teuchos::RCP<Teuchos::ParameterList> tInputParamsAForm = Teuchos::getParametersFromXmlString(
        "<ParameterList name='Plato Problem'>                                      \n"
        "  <Parameter name='PDE Constraint' type='string' value='Hyperbolic'/>     \n"
        "  <Parameter name='Physics' type='string' value='Mechanical'/>            \n"
        "  <Parameter name='Self-Adjoint' type='bool' value='false'/>              \n"
    ...
    //
    auto tProblemUForm = std::make_unique<Plato::Hyperbolic::Problem<Plato::Hyperbolic::Mechanics<Plato::Tet4>>>(
        tMesh, *tInputParamsUForm, tMachine);

    // create a-form problem
    //
    auto tProblemAForm = std::make_unique<Plato::Hyperbolic::Problem<Plato::Hyperbolic::Mechanics<Plato::Tet4>>>(
    ...
    {
        TEST_FLOATING_EQUALITY(tDisplacementAForm_Host[iNode], tDisplacementUForm_Host[iNode], 1e-12);
    }
    ...
    {
        TEST_FLOATING_EQUALITY(tVelocityAForm_Host[iNode], tVelocityUForm_Host[iNode], 1e-12);
    }
    ...
    {
        TEST_FLOATING_EQUALITY(tAccelerationAForm_Host[iNode], tAccelerationUForm_Host[iNode], 1e-12);
    }
}
...
TEUCHOS_UNIT_TEST(TransientMechanicsFormulationTests, UFormAndAFormEquivalenceWithInitialConditions)
{
    ...
    for (int iNode = 0; iNode < int(tDisplacementUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tDisplacementAForm_Host[iNode], tDisplacementUForm_Host[iNode], 1e-5);
    }
    ...
    for (int iNode = 0; iNode < int(tVelocityUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tVelocityAForm_Host[iNode], tVelocityUForm_Host[iNode], 1e-5);
    }
    ...
    for (int iNode = 0; iNode < int(tAccelerationUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tAccelerationAForm_Host[iNode], tAccelerationUForm_Host[iNode], 1e-5);
    }
}
...
TEUCHOS_UNIT_TEST(TransientMechanicsFormulationTests, UFormAndAFormEquivalenceWithTimeDependentNaturalBCs)
{
    ...
    Teuchos::RCP<Teuchos::ParameterList> tInputParamsUForm = Teuchos::getParametersFromXmlString(
        ...
        "    <ParameterList  name='Traction Vector Boundary Condition'>            \n"
        "      <Parameter name='Type'   type='string'        value='Uniform'/>     \n"
        "      <Parameter name='Values' type='Array(string)' value='{0.0, w=2e-6; p=1.5e8; pi=3.14159264; "
        "p*sin(pi*t/w)^2, 0.0}'/> \n"
        "      <Parameter name='Sides'  type='string'        value='x+'/>          \n"
        "    </ParameterList>                                                      \n"
        "  </ParameterList>                                                        \n"
    ...
    for (int iNode = 0; iNode < int(tDisplacementUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tDisplacementAForm_Host[iNode], tDisplacementUForm_Host[iNode], 1e-8);
    }
    ...
    for (int iNode = 0; iNode < int(tVelocityUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tVelocityAForm_Host[iNode], tVelocityUForm_Host[iNode], 1e-8);
    }
    ...
    for (int iNode = 0; iNode < int(tAccelerationUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tAccelerationAForm_Host[iNode], tAccelerationUForm_Host[iNode], 1e-8);
    }
}
...
TEUCHOS_UNIT_TEST(TransientMechanicsFormulationTests, UFormAndAFormEquivalenceWithTimeDependentEssentialBCs)
{
    ...
    for (int iNode = 0; iNode < int(tDisplacementUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tDisplacementAForm_Host[iNode], tDisplacementUForm_Host[iNode], 1.6e-0);
    }
    ...
    for (int iNode = 0; iNode < int(tVelocityUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tVelocityAForm_Host[iNode], tVelocityUForm_Host[iNode], 1e-0);
    }
    ...
    for (int iNode = 0; iNode < int(tAccelerationUForm_Host.size()); iNode++)
    {
        TEST_FLOATING_EQUALITY(tAccelerationAForm_Host[iNode], tAccelerationUForm_Host[iNode], 1e-0);
    }
}
