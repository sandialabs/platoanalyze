...
{
   private:
    std::unordered_map<std::string, std::shared_ptr<Plato::MetaDataBase>>
        mData; /*!< map from tag to metadata shared pointer */
...
struct LocalOrdinalMaps
{
    Plato::NodeCoordinate<PhysicsType::ElementType::mNumSpatialDims, PhysicsType::ElementType::mNumNodesPerCell>
        mNodeCoordinate; /*!< list of node coordinates */
    Plato::VectorEntryOrdinal<PhysicsType::ElementType::mNumSpatialDims, 1 /*scalar dofs per node*/>
        mScalarFieldOrdinalsMap; /*!< element to scalar field degree of freedom map */
    Plato::VectorEntryOrdinal<PhysicsType::ElementType::mNumSpatialDims, PhysicsType::ElementType::mNumSpatialDims>
        mVectorFieldOrdinalsMap; /*!< element to vector field degree of freedom map */
    Plato::VectorEntryOrdinal<PhysicsType::ElementType::mNumSpatialDims,
                              PhysicsType::ElementType::mNumControlDofsPerNode>
        mControlOrdinalsMap; /*!< element to control field degree of freedom map */
