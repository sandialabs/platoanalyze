...
#include "problem/hyperbolic/fluids/AbstractVolumetricSource.hpp"
...
class StabilizedUniformThermalSource : public Plato::AbstractVolumetricSource<PhysicsT, EvaluationT>
{
   private:
    ...
    static constexpr auto mNumTempDofsPerCell =
        PhysicsT::SimplexT::mNumEnergyDofsPerCell; /*!< number of degrees of freedom per cell */
   ...
   public:
     ...
     ******************************************************************************/
    StabilizedUniformThermalSource(const std::string& aFuncName,
     ...
     ******************************************************************************/
    std::string type() const override { return "uniform stabilized"; }
                  ...
                  Plato::Scalar aMultiplier = 1.0) const override
    {
        ...
        if (tEvaluateDomain)
        {
            ...
            Plato::ScalarMultiVectorT<CurVelT> tCurVelGP("current velocity at Gauss points", tNumCells,
                                                         mNumVelDofsPerNode);
            ...
            Kokkos::parallel_for(
                "intergate stabilizing thermal source term", Kokkos::RangePolicy<>(0, tNumCells),
                KOKKOS_LAMBDA(const Plato::OrdinalType& aCellOrdinal) {
                    ...
                    ControlT tPenalizedDimlessConstant = Plato::Fluids::penalize_heat_source_constant<mNumNodesPerCell>(
                        aCellOrdinal, tUnpenalizedConstant, tPenaltyExponent, tControlWS);
                    ...
                    Plato::Fluids::integrate_scalar_field<mNumTempDofsPerCell>(aCellOrdinal, tBasisFunctions,
                                                                               ...
                                                                               -tTimeStepTimesPenalizedDimlessConstant);
        ...
        if (tEvaluateDomain)
        {
            ...
            Kokkos::parallel_for(
                ...
                KOKKOS_LAMBDA(const Plato::OrdinalType& aCellOrdinal) {
                    ...
                    Plato::Fluids::integrate_scalar_field<mNumTempDofsPerCell>(aCellOrdinal, tBasisFunctions,
                                                                               tCellVolume, tThermalSource, aResultWS,
                                                                               -tTimeStepTimesDimlessConstant);

                    // 3. add stabilizing thermal source contribution to residual, i.e. R -= \alpha_{stab} *
                    // Q_u(u^{n+1})
...
PLATO_EXPL_DEC_FLUIDS(
    Plato::Fluids::StabilizedUniformThermalSource, Plato::EnergyConservation, Plato::SimplexFluids, 1, 1)
PLATO_EXPL_DEC_FLUIDS(
    Plato::Fluids::SIMP::StabilizedUniformThermalSource, Plato::EnergyConservation, Plato::SimplexFluids, 1, 1)
#endif

#ifdef PLATOANALYZE_2D
PLATO_EXPL_DEC_FLUIDS(
    Plato::Fluids::StabilizedUniformThermalSource, Plato::EnergyConservation, Plato::SimplexFluids, 2, 1)
PLATO_EXPL_DEC_FLUIDS(
    Plato::Fluids::SIMP::StabilizedUniformThermalSource, Plato::EnergyConservation, Plato::SimplexFluids, 2, 1)
#endif

#ifdef PLATOANALYZE_3D
PLATO_EXPL_DEC_FLUIDS(
    Plato::Fluids::StabilizedUniformThermalSource, Plato::EnergyConservation, Plato::SimplexFluids, 3, 1)
PLATO_EXPL_DEC_FLUIDS(
    Plato::Fluids::SIMP::StabilizedUniformThermalSource, Plato::EnergyConservation, Plato::SimplexFluids, 3, 1)
#endif
