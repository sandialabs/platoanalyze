...
#include "problem/hyperbolic/fluids/FluidsVolumeIntegrandFactory.hpp"
...
class TemperatureResidual : public Plato::Fluids::AbstractVectorFunction<PhysicsT, EvaluationT>
{
   private:
    ...
    std::shared_ptr<Plato::AbstractVolumeIntegrand<PhysicsT, EvaluationT>>
        mInternalForces; /*!< internal force evaluator */
   ...
   public:
     ...
     ******************************************************************************/
    TemperatureResidual(const Plato::SpatialDomain& aDomain, Plato::DataMap& aDataMap, Teuchos::ParameterList& aInputs)
                            ...
                            Plato::ScalarMultiVectorT<ResultT>& aResultWS) const override
    {
        if (mHeatFlux != nullptr)
        {
            ...
            auto tPrevTempWS =
                Plato::metadata<Plato::ScalarMultiVectorT<PrevTempT>>(aWorkSets.get("previous temperature"));
            ...
            Kokkos::parallel_for(
                "heat flux contribution", Kokkos::RangePolicy<>(0, tNumCells),
   ...
   private:
     ...
     * \param [in] aInputs  input file metadata
     ******************************************************************************/
    void initializeNaturalBoundaryConditions(Teuchos::ParameterList& aInputs)
    {
