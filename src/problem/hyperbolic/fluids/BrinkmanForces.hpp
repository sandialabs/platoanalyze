...
class BrinkmanForces
{
   ...
   public:
     ...
     ******************************************************************************/
    BrinkmanForces(const Plato::SpatialDomain& aDomain, Plato::DataMap& aDataMap, Teuchos::ParameterList& aInputs)
        : mDataMap(aDataMap),
     ...
     ******************************************************************************/
    void evaluate(const Plato::WorkSets& aWorkSets, Plato::ScalarMultiVectorT<ResultT>& aResultWS) const
    {
        ...
        Kokkos::parallel_for(
            "brinkman force evaluator", Kokkos::RangePolicy<>(0, tNumCells),
            KOKKOS_LAMBDA(const Plato::OrdinalType& aCellOrdinal) {
                ...
                Plato::Fluids::calculate_brinkman_forces<mNumSpatialDims>(aCellOrdinal, tPenalizedPermeability,
                                                                          tPrevVelGP, tBrinkman);
   ...
   private:
     ...
     * \param [in] aInputs  input file metadata
     ******************************************************************************/
    void setImpermeability(Teuchos::ParameterList& aInputs)
    {
        ...
        if (Plato::Fluids::is_material_property_defined("Impermeability Number", tMyMaterialName, aInputs))
        {
            // all use cases
            mImpermeability =
                Plato::Fluids::get_material_property<Plato::Scalar>("Impermeability Number", tMyMaterialName, aInputs);
        }
                 ...
                 Plato::Fluids::is_material_property_defined("Prandtl Number", tMyMaterialName, aInputs))
        {
            ...
            auto tPrNum =
                Plato::Fluids::get_material_property<Plato::Scalar>("Prandtl Number", tMyMaterialName, aInputs);
                 ...
                 Plato::Fluids::is_material_property_defined("Reynolds Number", tMyMaterialName, aInputs))
        {
            ...
            auto tDaNum = Plato::Fluids::get_material_property<Plato::Scalar>("Darcy Number", tMyMaterialName, aInputs);
            auto tReNum =
                Plato::Fluids::get_material_property<Plato::Scalar>("Reynolds Number", tMyMaterialName, aInputs);
