...
class MomentumConservation : public Plato::SimplexFluids<SpaceDim, NumControls>
{
   public:
    ...
    static constexpr Plato::OrdinalType mNumDofsPerNode =
        SimplexT::mNumMomentumDofsPerNode; /*!< number of momentum degress of freedom per node */
    static constexpr Plato::OrdinalType mNumDofsPerCell =
        SimplexT::mNumNodesPerCell * mNumDofsPerNode; /*!< number of momentum degress of freedom per cell */
};
// class MomentumConservation
...
class MassConservation : public Plato::SimplexFluids<SpaceDim, NumControls>
{
   public:
    ...
    static constexpr Plato::OrdinalType mNumDofsPerNode =
        SimplexT::mNumMassDofsPerNode; /*!< number of mass degress of freedom per node */
    static constexpr Plato::OrdinalType mNumDofsPerCell =
        SimplexT::mNumNodesPerCell * mNumDofsPerNode; /*!< number of mass degress of freedom per cell */
};
// class MassConservation
...
class EnergyConservation : public Plato::SimplexFluids<SpaceDim, NumControls>
{
   public:
    ...
    static constexpr Plato::OrdinalType mNumDofsPerNode =
        SimplexT::mNumEnergyDofsPerNode; /*!< number of energy degress of freedom per node */
    static constexpr Plato::OrdinalType mNumDofsPerCell =
        SimplexT::mNumNodesPerCell * mNumDofsPerNode; /*!< number of energy degress of freedom per cell */
};
// class EnergyConservation
...
class IncompressibleFluids : public Plato::SimplexFluids<SpaceDim, NumControls>
{
   public:
    ...
    using MassPhysicsT =
        typename Plato::MassConservation<SpaceDim, NumControls>; /*!< local mass conservation physics type */
    using EnergyPhysicsT =
        typename Plato::EnergyConservation<SpaceDim, NumControls>; /*!< local energy conservation physics type */
    using MomentumPhysicsT =
        typename Plato::MomentumConservation<SpaceDim, NumControls>; /*!< local momentum conservation physics type */
};
// class IncompressibleFluids
