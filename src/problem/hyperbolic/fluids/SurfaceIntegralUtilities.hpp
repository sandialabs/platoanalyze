...
template <>
template <typename ConfigScalarType, typename ResultScalarType>
KOKKOS_INLINE_FUNCTION void CalculateSurfaceJacobians<1>::operator()(
...
template <>
template <typename ConfigScalarType, typename ResultScalarType>
KOKKOS_INLINE_FUNCTION void CalculateSurfaceJacobians<2>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::OrdinalType& aFaceOrdinal,
    ...
    const Plato::ScalarArray3DT<ResultScalarType>& aJacobian) const
{
    ...
    for (Plato::OrdinalType tNode = 0; tNode < tSpaceDimMinusOne; tNode++)
    {
        ...
        {
            aJacobian(aFaceOrdinal, tNode, tDim) = aConfig(aCellOrdinal, aLocalNodeOrd[tNode], tDim) -
                                                   aConfig(aCellOrdinal, aLocalNodeOrd[tSpaceDimMinusOne], tDim);
        }
    }
}
...
template <>
template <typename ConfigScalarType, typename ResultScalarType>
KOKKOS_INLINE_FUNCTION void CalculateSurfaceJacobians<3>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::OrdinalType& aFaceOrdinal,
...
class CalculateSurfaceArea
{
   public:
     ...
     *******************************************************************************/
    template <typename ConfigScalarType, typename ResultScalarType>
    KOKKOS_INLINE_FUNCTION void operator()(const Plato::OrdinalType& aFaceOrdinal,
...
template <>
template <typename ConfigScalarType, typename ResultScalarType>
KOKKOS_INLINE_FUNCTION void CalculateSurfaceArea<1>::operator()(
    const Plato::OrdinalType& aFaceOrdinal,
    const Plato::Scalar& aMultiplier,
    const Plato::ScalarArray3DT<ConfigScalarType>& aJacobian,
    ResultScalarType& aOutput) const
...
template <>
template <typename ConfigScalarType, typename ResultScalarType>
KOKKOS_INLINE_FUNCTION void CalculateSurfaceArea<2>::operator()(
    const Plato::OrdinalType& aFaceOrdinal,
    const Plato::Scalar& aMultiplier,
    const Plato::ScalarArray3DT<ConfigScalarType>& aJacobian,
    ResultScalarType& aOutput) const
...
template <>
template <typename ConfigScalarType, typename ResultScalarType>
KOKKOS_INLINE_FUNCTION void CalculateSurfaceArea<3>::operator()(
    const Plato::OrdinalType& aFaceOrdinal,
    const Plato::Scalar& aMultiplier,
    const Plato::ScalarArray3DT<ConfigScalarType>& aJacobian,
    ResultScalarType& aOutput) const
{
    ConfigScalarType tJ23 = aJacobian(aFaceOrdinal, 0, 1) * aJacobian(aFaceOrdinal, 1, 2) -
                            aJacobian(aFaceOrdinal, 0, 2) * aJacobian(aFaceOrdinal, 1, 1);
    ConfigScalarType tJ31 = aJacobian(aFaceOrdinal, 0, 2) * aJacobian(aFaceOrdinal, 1, 0) -
                            aJacobian(aFaceOrdinal, 0, 0) * aJacobian(aFaceOrdinal, 1, 2);
    ConfigScalarType tJ12 = aJacobian(aFaceOrdinal, 0, 0) * aJacobian(aFaceOrdinal, 1, 1) -
                            aJacobian(aFaceOrdinal, 0, 1) * aJacobian(aFaceOrdinal, 1, 0);
