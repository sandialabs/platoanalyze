...
class AbstractVectorFunction
{
   ...
   public:
    ...
    AbstractVectorFunction& operator=(const AbstractVectorFunction& aFunction) = delete;
    ...
    const decltype(mDofDotNames)& getDofDotNames() const { return (mDofDotNames); }

    const decltype(mDofDotDotNames)& getDofDotDotNames() const { return (mDofDotDotNames); }
