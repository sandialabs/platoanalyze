...
#include "problem/hyperbolic/Newmark.hpp"
#include "problem/hyperbolic/ScalarFunctionFactory.hpp"
...
Problem<PhysicsType>::Problem(Plato::Mesh aMesh, Teuchos::ParameterList& aProblemParams, Comm::Machine aMachine)
    : AbstractProblem(aMesh, aProblemParams),
      ...
      mStateDotDotBoundaryConditions(aProblemParams.sublist("State Dot Dot Essential Boundary Conditions", false),
                                     aMesh),
...
template <typename PhysicsType>
void Problem<PhysicsType>::parseIntegrator(Teuchos::ParameterList& aProblemParams)
{
...
template <typename PhysicsType>
void Problem<PhysicsType>::allocateStateData()
{
...
template <typename PhysicsType>
void Problem<PhysicsType>::parseCriteria(Teuchos::ParameterList& aProblemParams)
{
...
template <typename PhysicsType>
void Problem<PhysicsType>::parseComputedFields(Teuchos::ParameterList& aProblemParams, Plato::Mesh aMesh)
{
    if (aProblemParams.isSublist("Computed Fields"))
    {
        mComputedFields = Teuchos::rcp(
            new Plato::ComputedFields<ElementType::mNumSpatialDims>(aMesh, aProblemParams.sublist("Computed Fields")));
    }
}

template <typename PhysicsType>
void Problem<PhysicsType>::parseInitialState(Teuchos::ParameterList& aProblemParams)
{
...
template <typename PhysicsType>
void Problem<PhysicsType>::parseLinearSolver(Teuchos::ParameterList& aProblemParams,
                                             Plato::Mesh aMesh,
...
template <typename PhysicsType>
void Problem<PhysicsType>::applyConstraints(const Teuchos::RCP<Plato::CrsMatrixType>& aMatrix,
...
template <typename PhysicsType>
void Problem<PhysicsType>::applyConstraintType(const Teuchos::RCP<Plato::CrsMatrixType>& aMatrix,
                                               const Plato::ScalarVector& aVector,
...
template <typename PhysicsType>
void Problem<PhysicsType>::forwardStepUForm(const Plato::ScalarVector& aControl,
                                            ...
                                            Plato::OrdinalType aStepIndex)
{
    ...
    // R_{v}
    auto tResidualV = mIntegrator->v_value(tDisplacement, tDisplacementPrev, tVelocity, tVelocityPrev, tAcceleration,
                                           tAccelerationPrev, mTimeStep);
    ...
    // R_{a}
    auto tResidualA = mIntegrator->a_value(tDisplacement, tDisplacementPrev, tVelocity, tVelocityPrev, tAcceleration,
                                           tAccelerationPrev, mTimeStep);
...
template <typename PhysicsType>
void Problem<PhysicsType>::forwardStepAForm(const Plato::ScalarVector& aControl,
                                            Plato::Scalar& aCurrentTime,
                                            Plato::OrdinalType aStepIndex)
{
    aCurrentTime += mTimeStep;
    ...
    // R_{u}
    auto tResidualU = mIntegrator->u_value(tDisplacement, tDisplacementPrev, tVelocity, tVelocityPrev, tAcceleration,
                                           tAccelerationPrev, mTimeStep);
...
template <typename PhysicsType>
void Problem<PhysicsType>::computeInitialState(const Plato::ScalarVector& aControl)
{
...
template <typename PhysicsType>
void Problem<PhysicsType>::constrainFieldsAtBoundary(Plato::ScalarVector& aDisplacement,
...
template <typename PhysicsType>
void Problem<PhysicsType>::constrainUFormFieldsAtBoundary(Plato::ScalarVector& aVelocity,
                                                          Plato::ScalarVector& aAcceleration,
                                                          const Plato::Scalar aTime)
{
...
template <typename PhysicsType>
void Problem<PhysicsType>::constrainAFormFieldsAtBoundary(Plato::ScalarVector& aDisplacement,
                                                          Plato::ScalarVector& aVelocity,
                                                          const Plato::Scalar aTime)
{
