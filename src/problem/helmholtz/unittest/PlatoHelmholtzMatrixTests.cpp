...
#include "problem/helmholtz/HelmholtzElement.hpp"
...
TEUCHOS_UNIT_TEST(HelmholtzFilterTests, Tri3MatrixEntries)
{
    ...
    Plato::Helmholtz::VectorFunction<PhysicsType> vectorFunction(tSpatialModel, tDataMap, *tParamList,
    ...
    */
    ...
    const std::vector<Plato::OrdinalType> tColIndices = {0, 1, 2, 3, 0, 1, 3, 0, 2, 3, 0, 1, 2, 3};
    const std::vector<Plato::Scalar> tValuesA = {0.1766666666666667,
                                                 0.0366666666666667,
                                                 0.0366666666666667,
                                                 0.0833333333333333,
                                                 0.0366666666666667,
                                                 0.0933333333333333,
                                                 /* 0.0000000000, */ 0.0366666666666667,
                                                 0.0366666666666667,
                                                 /* 0.0000000000, */ 0.0933333333333333,
                                                 0.0366666666666667,
                                                 0.0833333333333333,
                                                 0.0366666666666667,
                                                 0.0366666666666667,
...
TEUCHOS_UNIT_TEST(HelmholtzFilterTests, Tet4MatrixEntries)
{
    ...
    */
    ...
    const std::vector<Plato::OrdinalType> tColIndices = {0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 3, 5, 7, 0, 2, 3,
    ...
    const std::vector<Plato::Scalar> tValuesA = {
        ...
        0.013333333333333,
        0.040000000000000,
        /* 0.000000000 */ 0.006666666666667,
        /* 0.000000000 */ 0.006666666666667,
        /* 0.000000000 */ 0.016666666666667,
        0.013333333333333,
        /* 0.000000000 */ 0.040000000000000,
        0.006666666666667,
        /* 0.000000000 */ /* 0.000000000 */ 0.006666666666667,
        0.016666666666667,
        0.016666666666667,
        0.006666666666667,
        0.006666666666667,
        0.040000000000000,
        /* 0.000000000 */ /* 0.000000000 */ /* 0.000000000 */ 0.013333333333333,
        0.013333333333333,
        /* 0.000000000 */ /* 0.000000000 */ /* 0.000000000 */ 0.040000000000000,
        0.006666666666667,
        0.006666666666667,
        0.016666666666667,
        0.016666666666667,
