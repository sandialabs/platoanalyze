...
class HelmholtzResidual : public EvaluationType::ElementType,
...
/******************************************************************************/
{
   ...
   public:
    ...
    /**************************************************************************/
    {
        ...
        Kokkos::parallel_for(
            "helmholtz residual", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
            ...
            KOKKOS_LAMBDA(const Plato::OrdinalType& aSideOrdinal, const Plato::OrdinalType& aPointOrdinal) {
                ...
                for (Plato::OrdinalType tNode = 0; tNode < mNumNodesPerFace; tNode++)
                {
                    ...
                    Kokkos::atomic_add(
                        ...
                        tSurfaceLengthScale * tLengthScale * tFilteredDensity * tBasisValues(tNode) * tSurfaceArea);
                }
            });
    }
};
...
#include "problem/helmholtz/ExpInstMacros.hpp"
