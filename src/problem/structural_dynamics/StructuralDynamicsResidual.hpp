...
#include "local_operations/InertialForces.hpp"
...
#include "problem/structural_dynamics/ComplexLinearStress.hpp"
#include "problem/structural_dynamics/ComplexStrain.hpp"
#include "problem/structural_dynamics/ComplexStressDivergence.hpp"
...
class StructuralDynamicsResidual : public Plato::SimplexStructuralDynamics<EvaluationType::SpatialDim>,
...
/******************************************************************************/
{
   ...
   public:
     ...
     *
     **********************************************************************************/
    explicit StructuralDynamicsResidual(const Plato::SpatialDomain& aSpatialDomain,
     ...
     *
     **********************************************************************************/
    explicit StructuralDynamicsResidual(const Plato::SpatialDomain& aSpatialDomain, Plato::DataMap& aDataMap)
        : FunctionBaseType(aSpatialDomain, aDataMap),
          mDensity(1.0),
          mMassPropDamp(0.0),
          mStiffPropDamp(0.0),
     ...
     *
     **********************************************************************************/
    void setMassPropDamping(const Plato::Scalar& aInput) { mMassPropDamp = aInput; }
     ...
     *
     **********************************************************************************/
    void setStiffPropDamping(const Plato::Scalar& aInput) { mStiffPropDamp = aInput; }
     ...
     *
     **********************************************************************************/
    void setMaterialDensity(const Plato::Scalar& aInput) { mDensity = aInput; }
                  ...
                  Plato::Scalar aAngularFrequency = 0.0) const
    {
        ...
        using StrainScalarType = typename Plato::fad_type_t<Plato::SimplexStructuralDynamics<mNumSpatialDims>,
        ...
        Kokkos::parallel_for(
            "Structural Dynamics Residual Calculation", Kokkos::RangePolicy<>(0, tNumCells),
   ...
   private:
    ...
    void initialize(Teuchos::ParameterList& aParamList)
    {
        ...
        {
            mBodyLoads =
                std::make_shared<Plato::BodyLoads<EvaluationType, PhysicsType>>(aParamList.sublist("Body Loads"));
        }

        // Parse Neumann loads
        if (aParamList.isSublist("Natural Boundary Conditions"))
        {
            mBoundaryLoads = std::make_shared<Plato::NaturalBCs<mNumSpatialDims, mNumDofsPerNode>>(
