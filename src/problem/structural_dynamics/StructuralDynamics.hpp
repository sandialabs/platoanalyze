...
struct FunctionFactory
{
    ...
    /******************************************************************************/
    {
        if (aFunctionType == "StructuralDynamics")
        {
            ...
            {
                return std::make_shared<Plato::StructuralDynamicsResidual<EvaluationType, Plato::MSIMP,
                                                                          Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else if (tPenaltyType == "RAMP")
            {
                return std::make_shared<
                    Plato::StructuralDynamicsResidual<EvaluationType, Plato::RAMP, Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else if (tPenaltyType == "NoPenalty")
            {
                return std::make_shared<Plato::StructuralDynamicsResidual<EvaluationType, Plato::NoPenalty,
                                                                          Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else
        ...
        else if (aFunctionType == "StructuralDynamics Adjoint")
        {
            ...
            if (tPenaltyType == "SIMP")
            {
                return std::make_shared<Plato::AdjointStructuralDynamicsResidual<EvaluationType, Plato::MSIMP,
                                                                                 Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else if (tPenaltyType == "RAMP")
            {
                return std::make_shared<Plato::AdjointStructuralDynamicsResidual<EvaluationType, Plato::RAMP,
                                                                                 Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else if (tPenaltyType == "NoPenalty")
            {
                return std::make_shared<Plato::AdjointStructuralDynamicsResidual<EvaluationType, Plato::NoPenalty,
                                                                                 Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else
        ...
        else
        {
            ...
            tErrorMessage
                ...
                << "\n\n"
                << " MESSAGE: UNKNOWN 'PDE CONSTRAINT = " << aFunctionType.c_str()
    ...
    /******************************************************************************/
    {
        if (aFunctionType == "Dynamic Compliance")
        {
            ...
            {
                return std::make_shared<
                    Plato::DynamicCompliance<EvaluationType, Plato::MSIMP, Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else if (tPenaltyType == "RAMP")
            {
                return std::make_shared<
                    Plato::DynamicCompliance<EvaluationType, Plato::RAMP, Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else if (tPenaltyType == "NoPenalty")
            {
                return std::make_shared<
                    Plato::DynamicCompliance<EvaluationType, Plato::NoPenalty, Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, aParamList, tPenaltyParams);
            }
            else
            {
        ...
        else if (aFunctionType == "Volume")
        {
            ...
            if (tPenaltyType == "SIMP")
            {
                return std::make_shared<ExpVolume<EvaluationType, Plato::MSIMP, Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, tPenaltyParams);
            }
            else if (tPenaltyType == "RAMP")
            {
                return std::make_shared<ExpVolume<EvaluationType, Plato::RAMP, Plato::HyperbolicTangentProjection>>(
                    aMesh, aDataMap, tPenaltyParams);
            }
            else if (tPenaltyType == "NoPenalty")
            {
                return std::make_shared<
                    ExpVolume<EvaluationType, Plato::NoPenalty, Plato::HyperbolicTangentProjection>>(aMesh, aDataMap,
                                                                                                     tPenaltyParams);
            }
            else
            {
