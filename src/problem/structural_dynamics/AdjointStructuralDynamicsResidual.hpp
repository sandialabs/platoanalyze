...
#include "local_operations/optimization/ApplyPenalty.hpp"
...
#include "problem/elliptic/AdjointComplexRayleighDamping.hpp"
...
class AdjointStructuralDynamicsResidual : public Plato::SimplexStructuralDynamics<EvaluationType::SpatialDim>,
...
/******************************************************************************/
{
   ...
   public:
     ...
     *
     **********************************************************************************/
    explicit AdjointStructuralDynamicsResidual(const Plato::SpatialDomain& aSpatialDomain,
     ...
     *
     **********************************************************************************/
    explicit AdjointStructuralDynamicsResidual(const Plato::SpatialDomain& aSpatialDomain, Plato::DataMap& aDataMap)
        : FunctionBaseType(aSpatialDomain, aDataMap),
          mDensity(1),
          mMassPropDamp(0.0),
          mStiffPropDamp(0.0),
                  ...
                  Plato::Scalar aAngularFrequency = 0.0) const
    {
        ...
        Kokkos::parallel_for(
            "Adjoint Elastodynamcis Residual Calculation", Kokkos::RangePolicy<>(0, tNumCells),
