...
class J2PlasticityUtilities
{
   ...
   public:
     ...
     **********************************************************************************/
    KOKKOS_INLINE_FUNCTION void updatePlasticStrainAndBackstressPlasticStep(
     ...
     * \param [out] aLocalState 2D container of local state variables to update
     **********************************************************************************/
    KOKKOS_INLINE_FUNCTION void updatePlasticStrainAndBackstressElasticStep(
        const Plato::OrdinalType& aCellOrdinal,
        const Plato::ScalarMultiVector& aPrevLocalState,
        const Plato::ScalarMultiVector& aLocalState) const;
    ...
    KOKKOS_INLINE_FUNCTION void computeDeviatoricStressMinusBackstressNormalized(
        const Plato::OrdinalType& aCellOrdinal,
    ...
    KOKKOS_INLINE_FUNCTION void computePlasticStrainMisfit(const Plato::OrdinalType& aCellOrdinal,
    ...
    KOKKOS_INLINE_FUNCTION void fillPlasticStrainTensorResidualPlasticStep(
        const Plato::OrdinalType& aCellOrdinal,
        const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    ...
    template <typename ControlT,
              typename LocalStateT,
              typename PrevLocalStateT,
              typename YieldSurfNormalT,
              typename ResultT>
    KOKKOS_INLINE_FUNCTION void fillBackstressTensorResidualPlasticStep(
        const Plato::OrdinalType& aCellOrdinal,
    ...
    KOKKOS_INLINE_FUNCTION void fillPlasticStrainTensorResidualElasticStep(
        const Plato::OrdinalType& aCellOrdinal,
        const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
        const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
        const Plato::ScalarMultiVectorT<ResultT>& aResult) const;
     ...
     **********************************************************************************/
    template <typename LocalStateT, typename PrevLocalStateT, typename ResultT>
    KOKKOS_INLINE_FUNCTION void fillBackstressTensorResidualElasticStep(
        const Plato::OrdinalType& aCellOrdinal,
        const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
        const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
        const Plato::ScalarMultiVectorT<ResultT>& aResult) const;
    ...
    KOKKOS_INLINE_FUNCTION void getAccumulatedPlasticStrain(
        const Plato::OrdinalType& aCellOrdinal,
     ...
     **********************************************************************************/
    template <typename LocalStateT>
    KOKKOS_INLINE_FUNCTION void getPlasticMultiplierIncrement(
        const Plato::OrdinalType& aCellOrdinal,
        const Plato::ScalarMultiVectorT<LocalStateT>& aLocalStates,
     ...
     **********************************************************************************/
    template <typename LocalStateT>
    KOKKOS_INLINE_FUNCTION void getPlasticStrainTensor(
        const Plato::OrdinalType& aCellOrdinal,
        const Plato::ScalarMultiVectorT<LocalStateT>& aLocalStates,
     ...
     **********************************************************************************/
    template <typename LocalStateT>
    KOKKOS_INLINE_FUNCTION void getBackstressTensor(const Plato::OrdinalType& aCellOrdinal,
                                                    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalStates,
 ...
 **********************************************************************************/
template <>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::updatePlasticStrainAndBackstressPlasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVector& aPrevLocalState,
    const Plato::ScalarMultiVector& aYieldSurfaceNormal,
    const Plato::Scalar& aHardeningModulusKinematic,
    const Plato::ScalarMultiVector& aLocalState) const
{
    ...
    aLocalState(aCellOrdinal, 2) =
        aPrevLocalState(aCellOrdinal, 2) + tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 0);
    aLocalState(aCellOrdinal, 3) =
        aPrevLocalState(aCellOrdinal, 3) + tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 1);
    aLocalState(aCellOrdinal, 4) =
        aPrevLocalState(aCellOrdinal, 4) + mTwo * tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 2);
    aLocalState(aCellOrdinal, 5) =
        aPrevLocalState(aCellOrdinal, 5) + tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 3);
    ...
    aLocalState(aCellOrdinal, 6) =
        aPrevLocalState(aCellOrdinal, 6) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 0);
    aLocalState(aCellOrdinal, 7) =
        aPrevLocalState(aCellOrdinal, 7) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 1);
    aLocalState(aCellOrdinal, 8) =
        aPrevLocalState(aCellOrdinal, 8) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 2);
    aLocalState(aCellOrdinal, 9) =
        aPrevLocalState(aCellOrdinal, 9) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 3);
}
 ...
 **********************************************************************************/
template <>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::updatePlasticStrainAndBackstressPlasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVector& aPrevLocalState,
    const Plato::ScalarMultiVector& aYieldSurfaceNormal,
    const Plato::Scalar& aHardeningModulusKinematic,
    const Plato::ScalarMultiVector& aLocalState) const
{
    ...
    aLocalState(aCellOrdinal, 3) =
        aPrevLocalState(aCellOrdinal, 3) + tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 1);
    aLocalState(aCellOrdinal, 4) =
        aPrevLocalState(aCellOrdinal, 4) + tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 2);
    aLocalState(aCellOrdinal, 5) =
        aPrevLocalState(aCellOrdinal, 5) + mTwo * tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 3);
    aLocalState(aCellOrdinal, 6) =
        aPrevLocalState(aCellOrdinal, 6) + mTwo * tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 4);
    aLocalState(aCellOrdinal, 7) =
        aPrevLocalState(aCellOrdinal, 7) + mTwo * tMultiplier1 * aYieldSurfaceNormal(aCellOrdinal, 5);

    Plato::Scalar tMultiplier2 = aLocalState(aCellOrdinal, 1) * mSqrt2Over3 * aHardeningModulusKinematic;
    // Backstress Tensor
    aLocalState(aCellOrdinal, 8) =
        aPrevLocalState(aCellOrdinal, 8) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 0);
    aLocalState(aCellOrdinal, 9) =
        aPrevLocalState(aCellOrdinal, 9) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 1);
    aLocalState(aCellOrdinal, 10) =
        aPrevLocalState(aCellOrdinal, 10) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 2);
    aLocalState(aCellOrdinal, 11) =
        aPrevLocalState(aCellOrdinal, 11) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 3);
    aLocalState(aCellOrdinal, 12) =
        aPrevLocalState(aCellOrdinal, 12) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 4);
    aLocalState(aCellOrdinal, 13) =
        aPrevLocalState(aCellOrdinal, 13) + tMultiplier2 * aYieldSurfaceNormal(aCellOrdinal, 5);
}
 ...
 **********************************************************************************/
template <>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::updatePlasticStrainAndBackstressElasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVector& aPrevLocalState,
    const Plato::ScalarMultiVector& aLocalState) const
{
 ...
 **********************************************************************************/
template <>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::updatePlasticStrainAndBackstressElasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVector& aPrevLocalState,
    const Plato::ScalarMultiVector& aLocalState) const
{
...
template <>
template <typename LocalStateT, typename StressT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::computeDeviatoricStressMinusBackstressNormalized(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<StressT>& aDeviatoricStress,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<StressT>& aYieldSurfaceNormal,
    const Plato::ScalarVectorT<StressT>& aDevStressMinusBackstressNorm) const
{
    ...
    aYieldSurfaceNormal(aCellOrdinal, 0) =
        aDeviatoricStress(aCellOrdinal, 0) - aLocalState(aCellOrdinal, 6);  // sigma_11
    aYieldSurfaceNormal(aCellOrdinal, 1) =
        aDeviatoricStress(aCellOrdinal, 1) - aLocalState(aCellOrdinal, 7);  // sigma_22
    aYieldSurfaceNormal(aCellOrdinal, 2) =
        aDeviatoricStress(aCellOrdinal, 2) - aLocalState(aCellOrdinal, 8);  // sigma_12
    aYieldSurfaceNormal(aCellOrdinal, 3) =
        aDeviatoricStress(aCellOrdinal, 3) - aLocalState(aCellOrdinal, 9);  // sigma_33

    // Compute the norm || stress_deviator - backstress ||
    aDevStressMinusBackstressNorm(aCellOrdinal) =
        sqrt(pow(aYieldSurfaceNormal(aCellOrdinal, 0), 2) + pow(aYieldSurfaceNormal(aCellOrdinal, 1), 2) +
             pow(aYieldSurfaceNormal(aCellOrdinal, 3), 2) + mTwo * pow(aYieldSurfaceNormal(aCellOrdinal, 2), 2));
...
template <>
template <typename LocalStateT, typename StressT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::computeDeviatoricStressMinusBackstressNormalized(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<StressT>& aDeviatoricStress,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<StressT>& aYieldSurfaceNormal,
    const Plato::ScalarVectorT<StressT>& aDevStressMinusBackstressNorm) const
{
    ...
    aDevStressMinusBackstressNorm(aCellOrdinal) =
        sqrt(pow(aYieldSurfaceNormal(aCellOrdinal, 0), 2) + pow(aYieldSurfaceNormal(aCellOrdinal, 1), 2) +
             pow(aYieldSurfaceNormal(aCellOrdinal, 2), 2) + mTwo * pow(aYieldSurfaceNormal(aCellOrdinal, 3), 2) +
             mTwo * pow(aYieldSurfaceNormal(aCellOrdinal, 4), 2) + mTwo * pow(aYieldSurfaceNormal(aCellOrdinal, 5), 2));
...
template <>
template <typename AViewType, typename BViewType, typename ResultType>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::computePlasticStrainMisfit(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<AViewType>& aLocalStateOne,
    const Plato::ScalarMultiVectorT<BViewType>& aLocalStateTwo,
    const Plato::ScalarMultiVectorT<ResultType>& aOutput) const
...
template <>
template <typename AViewType, typename BViewType, typename ResultType>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::computePlasticStrainMisfit(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<AViewType>& aLocalStateOne,
    const Plato::ScalarMultiVectorT<BViewType>& aLocalStateTwo,
    const Plato::ScalarMultiVectorT<ResultType>& aOutput) const
...
template <>
template <typename LocalStateT, typename PrevLocalStateT, typename YieldSurfNormalT, typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::fillPlasticStrainTensorResidualPlasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
    const Plato::ScalarMultiVectorT<YieldSurfNormalT>& aYieldSurfaceNormal,
...
template <>
template <typename LocalStateT, typename PrevLocalStateT, typename YieldSurfNormalT, typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::fillPlasticStrainTensorResidualPlasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
    const Plato::ScalarMultiVectorT<YieldSurfNormalT>& aYieldSurfaceNormal,
...
template <typename ControlT,
          ...
          typename YieldSurfNormalT,
          typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::fillBackstressTensorResidualPlasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const ControlT& aHardeningModulusKinematic,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
...
{
    // backstress_{11}
    aResult(aCellOrdinal, 6) =
        aLocalState(aCellOrdinal, 6) - aPrevLocalState(aCellOrdinal, 6) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 0);

    // backstress_{22}
    aResult(aCellOrdinal, 7) =
        aLocalState(aCellOrdinal, 7) - aPrevLocalState(aCellOrdinal, 7) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 1);

    // backstress_{12}
    aResult(aCellOrdinal, 8) =
        aLocalState(aCellOrdinal, 8) - aPrevLocalState(aCellOrdinal, 8) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 2);

    // backstress_{33}
    aResult(aCellOrdinal, 9) =
        aLocalState(aCellOrdinal, 9) - aPrevLocalState(aCellOrdinal, 9) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 3);
}
...
template <typename ControlT,
          ...
          typename YieldSurfNormalT,
          typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::fillBackstressTensorResidualPlasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const ControlT& aHardeningModulusKinematic,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
    ...
    const Plato::ScalarMultiVectorT<ResultT>& aResult) const
{
    ...
    aResult(aCellOrdinal, 9) =
        aLocalState(aCellOrdinal, 9) - aPrevLocalState(aCellOrdinal, 9) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 1);
    aResult(aCellOrdinal, 10) =
        aLocalState(aCellOrdinal, 10) - aPrevLocalState(aCellOrdinal, 10) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 2);
    aResult(aCellOrdinal, 11) =
        aLocalState(aCellOrdinal, 11) - aPrevLocalState(aCellOrdinal, 11) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 3);
    aResult(aCellOrdinal, 12) =
        aLocalState(aCellOrdinal, 12) - aPrevLocalState(aCellOrdinal, 12) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 4);
    aResult(aCellOrdinal, 13) =
        aLocalState(aCellOrdinal, 13) - aPrevLocalState(aCellOrdinal, 13) -
        mSqrt2Over3 * aLocalState(aCellOrdinal, 1) * aHardeningModulusKinematic * aYieldSurfaceNormal(aCellOrdinal, 5);
}
...
template <>
template <typename LocalStateT, typename PrevLocalStateT, typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::fillPlasticStrainTensorResidualElasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
    const Plato::ScalarMultiVectorT<ResultT>& aResult) const
...
template <>
template <typename LocalStateT, typename PrevLocalStateT, typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::fillPlasticStrainTensorResidualElasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
    const Plato::ScalarMultiVectorT<ResultT>& aResult) const
...
template <>
template <typename LocalStateT, typename PrevLocalStateT, typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::fillBackstressTensorResidualElasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
    const Plato::ScalarMultiVectorT<ResultT>& aResult) const
...
template <>
template <typename LocalStateT, typename PrevLocalStateT, typename ResultT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::fillBackstressTensorResidualElasticStep(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<PrevLocalStateT>& aPrevLocalState,
    const Plato::ScalarMultiVectorT<ResultT>& aResult) const
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::getAccumulatedPlasticStrain(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVectorT<LocalStateT>& aAccumPlasticStrain) const
{
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::getAccumulatedPlasticStrain(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVectorT<LocalStateT>& aAccumPlasticStrain) const
{
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::getPlasticMultiplierIncrement(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVectorT<LocalStateT>& aPlasticMultiplier) const
{
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::getPlasticMultiplierIncrement(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVectorT<LocalStateT>& aPlasticMultiplier) const
{
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::getPlasticStrainTensor(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aPlasticStrains) const
{
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::getPlasticStrainTensor(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aPlasticStrains) const
{
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<2>::getBackstressTensor(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aBackstresses) const
{
...
template <>
template <typename LocalStateT>
KOKKOS_INLINE_FUNCTION void J2PlasticityUtilities<3>::getBackstressTensor(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aBackstresses) const
{
