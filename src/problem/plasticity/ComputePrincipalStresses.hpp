...
class ComputePrincipalStresses
{
   ...
   private:
    ...
    using GlobalStateT =
        typename EvaluationType::StateScalarType; /*!< global states forward automatic differentiation (FAD) type */
   ...
   public:
     ...
     **********************************************************************************/
    ComputePrincipalStresses() : mBulkModulus(1), mShearModulus(1), mPenaltySIMP(3), mMinErsatzSIMP(1e-9) {}
    ...
    ComputePrincipalStresses(Teuchos::ParameterList& aInputParams)
        : mBulkModulus(1), mShearModulus(1), mPenaltySIMP(3), mMinErsatzSIMP(1e-9)
    {
     ...
     **********************************************************************************/
    void setBulkModulus(const Plato::Scalar& aInput) { mBulkModulus = aInput; }
     ...
     **********************************************************************************/
    void setShearModulus(const Plato::Scalar& aInput) { mShearModulus = aInput; }
     ...
     **********************************************************************************/
    void setPenaltySIMP(const Plato::Scalar& aInput) { mPenaltySIMP = aInput; }
     ...
     **********************************************************************************/
    void setMinErsatzSIMP(const Plato::Scalar& aInput) { mMinErsatzSIMP = aInput; }
                    ...
                    const Plato::ScalarMultiVectorT<ResultT>& aResult) const
    {
        ...
        Plato::ScalarArray3DT<ConfigT> tConfigGradient("configuration gradient", tNumCells, mNumNodesPerCell,
                                                       mSpaceDim);
        ...
        Kokkos::parallel_for(
            "compute principal stresses", Kokkos::RangePolicy<>(0, tNumCells),
