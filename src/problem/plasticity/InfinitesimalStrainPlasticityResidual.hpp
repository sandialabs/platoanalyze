...
class InfinitesimalStrainPlasticityResidual : public Plato::AbstractGlobalVectorFunctionInc<EvaluationType>
{
   ...
   private:
    ...
    static constexpr auto mPressureDofOffset =
        SimplexPhysicsType::mPressureDofOffset; /*!< number of pressure dofs offset */
    ...
    static constexpr auto mMechDofOffset =
        SimplexPhysicsType::mDisplacementDofOffset; /*!< mechanical degrees of freedom offset */
    ...
    std::shared_ptr<Plato::NaturalBCs<mSpaceDim, mNumMechDims, mNumGlobalDofsPerNode, mMechDofOffset>>
        mNeumannLoads; /*!< Neumann loads interface */
   ...
   private:
    ...
    void parseOutputDataNames(Teuchos::ParameterList& aProblemParams)
    {
        ...
        {
            ANALYZE_THROWERR(
                "Infinitesimal Strain Plasticity Residual: 'Elliptic' sublist is not defined in XML input file.")
        }
    }
    ...
    void parseExternalForces(Teuchos::ParameterList& aProblemParams)
    {
        ...
        if (aProblemParams.isSublist("Natural Boundary Conditions"))
        {
            ...
            {
                mNeumannLoads =
                    std::make_shared<Plato::NaturalBCs<mSpaceDim, mNumMechDims, mNumGlobalDofsPerNode, mMechDofOffset>>(
    ...
    void parseIsotropicMaterialProperties(Teuchos::ParameterList& aProblemParams)
    {
        ...
        {
            std::stringstream ss;
            ss << "Infinitesimal Strain Plasticity Residual: 'Isotropic Linear Elastic' sublist of '" << tMaterialName
               << "' is not defined.";
                       ...
                       const Plato::ScalarMultiVectorT<ResultT>& aResult)
    {
        ...
        {
            ANALYZE_THROWERR(
                "Infinitesimal Strain Plasticity Residual: 'Load Control Constant' is NOT defined in data map.")
        }
   ...
   public:
     ...
     *******************************************************************************/
    InfinitesimalStrainPlasticityResidual(const Plato::SpatialDomain& aSpatialDomain,
     ...
     *residual workset \param [in]     aTimeData              current time data object
     *
     ****************************************************************************/
                  ...
                  const Plato::TimeData& aTimeData) override
    {
        ...
        Kokkos::parallel_for(
            "stabilized infinitesimal strain plasticity residual", Kokkos::RangePolicy<>(0, tNumCells),
            KOKKOS_LAMBDA(const Plato::OrdinalType& aCellOrdinal) {
                ...
                tVolumeStrain(aCellOrdinal) = tPressureScaling * (tStrainDivergence(aCellOrdinal) -
                ...
                // prepare output data
                tComputeCauchyStress(aCellOrdinal, tPenalizedBulkModulus, tPenalizedShearModulus, tElasticStrain,
                                     tCauchyStress);
     ...
     *current pressure gradient workset ( i.e. state at the n-th time interval (\f$ t^{n} \f$) ) \param [in] aControls
     *design variables workset \param [in]     aConfig                configuration workset \param [in/out] aResult
     *residual workset \param [in]     aTimeStep              current time step (i.e. \f$ \Delta{t}^{n} \f$), default =
     *0.0
     *
     ****************************************************************************/
