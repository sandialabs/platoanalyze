...
template <typename EvaluationType, typename IndicatorFunctionType>
Plato::Solutions TransientThermomechResidual<EvaluationType, IndicatorFunctionType>::getSolutionStateOutputData(
...
/**************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void TransientThermomechResidual<EvaluationType, IndicatorFunctionType>::evaluate(
...
/**************************************************************************/
{
    ...
    Kokkos::parallel_for(
        "stress and flux divergence", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
