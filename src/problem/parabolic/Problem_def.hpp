...
/******************************************************************************/
{
    ...
    {
        Plato::applyBlockConstraints<ElementType::mNumDofsPerNode>(aMatrix, aVector, mStateBcDofs, mStateBcValues,
                                                                   aScale);
    }
    else
    {
...
/******************************************************************************/
{
    ...
    for (Plato::OrdinalType tStepIndex = 1; tStepIndex < mNumSteps; tStepIndex++)
    {
        ...
        for (Plato::OrdinalType tNewtonIndex = 0; tNewtonIndex < mNumNewtonSteps; tNewtonIndex++)
        {
            ...
            // R_{v}
            mResidualV = mTrapezoidIntegrator.v_value(tState, tStatePrev, tStateDot, tStateDotPrev, mTimeStep);
