...
#include "problem/parabolic/InternalThermoelasticEnergy.hpp"
#include "problem/parabolic/TMStressPNorm.hpp"
#include "problem/parabolic/TransientThermomechResidual.hpp"
#endif
...
#include "problem/elliptic/InternalThermoelasticEnergy.hpp"
#include "problem/elliptic/Plato_AugLagStressCriterionQuadratic.hpp"
#include "problem/elliptic/TMStressPNorm.hpp"
#include "problem/elliptic/ThermalVonMisesLocalMeasure.hpp"
#include "problem/elliptic/ThermoelastostaticResidual.hpp"
    ...
    const std::string& aFuncName)
{
    ...
    {
        return std::make_shared<ThermalVonMisesLocalMeasure<EvaluationType>>(aSpatialDomain, aDataMap, aProblemParams,
                                                                             "VonMises");
    }
    else
    {
...
inline std::shared_ptr<Plato::Elliptic::AbstractScalarFunction<EvaluationType>> stress_constraint_quadratic(
    ...
    const std::string& aFuncName)
{
    auto EvalMeasure = Plato::ThermomechanicsFactory::create_local_measure<EvaluationType>(aSpatialDomain, aDataMap,
                                                                                           aInputParams, aFuncName);
    using Residual = typename Plato::Elliptic::ResidualTypes<typename EvaluationType::ElementType>;
    auto PODMeasure = Plato::ThermomechanicsFactory::create_local_measure<Residual>(aSpatialDomain, aDataMap,
                                                                                    aInputParams, aFuncName);
...
struct FunctionFactory
{
    ...
    /******************************************************************************/
    {
        ...
        {
            return Plato::makeScalarFunction<EvaluationType, Plato::Elliptic::TMStressPNorm>(aSpatialDomain, aDataMap,
