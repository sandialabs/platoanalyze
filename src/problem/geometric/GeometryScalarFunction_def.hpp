...
void GeometryScalarFunction<GeometryT>::initialize(Teuchos::ParameterList& aProblemParams)
{
 ...
 **********************************************************************************/
template <typename GeometryT>
void GeometryScalarFunction<GeometryT>::setEvaluator(const ValueFunction& aInput, std::string aName)
{
 ...
 **********************************************************************************/
template <typename GeometryT>
void GeometryScalarFunction<GeometryT>::setEvaluator(const GradientZFunction& aInput, std::string aName)
{
 ...
 **********************************************************************************/
template <typename GeometryT>
void GeometryScalarFunction<GeometryT>::setEvaluator(const GradientXFunction& aInput, std::string aName)
{
 ...
 **********************************************************************************/
template <typename GeometryT>
Plato::Scalar GeometryScalarFunction<GeometryT>::value(const Plato::ScalarVector& aControl) const
{
 ...
 **********************************************************************************/
template <typename GeometryT>
Plato::ScalarVector GeometryScalarFunction<GeometryT>::gradient_x(const Plato::ScalarVector& aControl) const
{
    ...
    if (mValueFunctions.at(tFirstBlockName)->hasBoundaryTerm())
    {
        ...
        // create and assemble to return view
        //
        Plato::assemble_vector_gradient_fad<mNumNodesPerCell, mNumSpatialDims>(tNumCells, mConfigEntryOrdinal, tResult,
                                                                               tObjGradientX);
 ...
 **********************************************************************************/
template <typename GeometryT>
Plato::ScalarVector GeometryScalarFunction<GeometryT>::gradient_z(const Plato::ScalarVector& aControl) const
{
    ...
    for (const auto& tDomain : mSpatialModel.mDomains)
    {
        ...
        // create and assemble to return view
        //
        Plato::assemble_scalar_gradient_fad<mNumNodesPerCell>(tDomain, mControlEntryOrdinal, tResult, tObjGradientZ);
    ...
    if (mValueFunctions.at(tFirstBlockName)->hasBoundaryTerm())
    {
        ...
        // create and assemble to return view
        //
        Plato::assemble_scalar_gradient_fad<mNumNodesPerCell>(tNumCells, mControlEntryOrdinal, tResult, tObjGradientZ);
 ...
 **********************************************************************************/
template <typename GeometryT>
void GeometryScalarFunction<GeometryT>::setFunctionName(const std::string aFunctionName)
{
