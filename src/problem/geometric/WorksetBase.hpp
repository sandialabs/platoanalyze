...
class WorksetBase : public ElementType
{
   ...
   public:
    ...
    {
        Plato::workset_config_scalar<mNumSpatialDims, mNumNodesPerCell>(aDomain, mNodeCoordinate, aConfigWS);
    }
    ...
    {
        Plato::workset_config_scalar<mNumSpatialDims, mNumNodesPerCell>(mNumCells, mNodeCoordinate, aConfigWS);
    }
