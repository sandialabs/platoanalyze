 ...
 **********************************************************************************/
template <typename PhysicsType>
void WeightedSumFunction<PhysicsType>::updateProblem(const Plato::ScalarVector& aControl) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::Scalar WeightedSumFunction<PhysicsType>::value(const Plato::ScalarVector& aControl) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector WeightedSumFunction<PhysicsType>::gradient_x(const Plato::ScalarVector& aControl) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector WeightedSumFunction<PhysicsType>::gradient_z(const Plato::ScalarVector& aControl) const
{
