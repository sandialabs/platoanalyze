 ...
 **********************************************************************************/
KOKKOS_INLINE_FUNCTION Plato::Scalar conditional_expression(const Plato::Scalar& aX,
...
void shiftDiagonal(Plato::CrsMatrixType const& aMatrix, Plato::Scalar aScale);
