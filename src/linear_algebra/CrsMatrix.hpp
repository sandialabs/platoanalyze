...
bool validCrsMapSizes(const Kokkos::View<Ordinal*, MemSpace> aRowMap,
...
class CrsMatrix
{
   ...
   public:
    ...
    CrsMatrix(int aNumRows, int aNumCols, int aNumRowsPerBlock, int aNumColsPerBlock)
        : mNumRows(aNumRows),
          mNumCols(aNumCols),
    ...
    KOKKOS_INLINE_FUNCTION void setColumnIndices(decltype(mColumnIndices) aColumnIndices)
    {
        mColumnIndices = aColumnIndices;
    }
