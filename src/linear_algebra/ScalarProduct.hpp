...
class ScalarProduct
{
   public:
    ...
    template <typename ProductScalarType,
              ...
              typename Array2ScalarType,
              typename VolumeScalarType>
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType iCellOrdinal,
    ...
    template <typename ProductScalarType, typename Array1ScalarType, typename VolumeScalarType>
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType aCellOrdinal,
                                           Plato::ScalarVectorT<ProductScalarType> aScalarProduct,
                                           Plato::ScalarMultiVectorT<Array1ScalarType> aArray1,
