...
template <typename T>
T getSubParam(Teuchos::ParameterList& aInputParams,
...
template <typename T>
T getParam(Teuchos::ParameterList& aInputParams, const std::string& aParamName, T aDefaultValue)
{
...
template <typename T>
T getParam(const Teuchos::ParameterList& aInputParams, const std::string& aParamName)
{
    if (aInputParams.isType<T>(aParamName))
    {
        return aInputParams.get<T>(aParamName);
 ...
 *****************************************************************************/
template <typename T>
void verifyVectorLength(Teuchos::Array<T> aVector, int aLength, const std::string& aContext = "")
{
 ...
 *****************************************************************************/
template <typename T>
void normalizeVector(Teuchos::Array<T>& aVector, bool aQuiet = false, const std::string& aContext = "")
{
    T tMag(0.0);
 ...
 *****************************************************************************/
template <typename T>
void getBasis(Teuchos::ParameterList const& aParams, Plato::Matrix<3, 3, T>& aBasis)
{
 ...
 *****************************************************************************/
template <typename T>
void getBasis(Teuchos::ParameterList const& aParams, Plato::Matrix<2, 2, T>& aBasis)
{
    if (aParams.isSublist("Basis"))
    {
        auto tBasisList = aParams.sublist("Basis");
 ...
 *****************************************************************************/
template <typename T>
void getBasis(Teuchos::ParameterList const& aParams, Plato::Matrix<1, 1, T>& aBasis)
{
    if (aParams.isSublist("Basis"))
    {
        auto tBasisList = aParams.sublist("Basis");
...
std::string getEquationParam(const Teuchos::ParameterList& aInputParams, const std::string equationName);
