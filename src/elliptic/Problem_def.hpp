...
/******************************************************************************/ /**
                                                                                  * \brief Is criterion independent of
                                                                                  *the solution state? \param [in] aName
                                                                                  *Name of criterion.
                                                                                  **********************************************************************************/
template <typename PhysicsType>
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  *aFilepath output/visualizaton file
                                                                                  *path
                                                                                  **********************************************************************************/
template <typename PhysicsType>
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  * \param [in] aMatrix Compressed Row
                                                                                  *Storage (CRS) matrix \param [in]
                                                                                  *aVector 1D view of Right-Hand-Side
                                                                                  *forces
                                                                                  **********************************************************************************/
template <typename PhysicsType>
...
/******************************************************************************/ /**
                                                                                  * \brief Update physics-based
                                                                                  *parameters within optimization
                                                                                  *iterations \param [in] aGlobalState
                                                                                  *2D container of state variables
                                                                                  * \param [in] aControl 1D container of
                                                                                  *control variables
                                                                                  **********************************************************************************/
template <typename PhysicsType>
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  * \param [in] aControl 1D view of
                                                                                  *control variables \return solution
                                                                                  *database
                                                                                  **********************************************************************************/
template <typename PhysicsType>
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  * \param [in] aControl 1D view of
                                                                                  *control variables \param [in] aName
                                                                                  *Name of criterion. \return criterion
                                                                                  *function value
                                                                                  **********************************************************************************/
template <typename PhysicsType>
...
/******************************************************************************/ /**
                                                                                  * \brief Evaluate criterion function
                                                                                  * \param [in] aControl 1D view of
                                                                                  *control variables \param [in]
                                                                                  *aSolution solution database \param
                                                                                  *[in] aName Name of criterion. \return
...
/******************************************************************************/ /**
                                                                                  * \brief Evaluate criterion gradient
                                                                                  *wrt control variables \param [in]
                                                                                  *aControl 1D view of control variables
                                                                                  * \param [in] aSolution solution
                                                                                  *database \param [in] aName Name of
                                                                                  *criterion. \return 1D view -
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  *aControl 1D view of control variables
                                                                                  * \param [in] aSolution solution
                                                                                  *database \param [in] aCriterion
                                                                                  *criterion to be evaluated \return 1D
                                                                                  *view - criterion gradient wrt control
                                                                                  *variables
                                                                                  **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector Problem<PhysicsType>::criterionGradient(const Plato::ScalarVector& aControl,
...
/******************************************************************************/ /**
                                                                                  * \brief Evaluate criterion gradient
                                                                                  *wrt configuration variables \param
                                                                                  *[in] aControl 1D view of control
                                                                                  *variables \param [in] aSolution
                                                                                  *solution database \param [in] aName
                                                                                  *Name of criterion. \return 1D view -
                                                                                  *criterion gradient wrt control
                                                                                  *variables
                                                                                  **********************************************************************************/
template <typename PhysicsType>
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  *[in] aControl 1D view of control
                                                                                  *variables \param [in] aSolution
                                                                                  *solution database \param [in]
                                                                                  *aCriterion criterion to be evaluated
                                                                                  * \return 1D view - criterion gradient
                                                                                  *wrt configuration variables
                                                                                  **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector Problem<PhysicsType>::criterionGradientX(const Plato::ScalarVector& aControl,
                                                             const Plato::Solutions& aSolution,
...
/******************************************************************************/ /**
                                                                                  * \brief Evaluate criterion partial
                                                                                  *derivative wrt control variables
                                                                                  * \param [in] aControl 1D view of
                                                                                  *control variables \param [in] aName
                                                                                  *Name of criterion. \return 1D view -
                                                                                  *criterion partial derivative wrt
                                                                                  *control variables
                                                                                  **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector Problem<PhysicsType>::criterionGradient(const Plato::ScalarVector& aControl,
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  *variables \param [in] aControl 1D
                                                                                  *view of control variables \param [in]
                                                                                  *aName Name of criterion. \return 1D
                                                                                  *view - criterion partial derivative
                                                                                  *wrt configuration variables
                                                                                  **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector Problem<PhysicsType>::criterionGradientX(const Plato::ScalarVector& aControl,
...
/***************************************************************************/ /**
                                                                               * \brief Read essential (Dirichlet)
                                                                               *boundary conditions from the Exodus
                                                                               *file. \param [in] aProblemParams input
                                                                               *parameters database
                                                                               *******************************************************************************/
template <typename PhysicsType>
...
/***************************************************************************/ /**
                                                                               * \brief Set essential (Dirichlet)
                                                                               *boundary conditions \param [in] aDofs
                                                                               *degrees of freedom associated with
                                                                               *Dirichlet boundary conditions \param
                                                                               *[in] aValues values associated with
                                                                               *Dirichlet degrees of freedom
                                                                               *******************************************************************************/
template <typename PhysicsType>
void Problem<PhysicsType>::setEssentialBoundaryConditions(const Plato::OrdinalVector& aDofs,
...
template <typename PhysicsType>
void Problem<PhysicsType>::applyAdjointConstraints(const Teuchos::RCP<Plato::CrsMatrixType>& aMatrix,
                                                   const Plato::ScalarVector& aVector) {
