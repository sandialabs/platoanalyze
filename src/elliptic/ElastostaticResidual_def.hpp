 ...
 **********************************************************************************/
template <typename EvaluationType, typename IndicatorFunctionType>
void ElastostaticResidual<EvaluationType, IndicatorFunctionType>::evaluate_contact(
    const Plato::SpatialModel& aSpatialModel,
    ...
    Plato::Scalar aTimeStep) const
{
    Plato::Contact::IntegrateContactForce<EvaluationType> integrateContactForce(
        aSpatialModel, aSideSet, aComputeSurfaceDisp, aComputeContactForce);
