 ...
 *
 *******************************************************************************/
template <typename ElementType, Plato::OrdinalType DofsPerNode, Plato::OrdinalType DofOffset = 0>
class StefanBoltzmann
{
   ...
   public:
     ...
     * \brief Constructor
     **********************************************************************************/
    StefanBoltzmann(const std::string& aSideSetName);
    ...
    template <typename StateScalarType>
    void evaluateSurfaceFlux(Plato::ScalarMultiVectorT<StateScalarType> tFlux,
...
StefanBoltzmann<ElementType, DofsPerNode, DofOffset>::StefanBoltzmann(const std::string& aSideSetName)
...
void StefanBoltzmann<ElementType, DofsPerNode, DofOffset>::evaluateSurfaceFlux(
    ...
    Plato::OrdinalVectorT<const Plato::OrdinalType> aSideSetLocalNodeOrds) const
{
    ...
    Kokkos::parallel_for(
        "compute flux", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumFaces, tNumPoints}),
    ...
    Plato::Scalar aScale) const
{
    ...
    Kokkos::parallel_for(
        "project to surface", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumFaces, tNumPoints}),
