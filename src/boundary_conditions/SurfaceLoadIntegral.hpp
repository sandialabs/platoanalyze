    ...
    Plato::Scalar aScale) const
{
    ...
    const auto tBoundaryData = mBCData->getVectorData(aSpatialModel.mMesh, mCurrentTime);
    ...
    Kokkos::parallel_for(
        "surface load integral", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumFaces, tNumPoints}),
