...
class MSIMP
{
   ...
   public:
    ...
    explicit MSIMP(const Plato::Scalar& aPenalty, const Plato::Scalar& aMinValue)
        : mMinValue(aMinValue), mPenaltyParam(aPenalty), mUpperBoundOnPenaltyParam(3.0), mAdditiveContinuationValue(0.1)
    {
    }
     ...
     **********************************************************************************/
    void setPenalty(const Plato::Scalar& aInput) { mPenaltyParam = aInput; }
     ...
     **********************************************************************************/
    void setMinimumErsatzMaterial(const Plato::Scalar& aInput) { mMinValue = aInput; }
     ...
     **********************************************************************************/
    void setAdditiveContinuationValue(const Plato::Scalar& aInput) { mAdditiveContinuationValue = aInput; }
