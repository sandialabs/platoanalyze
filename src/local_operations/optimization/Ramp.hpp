...
class RAMP
{
   ...
   public:
     ...
     **********************************************************************************/
    RAMP() : mMinValue(0), mPenaltyParam(3), mUpperBoundOnPenaltyParam(3.0), mAdditiveContinuationValue(0.1) {}
    ...
    {
        ScalarType tOutput =
            mMinValue + (static_cast<ScalarType>(1.0) - mMinValue) * aInput /
                            (static_cast<ScalarType>(1.0) + mPenaltyParam * (static_cast<ScalarType>(1.0) - aInput));
        return (tOutput);
    }
};
