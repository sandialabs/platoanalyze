...
class ApplyWeighting
{
   ...
   public:
     ...
     **********************************************************************************/
    ApplyWeighting(PenaltyFunction aPenaltyFunction) : mPenaltyFunction(aPenaltyFunction) {}

    /******************************************************************************/
    /**
     * \brief Update penalty model parameters within a frequency of optimization iterations
     **********************************************************************************/
    void update() { mPenaltyFunction.update(); }
    ...
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType aCellOrdinal,
                                           ...
                                           Plato::Array<NumTerms, InputScalarType>& aInputOutput) const
    {
        // apply weighting
        //
    ...
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType aCellOrdinal,
                                           ...
                                           const Plato::ScalarMultiVectorT<WeightScalarType>& aControl,
                                           const Plato::Array<NumNodes>& aBasisValues,
                                           Plato::ScalarArray3DT<InputScalarType> aInputOutput) const
    {
        // apply weighting
        //
        WeightScalarType tCellDensity = 0.0;
    ...
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType aCellOrdinal,
                                           const Plato::ScalarMultiVectorT<WeightScalarType>& aControl,
                                           const Plato::Array<NumNodes>& aBasisValues,
                                           InputScalarType& aInputOutput) const
    {
        // apply weighting
        //
        WeightScalarType tCellDensity = 0.0;
