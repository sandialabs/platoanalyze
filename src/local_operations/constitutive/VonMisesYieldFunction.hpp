...
template <>
template <typename InputType, typename ResultType>
KOKKOS_INLINE_FUNCTION void VonMisesYieldFunction<3, 6>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::OrdinalType& aGpOrdinal,
    const Plato::ScalarMultiVectorT<InputType>& aCauchyStress,
    ResultType& aVonMisesStress) const
{
    ResultType tSigma11MinusSigma22 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 0) - aCauchyStress(aCellOrdinal, aGpOrdinal, 1);
    ResultType tSigma22MinusSigma33 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 1) - aCauchyStress(aCellOrdinal, aGpOrdinal, 2);
    ResultType tSigma33MinusSigma11 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 2) - aCauchyStress(aCellOrdinal, aGpOrdinal, 0);
    ...
    ResultType tPrincipalStressContribution =
        tSigma11MinusSigma22Squared + tSigma22MinusSigma33Squared + tSigma33MinusSigma11Squared;

    ResultType tSigma33TimesSigma33 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 3) * aCauchyStress(aCellOrdinal, aGpOrdinal, 3);
    ResultType tSigma44TimesSigma44 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 4) * aCauchyStress(aCellOrdinal, aGpOrdinal, 4);
    ResultType tSigma55TimesSigma55 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 5) * aCauchyStress(aCellOrdinal, aGpOrdinal, 5);
    ResultType tShearStressContribution =
        static_cast<Plato::Scalar>(3) * (tSigma33TimesSigma33 + tSigma44TimesSigma44 + tSigma55TimesSigma55);
...
template <>
template <typename InputType, typename ResultType>
KOKKOS_INLINE_FUNCTION void VonMisesYieldFunction<2, 3>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::OrdinalType& aGpOrdinal,
    const Plato::ScalarMultiVectorT<InputType>& aCauchyStress,
    ResultType& aVonMisesStress) const
{
    ResultType tSigma11TimesSigma11 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 0) * aCauchyStress(aCellOrdinal, aGpOrdinal, 0);
    ResultType tSigma11TimesSigma22 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 0) * aCauchyStress(aCellOrdinal, aGpOrdinal, 1);
    ResultType tSigma22TimesSigma22 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 1) * aCauchyStress(aCellOrdinal, aGpOrdinal, 1);
    ResultType tSigma12TimesSigma12 =
        aCauchyStress(aCellOrdinal, aGpOrdinal, 2) * aCauchyStress(aCellOrdinal, aGpOrdinal, 2);
...
template <>
template <typename InputType, typename ResultType>
KOKKOS_INLINE_FUNCTION void VonMisesYieldFunction<1, 1>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::OrdinalType& aGpOrdinal,
    const Plato::ScalarMultiVectorT<InputType>& aCauchyStress,
    ResultType& aVonMisesStress) const
