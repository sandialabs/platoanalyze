...
class AbstractMeshIO
{
   public:
     ...
     **********************************************************************************/
    virtual void Write(Plato::OrdinalType aStepIndex, Plato::Scalar aTimeValue) = 0;
     ...
     **********************************************************************************/
    virtual Plato::ScalarVector ReadNodeData(const std::string& aVariableName, Plato::OrdinalType aStepIndex) = 0;
};
}  // namespace Plato
