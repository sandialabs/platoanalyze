...
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION ScalarType dot(Array<N, ScalarType> m1, Array<N, ScalarType> m2)
{
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Plato::Array<N, ScalarType> diagonal(Matrix<N, N, ScalarType> const& m1)
{
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION ScalarType norm(Array<N, ScalarType> const& m1)
{
    ScalarType tRetVal(0.0);
    for (Plato::OrdinalType i = 0; i < N; i++)
    {
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION ScalarType norm(Matrix<N, N, ScalarType> const& m1)
{
    ScalarType tRetVal(0.0);
    for (Plato::OrdinalType i = 0; i < N; i++)
    {
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Matrix<N, N, ScalarType> plus(Matrix<N, N, ScalarType> m1,
                                                                             Matrix<N, N, ScalarType> m2,
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Matrix<N, N, ScalarType> times(Matrix<N, N, ScalarType> m1,
                                                                              Matrix<N, N, ScalarType> m2)
{
    Matrix<N, N, ScalarType> tRetVal(0);
    for (Plato::OrdinalType i = 0; i < N; i++)
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Matrix<N, N, ScalarType> times(ScalarType v1,
                                                                              Matrix<N, N, ScalarType> m1)
{
    Matrix<N, N, ScalarType> tRetVal(0);
    for (Plato::OrdinalType i = 0; i < N; i++)
    {
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Array<N, ScalarType> times(ScalarType s1, Array<N, ScalarType> v1)
{
...
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Matrix<N, N, ScalarType> identity(ScalarType a = 1.0)
{
    Matrix<N, N, ScalarType> tRetVal(0);
    for (Plato::OrdinalType i = 0; i < N; i++)
    {
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Matrix<N, N, ScalarType> outer_product(Array<N, ScalarType> m1,
                                                                                      Array<N, ScalarType> m2)
{
    Matrix<N, N, ScalarType> tRetVal(0);
    for (Plato::OrdinalType i = 0; i < N; i++)
    {
 ...
 **********************************************************************************/
template <Plato::OrdinalType N, typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Plato::Array<N, ScalarType> normalize(Array<N, ScalarType> v1)
{
...
template <typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION ScalarType determinant(Matrix<2, 2, ScalarType> m)
{
...
template <typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION ScalarType determinant(Matrix<3, 3, ScalarType> m)
{
...
template <typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Matrix<2, 2, ScalarType> invert(Matrix<2, 2, ScalarType> const m)
{
...
template <typename ScalarType>
[[nodiscard]] constexpr KOKKOS_INLINE_FUNCTION Matrix<3, 3, ScalarType> invert(Matrix<3, 3, ScalarType> const a)
{
