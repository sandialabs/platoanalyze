...
class RelaxedMicromorphicResidual : public EvaluationType::ElementType,
                                    public Plato::Hyperbolic::AbstractVectorFunction<EvaluationType>
{
   ...
   public:
    RelaxedMicromorphicResidual(const Plato::SpatialDomain &aSpatialDomain,
                                Plato::DataMap &aDataMap,
                                Teuchos::ParameterList &aProblemParams,
                                Teuchos::ParameterList &aPenaltyParams);

    void checkTimeIntegrator(Teuchos::ParameterList &aIntegratorParams);
