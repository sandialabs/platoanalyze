...
class AbstractMicromorphicKinetics : public ElementType
{
   ...
   public:
    ...
    AbstractMicromorphicKinetics& operator=(const AbstractMicromorphicKinetics& aKinetics) = delete;

    AbstractMicromorphicKinetics& operator=(AbstractMicromorphicKinetics&& aKinetics) = delete;

    virtual void operator()(Plato::ScalarArray3DT<KineticsScalarType>& aSymmetricMesoStress,
