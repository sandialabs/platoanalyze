...
class ComputeElasticWork
{
   public:
    ...
    template <typename OutputT,
              typename ElasticStrainT,
              typename DeviatoricStrainT,
              typename ShearModulusT,
              typename BulkModulusT>
...
template <typename OutputT,
          ...
          typename ShearModulusT,
          typename BulkModulusT>
KOKKOS_INLINE_FUNCTION void ComputeElasticWork<3>::operator()(
    ...
    const Plato::ScalarVectorT<OutputT> &aOutput) const
{
    ...
    DeviatoricStrainT tDeviatoricStrainSquared =
        (aDeviatoricStrain(aCellOrdinal, 0) * aDeviatoricStrain(aCellOrdinal, 0)) +
...
template <typename OutputT,
          ...
          typename ShearModulusT,
          typename BulkModulusT>
KOKKOS_INLINE_FUNCTION void ComputeElasticWork<2>::operator()(
    const Plato::OrdinalType &aCellOrdinal,
    const ShearModulusT &aShearModulus,
    const BulkModulusT &aBulkModulus,
    const Plato::ScalarMultiVectorT<ElasticStrainT> &aElasticStrain,
...
template <typename OutputT,
          ...
          typename ShearModulusT,
          typename BulkModulusT>
KOKKOS_INLINE_FUNCTION void ComputeElasticWork<1>::operator()(
    const Plato::OrdinalType &aCellOrdinal,
    const ShearModulusT &aShearModulus,
    const BulkModulusT &aBulkModulus,
    const Plato::ScalarMultiVectorT<ElasticStrainT> &aElasticStrain,
