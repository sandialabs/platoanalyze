...
class AbstractMesh
{
   public:
     ...
     **********************************************************************************/
    virtual Plato::ScalarVectorT<const Plato::OrdinalType> GetLocalElementIDs(std::string aBlockName) const = 0;
     ...
     **********************************************************************************/
    virtual std::vector<std::string> GetElementBlockNames() const = 0;
     ...
     **********************************************************************************/
    virtual std::vector<std::string> GetNodeSetNames() const = 0;
     ...
     **********************************************************************************/
    virtual std::vector<std::string> GetSideSetNames() const = 0;
     ...
     **********************************************************************************/
    virtual void NodeNodeGraph(Plato::OrdinalVectorT<Plato::OrdinalType>& aOffsetMap,
     ...
     **********************************************************************************/
    virtual void NodeElementGraph(Plato::OrdinalVectorT<const Plato::OrdinalType>& aOffsetMap,
     ...
     **********************************************************************************/
    virtual Plato::OrdinalVectorT<const Plato::OrdinalType> GetNodeSetNodes(std::string aNodeSetName) const = 0;
     ...
     * If the mesh is distributed, returns only the nodes on the local partition.
     **********************************************************************************/
    virtual void CreateNodeSet(std::string aNodeSetName, std::initializer_list<Plato::OrdinalType> aNodes) = 0;
     ...
     **********************************************************************************/
    virtual Plato::OrdinalVectorT<const Plato::OrdinalType> GetSideSetFaces(std::string aSideSetName) const = 0;
     ...
     **********************************************************************************/
    virtual Plato::OrdinalVectorT<const Plato::OrdinalType> GetSideSetElements(std::string aSideSetName) const = 0;
     ...
     **********************************************************************************/
    virtual Plato::OrdinalVectorT<const Plato::OrdinalType> GetSideSetLocalNodes(std::string aSideSetName) const = 0;
     ...
     **********************************************************************************/
    virtual Plato::OrdinalVectorT<const Plato::OrdinalType> GetSideSetElementsComplement(
        std::vector<std::string> aExcludeNames) = 0;
     ...
     * \returns const OrdinalVector of edges (2D) or faces (3D) for the named side set
     **********************************************************************************/
    virtual Plato::OrdinalVectorT<const Plato::OrdinalType> GetSideSetFacesComplement(
        std::vector<std::string> aSideSetName) = 0;
     ...
     * where m is the number of nodes per face, and f is the number of faces in the side set
     **********************************************************************************/
    virtual Plato::OrdinalVectorT<const Plato::OrdinalType> GetSideSetLocalNodesComplement(
        std::vector<std::string> aExcludeNames) = 0;
