...
KOKKOS_INLINE_FUNCTION ControlType cell_mass(const Plato::OrdinalType& aCellOrdinal,
...
KOKKOS_INLINE_FUNCTION ControlType cell_density(const Plato::OrdinalType& aCellOrdinal,
                                                const Plato::ScalarMultiVectorT<ControlType>& aCellControls)
{
...
KOKKOS_INLINE_FUNCTION void apply_penalty(const Plato::OrdinalType aCellOrdinal,
                                          const ControlType& aPenalty,
                                          const Plato::ScalarMultiVectorT<ResultType>& aOutput)
{
