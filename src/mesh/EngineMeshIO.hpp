...
#include "mesh/AbstractPlatoMeshIO.hpp"
...
class EngineMeshIO : public AbstractMeshIO
{
    ...
    {
        Variable() {}
        Variable(Plato::ScalarMultiVector Data, StrList DofNames) : isStale(false), Data(Data), DofNames(DofNames) {}
   ...
   public:
    ...
    void extractColumn(const Plato::ScalarMultiVector& aFromVector,
