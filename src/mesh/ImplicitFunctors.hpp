...
class NodeOrdinal
{
   ...
   public:
    NodeOrdinal(Plato::Mesh aMesh) : mCells2nodes(aMesh->Connectivity()) {}
    ...
    Plato::OrdinalType operator()(Plato::OrdinalType aCellOrdinal, Plato::OrdinalType aNodeOrdinal) const
    {
...
class VectorEntryOrdinal
{
   ...
   public:
    VectorEntryOrdinal(Plato::Mesh mesh) : mCells2nodes(mesh->Connectivity()) {}

    KOKKOS_INLINE_FUNCTION Plato::OrdinalType operator()(Plato::OrdinalType cellOrdinal,
                                                         Plato::OrdinalType nodeOrdinal,
                                                         Plato::OrdinalType dofOrdinal = 0) const
    {
...
class NodeCoordinate
{
   ...
   public:
    NodeCoordinate(Plato::Mesh aMesh) : mCells2nodes(aMesh->Connectivity()), mCoords(aMesh->Coordinates())
    {
    ...
    KOKKOS_INLINE_FUNCTION
    Plato::Scalar operator()(Plato::OrdinalType aCellOrdinal,
                             Plato::OrdinalType aNodeOrdinal,
                             Plato::OrdinalType aDimOrdinal) const
    {
...
class BlockMatrixTransposeEntryOrdinal
{
   ...
   public:
    BlockMatrixTransposeEntryOrdinal(Teuchos::RCP<Plato::CrsMatrixType> matrix, Plato::Mesh mesh)
        : mRowMap(matrix->rowMap()), mColumnIndices(matrix->columnIndices()), mCells2nodes(mesh->Connectivity())
    {
    }

    KOKKOS_INLINE_FUNCTION
    Plato::OrdinalType operator()(Plato::OrdinalType cellOrdinal,
    ...
    KOKKOS_INLINE_FUNCTION
    Plato::OrdinalType operator()(Plato::OrdinalType icellOrdinal,
   ...
   private:
    KOKKOS_INLINE_FUNCTION
    Plato::OrdinalType getEntryOrdinal(Plato::OrdinalType iLocalOrdinal,
...
class LocalByGlobalEntryFunctor
{
   ...
   public:
    LocalByGlobalEntryFunctor(MatrixT tMatrix, MeshT tMesh)
        : mRowMap(tMatrix->rowMap()), mColumnIndices(tMatrix->columnIndices()), mCells2nodes(tMesh->Connectivity())
    {
    }
...
class GlobalByLocalEntryFunctor
{
   ...
   public:
     ...
     **********************************************************************************/
    KOKKOS_INLINE_FUNCTION
    Plato::OrdinalType operator()(Plato::OrdinalType aCellOrdinal,
                                  Plato::OrdinalType aGpOrdinal,
                                  Plato::OrdinalType aICellDofOrdinal,
                                  Plato::OrdinalType aIGpStateOrdinal) const
    {
        ...
        for (Plato::OrdinalType entryOrdinal = rowStart; entryOrdinal < rowEnd; entryOrdinal++)
        {
            if (mColumnIndices(entryOrdinal) == jLocalOrdinal)
            {
                return entryOrdinal * ElementType::mNumDofsPerNode * ElementType::mNumLocalStatesPerGP +
                       iDof * ElementType::mNumLocalStatesPerGP + aIGpStateOrdinal;
            }
        }
        return Plato::OrdinalType(-1);
    }
