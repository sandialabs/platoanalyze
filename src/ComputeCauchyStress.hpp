...
template <>
template <typename StrainT, typename ControlT, typename StressT>
KOKKOS_INLINE_FUNCTION void ComputeCauchyStress<3>::operator()(const Plato::OrdinalType& aCellOrdinal,
                                                               const ControlT& aPenalizedBulkModulus,
                                                               const ControlT& aPenalizedShearModulus,
                                                               const Plato::ScalarMultiVectorT<StrainT>& aStrain,
                                                               const Plato::ScalarMultiVectorT<StressT>& aStress) const
{
    ...
    aStress(aCellOrdinal, 2) =
        (static_cast<Plato::Scalar>(2.0) * aPenalizedShearModulus) * (aStrain(aCellOrdinal, 2) - tTraceOver3);
...
template <>
template <typename StrainT, typename ControlT, typename StressT>
KOKKOS_INLINE_FUNCTION void ComputeCauchyStress<2>::operator()(const Plato::OrdinalType& aCellOrdinal,
                                                               const ControlT& aPenalizedBulkModulus,
                                                               const ControlT& aPenalizedShearModulus,
                                                               const Plato::ScalarMultiVectorT<StrainT>& aStrain,
                                                               const Plato::ScalarMultiVectorT<StressT>& aStress) const
...
template <>
template <typename StrainT, typename ControlT, typename StressT>
KOKKOS_INLINE_FUNCTION void ComputeCauchyStress<1>::operator()(const Plato::OrdinalType& aCellOrdinal,
                                                               const ControlT& aPenalizedBulkModulus,
                                                               const ControlT& aPenalizedShearModulus,
                                                               const Plato::ScalarMultiVectorT<StrainT>& aStrain,
                                                               const Plato::ScalarMultiVectorT<StressT>& aStress) const
