...
/******************************************************************************/
template <int SpatialDim>
ThermoelasticMaterial<SpatialDim>::ThermoelasticMaterial(const Teuchos::ParameterList& paramList)
...
/******************************************************************************/
template <int SpatialDim>
void ThermoelasticMaterial<SpatialDim>::parseElasticStiffness(const Teuchos::ParameterList& aParamList)
/******************************************************************************/
{
    if (aParamList.isSublist("Elastic Stiffness"))
    {
        ...
        else if (tParams.isType<Plato::Scalar>("Youngs Modulus"))
        {
    ...
    else if (aParamList.isSublist("Elastic Stiffness Expression"))
    {
...
{
   public:
    ThermoelasticModelFactory(const Teuchos::ParameterList& aParamList) : MaterialModelFactory<SpatialDim>(aParamList)
    {
    }
