 ...
 *******************************************************************************/
void driver(Teuchos::ParameterList& aInputData, Comm::Machine aMachine)
{
    ...
    if (tPlatoProblemList.isSublist("Criteria"))
    {
        ...
        for (Teuchos::ParameterList::ConstIterator tIndex = tCriteriaList.begin(); tIndex != tCriteriaList.end();
             ++tIndex)
        {
