...
class TMKinetics : public ElementType
{
   ...
   public:
    ...
    KOKKOS_INLINE_FUNCTION void operator()(Plato::Array<mNumVoigtTerms, KineticsScalarType>& aStress,
                                           ...
                                           StateScalarType const& aTemperature) const
    {
        ...
        else
        {
            ...
            for (int iDim = 0; iDim < mNumSpatialDims; iDim++)
            {
                tstrain[iDim] = mScaling *
                                mThermalExpansivityFunctor(aTemperature, cVoigtMap.I[iDim], cVoigtMap.J[iDim]) *
                                (aTemperature - mRefTemperature);
            }
            ...
            for (int iVoigt = 0; iVoigt < mNumVoigtTerms; iVoigt++)
            {
                ...
                {
                    aStress(iVoigt) +=
                        (aStrain(jVoigt) - tstrain[jVoigt]) * mElasticStiffnessFunctor(aTemperature, iVoigt, jVoigt);
                }
            }
