...
Rank4VoigtFunctor<2>::Rank4VoigtFunctor(Teuchos::ParameterList& aParams) : c0{{0.0}}, c1{{0.0}}, c2{{0.0}}
{
    ...
    c0[0][1] = Plato::ParseTools::getParam<T>(aParams, "c012", /*default=*/0.0);
    c0[1][0] = c0[0][1];
    c1[0][1] = Plato::ParseTools::getParam<T>(aParams, "c112", /*default=*/0.0);
    c1[1][0] = c1[0][1];
    c2[0][1] = Plato::ParseTools::getParam<T>(aParams, "c212", /*default=*/0.0);
    c2[1][0] = c2[0][1];
}
...
Rank4VoigtFunctor<3>::Rank4VoigtFunctor(Teuchos::ParameterList& aParams) : c0{{0.0}}, c1{{0.0}}, c2{{0.0}}
{
    ...
    c0[0][2] = Plato::ParseTools::getParam<T>(aParams, "c013", /*default=*/c0[0][1]);
    c0[2][0] = c0[0][2];
    c1[0][2] = Plato::ParseTools::getParam<T>(aParams, "c113", /*default=*/c1[0][1]);
    c1[2][0] = c1[0][2];
    c2[0][2] = Plato::ParseTools::getParam<T>(aParams, "c213", /*default=*/c2[0][1]);
    c2[2][0] = c2[0][2];

    c0[1][2] = Plato::ParseTools::getParam<T>(aParams, "c023", /*default=*/c0[0][1]);
    c0[2][1] = c0[1][2];
    c1[1][2] = Plato::ParseTools::getParam<T>(aParams, "c123", /*default=*/c1[0][1]);
    c1[2][1] = c1[1][2];
    c2[1][2] = Plato::ParseTools::getParam<T>(aParams, "c223", /*default=*/c2[0][1]);
    c2[2][1] = c2[1][2];
}
