...
TensorConstant<2>::TensorConstant(Teuchos::ParameterList& aParams) : c0{{0.0}}
{
    ...
    c0[0][1] = Plato::ParseTools::getParam<T>(aParams, "c12", /*default=*/0.0);
    c0[1][0] = c0[0][1];
}
...
TensorConstant<3>::TensorConstant(Teuchos::ParameterList& aParams) : c0{{0.0}}
{
    ...
    c0[0][2] = Plato::ParseTools::getParam<T>(aParams, "c13", /*default=*/0.0);
    c0[2][0] = c0[0][2];
    c0[1][2] = Plato::ParseTools::getParam<T>(aParams, "c23", /*default=*/0.0);
    c0[2][1] = c0[1][2];
}
