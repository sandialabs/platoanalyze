...
class Rank4VoigtConstant
{
   public:
    ...
    KOKKOS_INLINE_FUNCTION ScalarType operator()(Plato::OrdinalType i, Plato::OrdinalType j) const
    {
...
class Rank4VoigtConstant<2, ScalarType>
{
   public:
    ...
    Rank4VoigtConstant(Teuchos::ParameterList& aParams) : c0{{0.0}}
    {
        ...
        c0[0][1] = Plato::ParseTools::getParam<RealT>(aParams, "c12", /*default=*/0.0);
        c0[1][0] = c0[0][1];
...
class Rank4VoigtConstant<3, ScalarType>
{
   public:
    ...
    Rank4VoigtConstant(Teuchos::ParameterList& aParams) : c0{{0.0}}
    {
        ...
        c0[0][1] = Plato::ParseTools::getParam<RealT>(aParams, "c12", /*default=*/0.0);
        c0[1][0] = c0[0][1];
        c0[0][2] = Plato::ParseTools::getParam<RealT>(aParams, "c13", /*default=*/c0[0][1]);
        c0[2][0] = c0[0][2];
        c0[1][2] = Plato::ParseTools::getParam<RealT>(aParams, "c23", /*default=*/c0[0][1]);
        c0[2][1] = c0[1][2];
