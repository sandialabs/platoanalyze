...
KOKKOS_INLINE_FUNCTION Plato::Matrix<SpaceDim, SpaceDim, T> FromVoigt(Plato::ScalarArray3DT<T> aVoigtTensor,
...
template <int SpaceDim, typename T>
KOKKOS_INLINE_FUNCTION void ToVoigt(Plato::Matrix<SpaceDim, SpaceDim, T> const& aTensor,
