...
class CubicVoigtRank4Field : public Rank4Field<EvaluationType>
{
   ...
   public:
    CubicVoigtRank4Field(const Teuchos::ParameterList& aParams)
        : Rank4Field<EvaluationType>(), mConstantsType(CubicConstants::Undefined)
    {
        ...
        {
            ANALYZE_THROWERR(
                "Unrecognized representation of CubicVoigtRank4Field. Provide Modulus or Lame representations.");
        }
    }

    void getModulusExpressions(const Teuchos::ParameterList& aParams)
    {
        this->mStiffnessTensorProperties["Youngs Modulus"] =
            Plato::ScalarExpression<EvaluationType>("Youngs Modulus", aParams);
        this->mStiffnessTensorProperties["Poissons Ratio"] =
            Plato::ScalarExpression<EvaluationType>("Poissons Ratio", aParams);
        this->mStiffnessTensorProperties["Shear Modulus"] =
            Plato::ScalarExpression<EvaluationType>("Shear Modulus", aParams);
    }

    void getLameExpressions(const Teuchos::ParameterList& aParams)
    {
    ...
    Plato::ScalarArray4DT<KineticsScalarType> operator()(
        const Plato::ScalarMultiVectorT<ControlScalarType>& aLocalControl) override
    {
    ...
    void computeElementConstantsModulus(const Plato::ScalarVectorT<ControlScalarType>& aIndependentVariable,
                                        ...
                                        Plato::ScalarMultiVectorT<KineticsScalarType>& aElementC44)
    {
        ...
        Plato::ScalarVectorT<KineticsScalarType> tElementYoungsModulus =
            this->getTensorProperty("Youngs Modulus")(aIndependentVariable);
        Plato::ScalarVectorT<KineticsScalarType> tElementPoissonsRatio =
            this->getTensorProperty("Poissons Ratio")(aIndependentVariable);
        Plato::ScalarVectorT<KineticsScalarType> tElementShearModulus =
            this->getTensorProperty("Shear Modulus")(aIndependentVariable);

        Kokkos::parallel_for(
            "compute stiffness tensor", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
    ...
    void computeElementConstantsLame(const Plato::ScalarVectorT<ControlScalarType>& aIndependentVariable,
                                     Plato::ScalarMultiVectorT<KineticsScalarType>& aElementC11,
                                     Plato::ScalarMultiVectorT<KineticsScalarType>& aElementC12,
                                     Plato::ScalarMultiVectorT<KineticsScalarType>& aElementC44)
    {
        ...
        Plato::ScalarVectorT<KineticsScalarType> tElementLambda =
            this->getTensorProperty("Lambda")(aIndependentVariable);
    ...
    Plato::ScalarArray4DT<KineticsScalarType> populateStiffnessTensor(
        ...
        const Plato::ScalarMultiVectorT<KineticsScalarType>& aElementC44)
    {
        ...
        Plato::ScalarArray4DT<KineticsScalarType> tStiffness("stiffness", tNumCells, tNumPoints,
                                                             ElementType::mNumVoigtTerms, ElementType::mNumVoigtTerms);

        Kokkos::parallel_for(
            "populate stiffness tensor", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {tNumCells, tNumPoints}),
            KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal, const Plato::OrdinalType iGpOrdinal) {
                ...
                {
                    tStiffness(iCellOrdinal, iGpOrdinal, ElementType::mNumSpatialDims + m,
                               ElementType::mNumSpatialDims + m) = aElementC44(iCellOrdinal, iGpOrdinal);
                }
            });
