...
{
    if (aParamList.isType<Plato::Scalar>("e11")) mReferenceStrain(0) = aParamList.get<Plato::Scalar>("e11");
}

template <>
LinearElasticMaterial<1>::LinearElasticMaterial()
    : mCellDensity(1.0), mPressureScaling(1.0), mRayleighA(0.0), mRayleighB(0.0)
{
    this->initialize();
}
...
{
    if (aParamList.isType<Plato::Scalar>("e11")) mReferenceStrain(0) = aParamList.get<Plato::Scalar>("e11");
    if (aParamList.isType<Plato::Scalar>("e22")) mReferenceStrain(1) = aParamList.get<Plato::Scalar>("e22");
    if (aParamList.isType<Plato::Scalar>("e12")) mReferenceStrain(2) = aParamList.get<Plato::Scalar>("e12");
}
...
void LinearElasticMaterial<3>::setReferenceStrainTensor(const Teuchos::ParameterList& aParamList)
{
    if (aParamList.isType<Plato::Scalar>("e11")) mReferenceStrain(0) = aParamList.get<Plato::Scalar>("e11");
    if (aParamList.isType<Plato::Scalar>("e22")) mReferenceStrain(1) = aParamList.get<Plato::Scalar>("e22");
    if (aParamList.isType<Plato::Scalar>("e33")) mReferenceStrain(2) = aParamList.get<Plato::Scalar>("e33");
    if (aParamList.isType<Plato::Scalar>("e23")) mReferenceStrain(3) = aParamList.get<Plato::Scalar>("e23");
    if (aParamList.isType<Plato::Scalar>("e13")) mReferenceStrain(4) = aParamList.get<Plato::Scalar>("e13");
    if (aParamList.isType<Plato::Scalar>("e12")) mReferenceStrain(5) = aParamList.get<Plato::Scalar>("e12");
}
