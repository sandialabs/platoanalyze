...
class IsotropicVoigtRank4Field : public Rank4Field<EvaluationType>
{
   ...
   public:
    IsotropicVoigtRank4Field(const Teuchos::ParameterList& aParams) : Rank4Field<EvaluationType>()
    {
        ...
        const Plato::ScalarMultiVectorT<ControlScalarType>& aLocalControl) override
    {
        ...
        Plato::ScalarVectorT<KineticsScalarType> tElementYoungsModulus =
            this->getTensorProperty("Youngs Modulus")(tIndependentVariable);
        Plato::ScalarVectorT<KineticsScalarType> tElementPoissonsRatio =
            this->getTensorProperty("Poissons Ratio")(tIndependentVariable);
            ...
            KOKKOS_LAMBDA(const Plato::OrdinalType iCellOrdinal, const Plato::OrdinalType iGpOrdinal) {
                ...
                for (int m = 0; m < tNumShearTerms; ++m)
                {
                    tStiffness(iCellOrdinal, iGpOrdinal, ElementType::mNumSpatialDims + m,
                               ElementType::mNumSpatialDims + m) = 1.0 / 2.0 * tCoeff * (1.0 - 2.0 * tCurPoissonsRatio);
                }
            });
