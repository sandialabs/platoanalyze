...
class Rank4VoigtFunctor
{
   public:
    ...
    KOKKOS_INLINE_FUNCTION TScalarType operator()(TScalarType aInput, Plato::OrdinalType i, Plato::OrdinalType j) const
    {
   ...
   protected:
    static constexpr Plato::OrdinalType NumVoigtTerms =
