#include "material/LinearElectroelasticMaterial.hpp"
...
/******************************************************************************/
template <>
::Plato::IsotropicLinearElectroelasticMaterial<1>::IsotropicLinearElectroelasticMaterial(
...
/******************************************************************************/
template <>
::Plato::IsotropicLinearElectroelasticMaterial<2>::IsotropicLinearElectroelasticMaterial(
    const Teuchos::ParameterList& paramList)
...
/******************************************************************************/
template <>
::Plato::IsotropicLinearElectroelasticMaterial<3>::IsotropicLinearElectroelasticMaterial(
    const Teuchos::ParameterList& paramList)
