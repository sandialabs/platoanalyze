...
TensorFunctor<3>::TensorFunctor(Teuchos::ParameterList& aParams) : c0{{0.0}}, c1{{0.0}}, c2{{0.0}}
{
    ...
    c0[0][2] = Plato::ParseTools::getParam<T>(aParams, "c013", /*default=*/0.0);
    c0[2][0] = c0[0][2];
    c1[0][2] = Plato::ParseTools::getParam<T>(aParams, "c113", /*default=*/0.0);
    c1[2][0] = c1[0][2];
    c2[0][2] = Plato::ParseTools::getParam<T>(aParams, "c213", /*default=*/0.0);
    c2[2][0] = c2[0][2];
    c0[1][2] = Plato::ParseTools::getParam<T>(aParams, "c023", /*default=*/0.0);
    c0[2][1] = c0[1][2];
    c1[1][2] = Plato::ParseTools::getParam<T>(aParams, "c123", /*default=*/0.0);
    c1[2][1] = c1[1][2];
    c2[1][2] = Plato::ParseTools::getParam<T>(aParams, "c223", /*default=*/0.0);
    c2[2][1] = c2[1][2];
}
