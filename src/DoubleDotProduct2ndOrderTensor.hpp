...
template <>
template <typename AViewType, typename BViewType, typename CViewType>
KOKKOS_INLINE_FUNCTION void DoubleDotProduct2ndOrderTensor<3>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<AViewType>& aA,
    const Plato::ScalarMultiVectorT<BViewType>& aB,
    const Plato::ScalarVectorT<CViewType>& aOutput) const
{
    aOutput(aCellOrdinal) = aA(aCellOrdinal, 0) * aB(aCellOrdinal, 0) + aA(aCellOrdinal, 1) * aB(aCellOrdinal, 1) +
...
template <>
template <typename AViewType, typename BViewType, typename CViewType>
KOKKOS_INLINE_FUNCTION void DoubleDotProduct2ndOrderTensor<2>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<AViewType>& aA,
    const Plato::ScalarMultiVectorT<BViewType>& aB,
    const Plato::ScalarVectorT<CViewType>& aOutput) const
...
template <>
template <typename AViewType, typename BViewType, typename CViewType>
KOKKOS_INLINE_FUNCTION void DoubleDotProduct2ndOrderTensor<1>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<AViewType>& aA,
    const Plato::ScalarMultiVectorT<BViewType>& aB,
    const Plato::ScalarVectorT<CViewType>& aOutput) const
