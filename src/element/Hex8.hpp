   ...
   public:
    ...
    [[nodiscard]] static constexpr Plato::Array<mNumGaussPoints> getCubWeights()
    {
        return Plato::Array<mNumGaussPoints>{Plato::Scalar(1.0), Plato::Scalar(1.0), Plato::Scalar(1.0),
                                             Plato::Scalar(1.0), Plato::Scalar(1.0), Plato::Scalar(1.0),
    ...
    [[nodiscard]] static constexpr Plato::Matrix<mNumGaussPoints, mNumSpatialDims> getCubPoints()
    {
        ...
        return Plato::Matrix<mNumGaussPoints, mNumSpatialDims>{
            -sqt, -sqt, -sqt, sqt, -sqt, -sqt, sqt, sqt, -sqt, -sqt, sqt, -sqt,
            -sqt, -sqt, sqt,  sqt, -sqt, sqt,  sqt, sqt, sqt,  -sqt, sqt, sqt,
        };
    }
        ...
        const Plato::Array<mNumSpatialDims>& aCubPoint) -> Plato::Array<mNumNodesPerCell>
    {
        ...
        return Plato::Array<mNumNodesPerCell>{(1 - x) * (1 - y) * (1 - z) / 8.0, (1 + x) * (1 - y) * (1 - z) / 8.0,
                                              (1 + x) * (1 + y) * (1 - z) / 8.0, (1 - x) * (1 + y) * (1 - z) / 8.0,
                                              (1 - x) * (1 - y) * (1 + z) / 8.0, (1 + x) * (1 - y) * (1 + z) / 8.0,
                                              (1 + x) * (1 + y) * (1 + z) / 8.0, (1 - x) * (1 + y) * (1 + z) / 8.0};
    }
        ...
        const Plato::Array<mNumSpatialDims>& aCubPoint) -> Plato::Matrix<mNumNodesPerCell, mNumSpatialDims>
    {
        ...
        return Plato::Matrix<mNumNodesPerCell, mNumSpatialDims>{
            -(1 - y) * (1 - z) / 8.0, -(1 - x) * (1 - z) / 8.0, -(1 - x) * (1 - y) / 8.0, (1 - y) * (1 - z) / 8.0,
            -(1 + x) * (1 - z) / 8.0, -(1 + x) * (1 - y) / 8.0, (1 + y) * (1 - z) / 8.0,  (1 + x) * (1 - z) / 8.0,
            -(1 + x) * (1 + y) / 8.0, -(1 + y) * (1 - z) / 8.0, (1 - x) * (1 - z) / 8.0,  -(1 - x) * (1 + y) / 8.0,
            -(1 - y) * (1 + z) / 8.0, -(1 - x) * (1 + z) / 8.0, (1 - x) * (1 - y) / 8.0,  (1 - y) * (1 + z) / 8.0,
            -(1 + x) * (1 + z) / 8.0, (1 + x) * (1 - y) / 8.0,  (1 + y) * (1 + z) / 8.0,  (1 + x) * (1 + z) / 8.0,
            (1 + x) * (1 + y) / 8.0,  -(1 + y) * (1 + z) / 8.0, (1 - x) * (1 + z) / 8.0,  (1 - x) * (1 + y) / 8.0};
    }
