...
class AbstractYieldStress
{
   ...
   public:
     ...
     **********************************************************************************/
    void operator()(Plato::ScalarMultiVectorT<ResultT> const& aResult,
                    Plato::ScalarMultiVectorT<LocalStateT> const& aLocalState) const
    {
        ...
        Kokkos::View<Plato::ScalarVectorT<ControlT>*, Plato::UVMSpace> tParameters("Yield Stress Parameters");
    ...
    virtual void operator()(
        Plato::ScalarMultiVectorT<ResultT> const& aResult,
        Plato::ScalarMultiVectorT<LocalStateT> const& aLocalState,
        Kokkos::View<Plato::ScalarVectorT<ControlT>*, Plato::UVMSpace> const& aParameters) const = 0;
};
// class AbstractYieldStress
