...
OmegaHMesh::OmegaHMesh(std::string aInputMeshName)
    : mMesh(Omega_h::read_mesh_file(aInputMeshName, OmegaH::Library->world())), mFileName(aInputMeshName)
{
...
Plato::ScalarVectorT<const Plato::OrdinalType> OmegaHMesh::GetLocalElementIDs(std::string aBlockName) const
{
...
std::vector<std::string> OmegaHMesh::GetElementBlockNames() const
{
...
std::vector<std::string> OmegaHMesh::GetNodeSetNames() const
{
    std::vector<std::string> tRetVal;
...
std::vector<std::string> OmegaHMesh::GetSideSetNames() const
{
    std::vector<std::string> tRetVal;
...
std::string OmegaHMesh::FileName() const { return mFileName; }

std::string OmegaHMesh::ElementType() const { return mElementType; }

Plato::OrdinalType OmegaHMesh::NumNodes() const { return mMesh.nverts(); }

Plato::OrdinalType OmegaHMesh::NumElements() const { return mMesh.nelems(); }

Plato::OrdinalType OmegaHMesh::NumNodesPerElement() const { return mMesh.dim() + 1; }

Plato::OrdinalType OmegaHMesh::NumDimensions() const { return mMesh.dim(); }

Plato::ScalarVectorT<const Plato::Scalar> OmegaHMesh::Coordinates() const { return mMesh.coords().view(); }

void OmegaHMesh::SetCoordinates(Plato::ScalarVector aCoordinates)
{
    mMesh.set_coords(Omega_h::Read<Plato::Scalar>(Omega_h::Write<Plato::Scalar>(aCoordinates)));
}

Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::Connectivity() { return mMesh.ask_elem_verts().view(); }

void OmegaHMesh::NodeNodeGraph(Plato::OrdinalVectorT<Plato::OrdinalType>& aOffsetMap,
...
void OmegaHMesh::NodeElementGraph(Plato::OrdinalVectorT<const Plato::OrdinalType>& aOffsetMap,
...
Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::GetSideSetFaces(std::string aSideSetName) const
{
    return mSideSetFacesOrdinals.at(aSideSetName);
}

Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::GetSideSetElements(std::string aSideSetName) const
{
    return mSideSetElementsOrdinals.at(aSideSetName);
}

Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::GetSideSetLocalNodes(std::string aSideSetName) const
{
    return mSideSetLocalNodesOrdinals.at(aSideSetName);
}

Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::GetSideSetElementsComplement(
...
Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::GetSideSetFacesComplement(
    std::vector<std::string> aExcludeNames)
{
...
Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::GetSideSetLocalNodesComplement(
    std::vector<std::string> aExcludeNames)
{
...
void OmegaHMesh::createComplement(std::vector<std::string> aExcludeNames)
{
    if (mMesh.dim() == 3)
    {
        ...
        auto tFaceOrds =
            Plato::omega_h::get_boundary_entities<cFaceDim, Omega_h::SIDE_SET>(aExcludeNames, mMesh, mMeshSets);
...
Plato::OrdinalVectorT<const Plato::OrdinalType> OmegaHMesh::GetNodeSetNodes(std::string aNodeSetName) const
{
...
void OmegaHMesh::CreateNodeSet(std::string aNodeSetName, std::initializer_list<Plato::OrdinalType> aNodes)
{
