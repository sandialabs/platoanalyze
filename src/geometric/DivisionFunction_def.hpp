 ...
 **********************************************************************************/
template <typename PhysicsType>
void DivisionFunction<PhysicsType>::updateProblem(const Plato::ScalarVector& aControl) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::Scalar DivisionFunction<PhysicsType>::value(const Plato::ScalarVector& aControl) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector DivisionFunction<PhysicsType>::gradient_x(const Plato::ScalarVector& aControl) const
{
 ...
 **********************************************************************************/
template <typename PhysicsType>
Plato::ScalarVector DivisionFunction<PhysicsType>::gradient_z(const Plato::ScalarVector& aControl) const
{
