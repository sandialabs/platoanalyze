...
template <>
template <typename StrainT, typename ControlT, typename StressT>
KOKKOS_INLINE_FUNCTION void ComputeDeviatoricStress<1>::operator()(
    ...
    const Plato::ScalarMultiVectorT<StressT>& aStress) const
{
    ...
    // sigma_11
    aStress(aCellOrdinal, 0) =
        (static_cast<Plato::Scalar>(2.0) * aPenalizedShearModulus) * (aStrain(aCellOrdinal, 0) - tTraceOver3);
}
...
template <>
template <typename StrainT, typename ControlT, typename StressT>
KOKKOS_INLINE_FUNCTION void ComputeDeviatoricStress<2>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const ControlT& aPenalizedShearModulus,
    const Plato::ScalarMultiVectorT<StrainT>& aStrain,
    const Plato::ScalarMultiVectorT<StressT>& aStress) const
{
    StrainT tTraceOver3 = (aStrain(aCellOrdinal, 0) + aStrain(aCellOrdinal, 1) + aStrain(aCellOrdinal, 3)) /
    ...
    // sigma_22
    aStress(aCellOrdinal, 1) =
        (static_cast<Plato::Scalar>(2.0) * aPenalizedShearModulus) * (aStrain(aCellOrdinal, 1) - tTraceOver3);

    // sigma_12
    aStress(aCellOrdinal, 2) = aPenalizedShearModulus * aStrain(aCellOrdinal, 2);

    // sigma_33 - out-of-plane stress
    aStress(aCellOrdinal, 3) =
        (static_cast<Plato::Scalar>(2.0) * aPenalizedShearModulus) * (aStrain(aCellOrdinal, 3) - tTraceOver3);
}
...
template <>
template <typename StrainT, typename ControlT, typename StressT>
KOKKOS_INLINE_FUNCTION void ComputeDeviatoricStress<3>::operator()(
    const Plato::OrdinalType& aCellOrdinal,
    const ControlT& aPenalizedShearModulus,
    const Plato::ScalarMultiVectorT<StrainT>& aStrain,
    const Plato::ScalarMultiVectorT<StressT>& aStress) const
{
    StrainT tTraceOver3 = (aStrain(aCellOrdinal, 0) + aStrain(aCellOrdinal, 1) + aStrain(aCellOrdinal, 2)) /
                          static_cast<Plato::Scalar>(3.0);
    ...
    aStress(aCellOrdinal, 2) = (2.0 * aPenalizedShearModulus) * (aStrain(aCellOrdinal, 2) - tTraceOver3);
