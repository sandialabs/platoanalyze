   ...
   public:
    ...
    TimeData(Teuchos::ParameterList& aInputs)
        : mCurrentTimeStepIndex(0),
          mNumTimeSteps(Plato::ParseTools::getSubParam<Plato::OrdinalType>(
              aInputs, "Time Stepping", "Initial Num. Pseudo Time Steps", 20)),
          mMaxNumTimeSteps(Plato::ParseTools::getSubParam<Plato::OrdinalType>(
              aInputs, "Time Stepping", "Maximum Num. Pseudo Time Steps", 80)),
          mCurrentTime(0.0),
          mStartTime(0.0),
          ...
          mTimeStepExpansionMultiplier(
              Plato::ParseTools::getSubParam<Plato::Scalar>(aInputs, "Time Stepping", "Expansion Multiplier", 2)),
