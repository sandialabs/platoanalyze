...
class tachoSolver
{
   public:
    ...
    void Initialize(int numRows, int* rowBegin, int* columns, SX* values, const bool printTimings = false);

    void Initialize(int numRows,
                    size_type_array rowBegin,
   ...
   private:
    ...
    void initializeFromHostData(int numRows,
                                size_type_array_host ap_host,
