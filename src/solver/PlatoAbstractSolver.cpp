...
AbstractSolver::AbstractSolver(const Teuchos::ParameterList& aSolverParams) : mAlpha(parseDiagonalOffset(aSolverParams))
{
}

AbstractSolver::AbstractSolver(const Teuchos::ParameterList& aSolverParams,
                               std::shared_ptr<Plato::MultipointConstraints> aMPCs)
    : mSystemMPCs(aMPCs), mAlpha(parseDiagonalOffset(aSolverParams))
{
}

void AbstractSolver::solve(Plato::CrsMatrix<int> aAf, Plato::ScalarVector aX, Plato::ScalarVector aB, bool aAdjointFlag)
{
    ...
    if (mSystemMPCs)
    {
        ...
        auto tCondensedA = Teuchos::rcp(
            new Plato::CrsMatrixType(tNumCondensedDofs, tNumCondensedDofs, tNumDofsPerNode, tNumDofsPerNode));
