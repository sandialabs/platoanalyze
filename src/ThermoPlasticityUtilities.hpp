...
class ThermoPlasticityUtilities
{
   ...
   public:
    ...
    KOKKOS_INLINE_FUNCTION void computeElasticStrain(
...
template <>
template <typename GlobalStateT, typename LocalStateT, typename TotalStrainT, typename ElasticStrainT>
KOKKOS_INLINE_FUNCTION void ThermoPlasticityUtilities<2, Plato::SimplexPlasticity<2>>::computeElasticStrain(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<GlobalStateT>& aGlobalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVector& aBasisFunctions,
...
template <>
template <typename GlobalStateT, typename LocalStateT, typename TotalStrainT, typename ElasticStrainT>
KOKKOS_INLINE_FUNCTION void ThermoPlasticityUtilities<3, Plato::SimplexPlasticity<3>>::computeElasticStrain(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<GlobalStateT>& aGlobalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVector& aBasisFunctions,
...
template <>
template <typename GlobalStateT, typename LocalStateT, typename TotalStrainT, typename ElasticStrainT>
KOKKOS_INLINE_FUNCTION void ThermoPlasticityUtilities<2, Plato::SimplexThermoPlasticity<2>>::computeElasticStrain(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<GlobalStateT>& aGlobalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVector& aBasisFunctions,
...
template <>
template <typename GlobalStateT, typename LocalStateT, typename TotalStrainT, typename ElasticStrainT>
KOKKOS_INLINE_FUNCTION void ThermoPlasticityUtilities<3, Plato::SimplexThermoPlasticity<3>>::computeElasticStrain(
    const Plato::OrdinalType& aCellOrdinal,
    const Plato::ScalarMultiVectorT<GlobalStateT>& aGlobalState,
    const Plato::ScalarMultiVectorT<LocalStateT>& aLocalState,
    const Plato::ScalarVector& aBasisFunctions,
