...
class Bar2
{
   public:
    ...
    {
        return Plato::Array<mNumGaussPoints>{Plato::Scalar(1.0), Plato::Scalar(1.0)};
    }
        ...
        const Plato::Array<mNumSpatialDims>& aCubPoint) -> Plato::Array<mNumNodesPerCell>
    {
        ...
        return Plato::Array<mNumNodesPerCell>{(1 - x) / 2.0, (1 + x) / 2.0};
    }
    ...
    {
        return Plato::Matrix<mNumNodesPerCell, mNumSpatialDims>{Plato::Scalar(-1) / 2.0, Plato::Scalar(1) / 2.0};
    }
    ...
    {
        return Plato::Array<mNumSpatialDims + 1, ScalarType>{aJacobian(0, 0), aJacobian(0, 1)};
    }
};
