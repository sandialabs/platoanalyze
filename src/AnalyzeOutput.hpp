...
namespace Plato
{
inline void AddStateData(Plato::MeshIO aWriter, Plato::DataMap aDataMap, Plato::OrdinalType aNumDims)
{
...
/******************************************************************************/ /**
                                                                                  ...
                                                                                  *database
                                                                                  **********************************************************************************/
inline void universal_solution_output(const std::string& aOutputFilePath,
