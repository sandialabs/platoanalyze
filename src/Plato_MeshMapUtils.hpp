...
struct GetBasis
{
    ...
    GetBasis(Plato::Mesh aMesh) : mCells2Nodes(aMesh->Connectivity()), mCoords(aMesh->Coordinates()) {}
    ...
    Plato::Matrix<ElementT::mNumNodesPerCell, ElementT::mNumSpatialDims> getNodeLocations(
        const Plato::Array<ElementT::mNumNodesPerCell, Plato::OrdinalType> &aNodeOrdinals) const
    {
     ...
     **********************************************************************************/
    KOKKOS_INLINE_FUNCTION void basis(const Plato::Array<ElementT::mNumSpatialDims, ScalarT> &aPhysicalLocation,
                                      const Plato::Array<ElementT::mNumNodesPerCell, Plato::OrdinalType> &aNodeOrdinals,
                                      Plato::Array<ElementT::mNumNodesPerCell, ScalarT> &aBases) const
    {
        Plato::Array<ElementT::mNumSpatialDims, ScalarT> tParentCoords(0.0);

        Plato::Matrix<ElementT::mNumNodesPerCell, ElementT::mNumSpatialDims, ScalarT> tNodeLocations =
            getNodeLocations(aNodeOrdinals);
    ...
    /**
        ...
        **********************************************************************************/
    KOKKOS_INLINE_FUNCTION void operator()(VectorArrayT aLocations,
     ...
     **********************************************************************************/
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType aElemOrdinal,
