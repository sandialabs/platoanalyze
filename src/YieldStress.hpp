...
class YieldStress : public Plato::AbstractYieldStress<EvaluationType>
{
   protected:
    using LocalStateT =
   ...
   public:
     ...
     **********************************************************************************/
    KOKKOS_INLINE_FUNCTION void operator()(Plato::OrdinalType const& aCellOrdinal,
                                           ...
                                           ControlT const& aPenalizedHardeningModulusIsotropic) const
    {
        ...
        aYieldStress =
            ...
            aPenalizedHardeningModulusIsotropic * aLocalState(aCellOrdinal, 0);  // SHOULD THIS BE PREV? I think no.
    }
    ...
    KOKKOS_INLINE_FUNCTION void operator()(
        Plato::OrdinalType const& aCellOrdinal,
        ...
        Plato::ScalarVectorT<ControlT> const& aPenalizedHardeningModulusIsotropic) const
    {
        ...
        aYieldStress(aCellOrdinal, 0) = aPenalizedInitialYieldStress(aCellOrdinal) +
     ...
     **********************************************************************************/
    void operator()(Plato::ScalarMultiVectorT<ResultT> const& aYieldStress,
                    Plato::ScalarMultiVectorT<LocalStateT> const& aLocalState,
                    Kokkos::View<Plato::ScalarVectorT<ControlT>*, Plato::UVMSpace> const& aParameters) const override
    {
        ...
        if (aParameters.extent(0) != 2)
        {
            ...
            errorMsg << "Calling the original yield stress equation with an "
                     << "incorrect number of parameters, expected 2, received " << aParameters.extent(0) << ".";
        ...
        Kokkos::parallel_for(
            "Compute yield stress", Kokkos::RangePolicy<>(0, tNumCells),
        ...
        Plato::ScalarVectorT<ControlT> tDummyParam("Yield Stress Dummy Parameter", 0);
