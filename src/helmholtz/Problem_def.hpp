...
/******************************************************************************/ /**
                                                                                  * \brief Solve system of equations
                                                                                  *related to chain rule of Helmholtz
                                                                                  *filter for gradients \param [in]
                                                                                  *aControl 1D view of criterion partial
                                                                                  *derivative wrt filtered control
                                                                                  * \param [in] aName Name of criterion
                                                                                  *(is just a dummy for Helmhomtz to
                                                                                  * match signature of base class
                                                                                  *virtual function). \return 1D view -
...
Plato::ScalarVector Problem<PhysicsType>::criterionGradient(const Plato::ScalarVector& aControl,
                                                            ...
                                                            const std::string& aName) {
  ANALYZE_THROWERR(
      "CRITERION GRADIENT: NO INSTANCE OF THIS FUNCTION WITH SOLUTION INPUT IMPLEMENTED FOR HELMHOLTZ FILTER PROBLEM.")
}
