   ...
   public:
    ...
    ) const
    {
...

        {
            ...
            //
            mBoundaryResidualFunctions->evaluate_boundary(mSpatialModel, tStateWS, tControlWS, tConfigWS, tResidual,
                                                          aTimeStep);
    ...
    /**************************************************************************/
    {
...

        {
            ...
            // evaluate_boundary function
            //
            mBoundaryJacobianFunctions->evaluate_boundary(mSpatialModel, tStateWS, tControlWS, tConfigWS, tJacobian,
                                                          aTimeStep);
    ...
    ) const
    {
...

        {
            ...
            // evaluate_boundary function
            //
            mBoundaryGradientZFunctions->evaluate_boundary(mSpatialModel, tStateWS, tControlWS, tConfigWS, tJacobian,
                                                           aTimeStep);
