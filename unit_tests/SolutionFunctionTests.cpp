...
TEUCHOS_UNIT_TEST(DerivativeTests, Solution2D)
{
    ...
    Kokkos::parallel_for(
        "set disp", Kokkos::RangePolicy<int>(0, tNumVerts), KOKKOS_LAMBDA(int aNodeOrdinal) {
    ...
    Plato::Elliptic::SolutionFunction<::Plato::Mechanics<Plato::Tri3>> scalarFunction(tSpatialModel, tDataMap,
