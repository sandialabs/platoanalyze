...
TEUCHOS_UNIT_TEST(HeatEquationTests, 3D)
{
    ...
    Plato::ScalarMultiVectorT<Plato::Scalar> tCellGrad("temperature gradient", numCells, spaceDim);

    Plato::ScalarMultiVectorT<Plato::Scalar> tCellFlux("thermal flux", numCells, spaceDim);
    ...
    Kokkos::parallel_for(
        "flux divergence", Kokkos::MDRangePolicy<Kokkos::Rank<2>>({0, 0}, {numCells, numPoints}),
    ...
    std::vector<Plato::Scalar> tTemperature_gold = {
        10.23606797749978, 6.211145618000156, 10.68328157299974, 4.869504831500283, 5.105572809000069,
        5.552786404500027, 9.577708763999649, 3.763932022500195, 5.276393202250006, 3.934752415750130,
        9.301315561749627, 3.487538820250173, 4.763932022500198, 8.788854381999819, 10.13049516849969,
        4.316718427000239, 9.894427190999906, 9.447213595499949, 11.23606797749978, 5.422291236000327,
        9.723606797749971, 11.06524758424984, 11.51246117974980, 5.698684438250349, 11.23606797749978,
        7.211145618000156, 11.68328157299974, 5.869504831500284, 6.105572809000070, 6.552786404500026,
        10.57770876399965, 4.763932022500195, 6.276393202250005, 4.934752415750131, 10.30131556174963,
        4.487538820250173, 5.763932022500198, 9.788854381999819, 11.13049516849969, 5.316718427000239,
    ...
    std::vector<Plato::Scalar> thermalContent_gold = {
        3.070820393249934e6, 1.863343685400047e6, 3.204984471899921e6, 1.460851449450085e6, 1.531671842700021e6,
        1.665835921350008e6, 2.873312629199895e6, 1.129179606750058e6, 1.582917960675002e6, 1.180425724725039e6,
        2.790394668524888e6, 1.046261646075052e6, 1.429179606750059e6, 2.636656314599946e6, 3.039148550549908e6,
        1.295015528100072e6, 2.968328157299972e6, 2.834164078649985e6, 3.370820393249934e6, 1.626687370800098e6,
        2.917082039324991e6, 3.319574275274953e6, 3.453738353924941e6, 1.709605331475105e6, 3.370820393249934e6,
        2.163343685400047e6, 3.504984471899921e6, 1.760851449450085e6, 1.831671842700021e6, 1.965835921350008e6,
        3.173312629199895e6, 1.429179606750058e6, 1.882917960675001e6, 1.480425724725039e6, 3.090394668524887e6,
        1.346261646075052e6, 1.729179606750059e6, 2.936656314599946e6, 3.339148550549908e6, 1.595015528100072e6,
        3.268328157299972e6, 3.134164078649984e6, 3.670820393249934e6, 1.926687370800098e6, 3.217082039324991e6,
        3.619574275274953e6, 3.753738353924941e6, 2.009605331475105e6};
    ...
    std::vector<std::vector<Plato::Scalar>> tgrad_gold = {{18.000, 6.000, 2.000}, {18.000, 6.000, 2.000},
                                                          {18.000, 6.000, 2.000}, {18.000, 6.000, 2.000},
                                                          {18.000, 6.000, 2.000}, {18.000, 6.000, 2.000}};
    ...
    std::vector<std::vector<Plato::Scalar>> tflux_gold = {{-18.0e6, -6.0e6, -2.0e6}, {-18.0e6, -6.0e6, -2.0e6},
                                                          {-18.0e6, -6.0e6, -2.0e6}, {-18.0e6, -6.0e6, -2.0e6},
                                                          {-18.0e6, -6.0e6, -2.0e6}, {-18.0e6, -6.0e6, -2.0e6}};
...
TEUCHOS_UNIT_TEST(HeatEquationTests, HeatEquationResidual3D)
{
    ...
    Kokkos::View<Plato::Scalar*, Kokkos::HostSpace, Kokkos::MemoryUnmanaged> Tdot_host_view(Tdot_host.data(),
                                                                                            Tdot_host.size());
    ...
    std::vector<Plato::Scalar> residual_gold = {
        -2166637.6041666669771075, -2999957.8125000000000000, -833323.3333333332557231,  -2499946.8750000000000000,
        -4499918.7500000009313226, -1999975.0000000000000000, -333318.6458333332557231,  -1499970.3124999997671694,
        -1166651.6666666667442769, -999914.0625000002328306,  -1499871.8750000004656613, -499960.9375000000582077,
        -499856.2499999998835847,  262.5000000004656613,      500118.7500000003492460,   500048.4374999998253770,
        1500134.3749999997671694,  1000089.0624999997671694,  1166695.4166666665114462,  1500057.8124999997671694,
        333362.3958333332557231,   2000062.5000000000000000,  4500181.2500000000000000,  2500121.8750000004656613,
    ...
    std::vector<Plato::Scalar> gold_jac_entries = {499999.999999999942,
                                                   -166666.666666666657,
                                                   -166666.666666666657,
                                                   0,
                                                   -166666.666666666657,
    ...
    std::vector<Plato::Scalar> gold_jac_v_entries = {
        3.75000000000000977,  0.625000000000002887, 0.625000000000002887, 0.625000000000002887, 0.625000000000002887,
        0.625000000000002887, 0.625000000000002887, 1.87499999999999067,  0.625000000000002887, 5.00000000000001332,
        0.625000000000002887, 0.937500000000004441, 0.625000000000002887, 0.937500000000004441, 0.625000000000002887,
        1.24999999999999978,  1.87499999999999067,  0.625000000000002887, 1.25000000000000311,  0.312500000000001499,
        0.312500000000001499, 0.624999999999996891};
    ...
    std::vector<Plato::Scalar> gold_grad_entries = {
        -541657.0136455872561783, -208331.7904794917849358, -83331.5345112734939903,  -291665.1073170731542632,
        291669.2333933811169118,  83335.6605875814420870,   208335.9165557996893767,  541673.6979166636010632,
        -41665.1238128263357794,  -749985.5267691994085908, -208331.4779794917558320, -208330.4490091494517401,
        -291664.7948170731542632, 416670.6180501623894088,  83335.9730875814420870,   458338.3333333326736465,
        541674.6354166636010632,  -41664.8113128263430553,  -208329.7631236119777896, -124999.0707478759577498,
        125001.2284067813016009,  250002.4167775329842698};
    ...
    std::vector<Plato::Scalar> gold_grad_x_entries = {
        -9000023.7500000000000000, -3000018.1250000000000000, -1000016.2499999998835847, 2833333.3333333330228925,
        833333.3333333332557231,   2333316.4583333334885538,  2500000.0000000000000000,  2666646.6666666669771075,
        -166666.6666666666569654,  -666666.6666666666278616,  1499990.9375000002328306,  1499991.5625000000000000,
    };
...
TEUCHOS_UNIT_TEST(HeatEquationTests, ComputedField_UniformScalar)
{
    ...
    Kokkos::parallel_for(
        "get coords", Kokkos::RangePolicy<int>(0, tNumNodes), KOKKOS_LAMBDA(int nodeOrdinal) {
