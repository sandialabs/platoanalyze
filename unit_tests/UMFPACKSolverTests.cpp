...
TEUCHOS_UNIT_TEST(UMFPACKSolver, Symmetric)
{
    ...
    */
    ...
    const pu::CSRMatrix Acsr = {
        /* .rowBegin = */ std::vector<SuiteSparse_long>{0, 2, 5, 8, 10},
...
TEUCHOS_UNIT_TEST(UMFPACKSolver, NonSymmetricEntries)
{
    ...
    */
    ...
    const pu::CSCMatrix Acsc_gold = {
        /* .colBegin = */ std::vector<SuiteSparse_long>{0, 2, 5, 8, 10},
